...
public class D_Gshty : Form
{
	...
	private TextBox d163d;

	private TextBox s165s;

	private TextBox d162d;
	...
	private TextBox d161d;

	private TextBox h217;

	private TextBox h216;

	private TextBox d159d;

	private TextBox h215;

	private TextBox d157d;

	private TextBox h214;

	private TextBox d155d;

	private TextBox h212;

	private TextBox d152d;

	private TextBox d232d;

	private TextBox d225d;

	private TextBox d148d;

	private TextBox d227d;

	private TextBox d147d;

	private TextBox d143d;

	private TextBox d224d;

	private TextBox d222d;

	private TextBox d142d;

	private TextBox d213d;

	private TextBox d141d;

	private TextBox d140d;

	private TextBox d211d;

	private TextBox d134d;

	private TextBox d133d;

	private TextBox d132d;

	private TextBox d200d;

	private TextBox d197d;

	private TextBox d196d;

	private TextBox d195d;

	private TextBox d190d;

	private TextBox d188d;

	private TextBox d129d;

	private TextBox d127d;

	private TextBox d126d;

	private TextBox d118d;

	private TextBox d177d;

	private TextBox d186d;

	private TextBox d114d;

	private TextBox d175d;

	private TextBox d108d;

	private TextBox d107d;

	private TextBox d169d;

	private TableLayoutPanel tableLayoutPanel7;

	private TextBox d164d;
	...
	private void totals()
	{
		try
		{
			double To2 = (double)int.Parse(d107d.Text) + Convert.ToDouble(d108d.Text) + Convert.ToDouble(d114d.Text) + Convert.ToDouble(d118d.Text) + Convert.ToDouble(d126d.Text) + Convert.ToDouble(d127d.Text) + Convert.ToDouble(d129d.Text) + Convert.ToDouble(d132d.Text) + Convert.ToDouble(d133d.Text) + Convert.ToDouble(d134d.Text) + Convert.ToDouble(d140d.Text) + Convert.ToDouble(d141d.Text) + Convert.ToDouble(d142d.Text) + Convert.ToDouble(d143d.Text) + Convert.ToDouble(d147d.Text) + Convert.ToDouble(d148d.Text) + Convert.ToDouble(d152d.Text) + Convert.ToDouble(d155d.Text) + Convert.ToDouble(d157d.Text) + Convert.ToDouble(d159d.Text) + Convert.ToDouble(d161d.Text) + Convert.ToDouble(s138s.Text) + Convert.ToDouble(s145s.Text) + Convert.ToDouble(s147s.Text) + Convert.ToDouble(s148s.Text) + Convert.ToDouble(s153s.Text) + Convert.ToDouble(s157s.Text) + Convert.ToDouble(s161s.Text) + Convert.ToDouble(s162s.Text) + Convert.ToDouble(s164s.Text) + Convert.ToDouble(s165s.Text) + Convert.ToDouble(s166s.Text) + Convert.ToDouble(s168s.Text) + Convert.ToDouble(s169s.Text) + Convert.ToDouble(s171s.Text) + Convert.ToDouble(d162d.Text) + Convert.ToDouble(d163d.Text) + Convert.ToDouble(d164d.Text) + Convert.ToDouble(d169d.Text) + Convert.ToDouble(d175d.Text) + Convert.ToDouble(d177d.Text) + Convert.ToDouble(d186d.Text) + Convert.ToDouble(d188d.Text) + Convert.ToDouble(d190d.Text) + Convert.ToDouble(d195d.Text) + Convert.ToDouble(d196d.Text) + Convert.ToDouble(d197d.Text) + Convert.ToDouble(d200d.Text) + Convert.ToDouble(d211d.Text) + Convert.ToDouble(d213d.Text) + Convert.ToDouble(d222d.Text) + Convert.ToDouble(d224d.Text) + Convert.ToDouble(d225d.Text) + Convert.ToDouble(d227d.Text);
	...
	{
		Home ho = new Home();
		string qurey = "Update  dhok_hazb set [waraqa_rast]=@waraqa_rast,[waraqapochal]=@waraqapochal , [107]= @107, \t[108]= @108, \t[114]= @114, \t[118]= @118, \t[126]= @126, \t[127]= @127, \t[129]= @129, \t[132]= @132, \t[133]= @133, \t[134]= @134, \t[140]= @140, \t[141]= @141, \t[142]= @142, \t[143]= @143, \t[147]= @147, \t[148]= @148, \t[152]= @152, \t[155]= @155, \t[157]= @157, \t[159]= @159, \t[161]= @161, \t[162]= @162, \t[163]= @163, \t[164]= @164, \t[169]= @169, \t[175]= @175, \t[177]= @177, \t[186]= @186, \t[188]= @188, \t[190]= @190, \t[195]= @195, \t[196]= @196, \t[197]= @197, \t[200]= @200, \t[211]= @211, \t[213]= @213, \t[222]= @222, \t[224]= @224, \t[225]= @225, \t[227]= @227, \t[232]=  @232   WHERE cood_bnka = " + txtbnkacood.Text + " and westga = " + comwestga.Text;
		...
		cmd.Parameters.AddWithValue("@107", d107d.Text);
		cmd.Parameters.AddWithValue("@108", d108d.Text);
		cmd.Parameters.AddWithValue("@114", d114d.Text);
		cmd.Parameters.AddWithValue("@118", d118d.Text);
		cmd.Parameters.AddWithValue("@126", d126d.Text);
		cmd.Parameters.AddWithValue("@127", d127d.Text);
		cmd.Parameters.AddWithValue("@129", d129d.Text);
		cmd.Parameters.AddWithValue("@132", d132d.Text);
		cmd.Parameters.AddWithValue("@133", d133d.Text);
		cmd.Parameters.AddWithValue("@134", d134d.Text);
		cmd.Parameters.AddWithValue("@140", d140d.Text);
		cmd.Parameters.AddWithValue("@141", d141d.Text);
		cmd.Parameters.AddWithValue("@142", d142d.Text);
		cmd.Parameters.AddWithValue("@143", d143d.Text);
		cmd.Parameters.AddWithValue("@147", d147d.Text);
		cmd.Parameters.AddWithValue("@148", d148d.Text);
		cmd.Parameters.AddWithValue("@152", d152d.Text);
		cmd.Parameters.AddWithValue("@155", d155d.Text);
		cmd.Parameters.AddWithValue("@157", d157d.Text);
		cmd.Parameters.AddWithValue("@159", d159d.Text);
		cmd.Parameters.AddWithValue("@161", d161d.Text);
		cmd.Parameters.AddWithValue("@162", d162d.Text);
		cmd.Parameters.AddWithValue("@163", d163d.Text);
		cmd.Parameters.AddWithValue("@164", d164d.Text);
		cmd.Parameters.AddWithValue("@169", d169d.Text);
		cmd.Parameters.AddWithValue("@175", d175d.Text);
		cmd.Parameters.AddWithValue("@177", d177d.Text);
		cmd.Parameters.AddWithValue("@186", d186d.Text);
		cmd.Parameters.AddWithValue("@188", d188d.Text);
		cmd.Parameters.AddWithValue("@190", d190d.Text);
		cmd.Parameters.AddWithValue("@195", d195d.Text);
		cmd.Parameters.AddWithValue("@196", d196d.Text);
		cmd.Parameters.AddWithValue("@197", d197d.Text);
		cmd.Parameters.AddWithValue("@200", d200d.Text);
		cmd.Parameters.AddWithValue("@211", d211d.Text);
		cmd.Parameters.AddWithValue("@213", d213d.Text);
		cmd.Parameters.AddWithValue("@222", d222d.Text);
		cmd.Parameters.AddWithValue("@224", d224d.Text);
		cmd.Parameters.AddWithValue("@225", d225d.Text);
		cmd.Parameters.AddWithValue("@227", d227d.Text);
		cmd.Parameters.AddWithValue("@232", d232d.Text);
		cmd.ExecuteNonQuery();
		connectionString.Close();
	...
	private void add_update_delete()
	{
		...
		cmd.Parameters.AddWithValue("@s218", d200d.Text);
		...
		cmd.Parameters.AddWithValue("@h102", d107d.Text);
		cmd.Parameters.AddWithValue("@h103", d108d.Text);
		cmd.Parameters.AddWithValue("@h105", d114d.Text);
		cmd.Parameters.AddWithValue("@h106", d118d.Text);
		cmd.Parameters.AddWithValue("@h109", d126d.Text);
		cmd.Parameters.AddWithValue("@h111", d127d.Text);
		cmd.Parameters.AddWithValue("@h112", d129d.Text);
		cmd.Parameters.AddWithValue("@h120", d132d.Text);
		cmd.Parameters.AddWithValue("@h123", d133d.Text);
		cmd.Parameters.AddWithValue("@h129", d134d.Text);
		cmd.Parameters.AddWithValue("@h131", d140d.Text);
		cmd.Parameters.AddWithValue("@h133", d141d.Text);
		cmd.Parameters.AddWithValue("@h139", d142d.Text);
		cmd.Parameters.AddWithValue("@h144", d143d.Text);
		cmd.Parameters.AddWithValue("@h146", d147d.Text);
		cmd.Parameters.AddWithValue("@h147", d148d.Text);
		cmd.Parameters.AddWithValue("@h148", d152d.Text);
		cmd.Parameters.AddWithValue("@h149", d155d.Text);
		cmd.Parameters.AddWithValue("@h150", d157d.Text);
		cmd.Parameters.AddWithValue("@h151", d159d.Text);
		cmd.Parameters.AddWithValue("@h154", d161d.Text);
		...
		cmd.Parameters.AddWithValue("@h173", d162d.Text);
		cmd.Parameters.AddWithValue("@h176", d163d.Text);
		cmd.Parameters.AddWithValue("@h178", d164d.Text);
		cmd.Parameters.AddWithValue("@h179", d169d.Text);
		cmd.Parameters.AddWithValue("@h181", d175d.Text);
		cmd.Parameters.AddWithValue("@h184", d177d.Text);
		cmd.Parameters.AddWithValue("@h187", d186d.Text);
		cmd.Parameters.AddWithValue("@h189", d188d.Text);
		cmd.Parameters.AddWithValue("@h190", d190d.Text);
		cmd.Parameters.AddWithValue("@h191", d195d.Text);
		cmd.Parameters.AddWithValue("@h198", d196d.Text);
		cmd.Parameters.AddWithValue("@h199", d197d.Text);
		cmd.Parameters.AddWithValue("@h202", d200d.Text);
		cmd.Parameters.AddWithValue("@h203", d211d.Text);
		cmd.Parameters.AddWithValue("@h204", d213d.Text);
		cmd.Parameters.AddWithValue("@h205", d222d.Text);
		cmd.Parameters.AddWithValue("@h206", d224d.Text);
		cmd.Parameters.AddWithValue("@h208", d225d.Text);
		cmd.Parameters.AddWithValue("@h209", d227d.Text);
		cmd.Parameters.AddWithValue("@h210", d232d.Text);
	...
	{
		string qurey = "Update candid_d set [1]=@1,\t[2]=@2,\t[3]=@3,\t[4]=@4,\t[5]=@5,\t[6]=@6,\t[7]=@7,\t[8]=@8,\t[9]=@9,\t[10]=@10,\t[11]=@11,\t[12]=@12,\t[13]=@13,\t[14]=@14,\t[15]=@15,\t[16]=@16,\t[17]=@17,\t[18]=@18,\t[19]=@19,\t[20]=@20,\t[21]=@21,\t[22]=@22,\t[23]=@23,\t[24]=@24,\t[25]=@25,\t[26]=@26,\t[27]=@27,\t[28]=@28,\t[29]=@29,\t[30]=@30    WHERE cood_bnka = " + txtbnkacood.Text + " and westga = " + comwestga.Text;
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
	...
	private void btnadd_Click(object sender, EventArgs e)
	{
		...
		else if (btnadd.Text == "تۆمارکردن")
		{
			...
			bm = log.get_hazb_d(int.Parse(txtbnkacood.Text), int.Parse(comwestga.Text));
			if (bm.Rows.Count > 0)
			{
	...
	private void comwestga_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		using (SqlDataReader reader = command.ExecuteReader())
		{
			if (reader.Read())
			{
				...
				d107d.Text = reader["107"].ToString();
				d108d.Text = reader["108"].ToString();
				d114d.Text = reader["114"].ToString();
				d118d.Text = reader["118"].ToString();
				d126d.Text = reader["126"].ToString();
				d127d.Text = reader["127"].ToString();
				d129d.Text = reader["129"].ToString();
				d132d.Text = reader["132"].ToString();
				d133d.Text = reader["133"].ToString();
				d134d.Text = reader["134"].ToString();
				d140d.Text = reader["140"].ToString();
				d141d.Text = reader["141"].ToString();
				d142d.Text = reader["142"].ToString();
				d143d.Text = reader["143"].ToString();
				d147d.Text = reader["147"].ToString();
				d148d.Text = reader["148"].ToString();
				d152d.Text = reader["152"].ToString();
				d155d.Text = reader["155"].ToString();
				d157d.Text = reader["157"].ToString();
				d159d.Text = reader["159"].ToString();
				d161d.Text = reader["161"].ToString();
				d162d.Text = reader["162"].ToString();
				d163d.Text = reader["163"].ToString();
				d164d.Text = reader["164"].ToString();
				d169d.Text = reader["169"].ToString();
				d175d.Text = reader["175"].ToString();
				d177d.Text = reader["177"].ToString();
				d186d.Text = reader["186"].ToString();
				d188d.Text = reader["188"].ToString();
				d190d.Text = reader["190"].ToString();
				d195d.Text = reader["195"].ToString();
				d196d.Text = reader["196"].ToString();
				d197d.Text = reader["197"].ToString();
				d200d.Text = reader["200"].ToString();
				d211d.Text = reader["211"].ToString();
				d213d.Text = reader["213"].ToString();
				d222d.Text = reader["222"].ToString();
				d224d.Text = reader["224"].ToString();
				d225d.Text = reader["225"].ToString();
				d227d.Text = reader["227"].ToString();
				d232d.Text = reader["232"].ToString();
				btnadd.Text = "Update";
				txtcoler();
			}
			else
	...
	{
		string qurey = "insert into candid_d(naw_mahafaza,cood_tasjil,cood_bnka,jor_dangdan,\twestga,[1]\t,[2]\t,[3]\t,[4]\t,[5]\t,[6]\t,[7]\t,[8]\t,[9]\t,[10]\t,[11]\t,[12]\t,[13]\t,[14]\t,[15]\t,[16]\t,[17]\t,[18]\t,[19]\t,[20]\t,[21]\t,[22]\t,[23]\t,[24]\t,[25]\t,[26]\t,[27]\t,[28]\t,[29]\t,[30])VALUES (@naw_mahafaza,\t@cood_tasjil,\t@cood_bnka,@jor_dangdan,\t@westga,@1,@2,\t@3,\t@4,\t@5,\t@6,\t@7,\t@8,\t@9,\t@10,\t@11,\t@12,\t@13,\t@14,\t@15,\t@16,\t@17,\t@18,\t@19,\t@20,\t@21,\t@22,\t@23,\t@24,\t@25,\t@26,\t@27,\t@28,\t@29,\t@30)";
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
		cmd.Parameters.AddWithValue("@naw_mahafaza", txtparezga.Text);
		cmd.Parameters.AddWithValue("@cood_tasjil", txtcoodtasj.Text);
	...
	private void txtcoler()
	{
		...
		{
			d107d, d108d, d114d, d118d, d126d, d127d, d129d, d132d, d133d, d134d,
			d140d, d141d, d142d, d143d, d147d, d148d, d152d, d155d, d157d, d159d,
			d161d, d162d, d163d, d164d, d169d, d175d, d177d, d186d, d188d, d190d,
			d195d, d196d, d197d, d200d, d211d, d213d, d222d, d224d, d225d, d227d,
			d232d, s1, s2, s3, s4, s5, s6, s7, s8, s9,
	...
	{
		Home ho = new Home();
		string qurey = "insert into dhok_hazb(naw_mahafaza,\tmalband,\tcood_tasjil,\tnaw_tasjil,\tcood_bnka,\tnaw_bnka,\twestga_gshty,\tdangdar,\twestga,\twaraqa_rast,\twaraqapochal, [naw_karmand],[taime],[jor_dangdan],Device_name,srial_namber,[107], \t[108], \t[114], \t[118], \t[126], \t[127], \t[129], \t[132], \t[133], \t[134], \t[140], \t[141], \t[142], \t[143], \t[147], \t[148], \t[152], \t[155], \t[157], \t[159], \t[161], \t[162], \t[163], \t[164], \t[169], \t[175], \t[177], \t[186], \t[188], \t[190], \t[195], \t[196], \t[197], \t[200], \t[211], \t[213], \t[222], \t[224], \t[225], \t[227], \t[232])VALUES (@naw_mahafaza,\t@malband,\t@cood_tasjil,\t@naw_tasjil,\t@cood_bnka,\t@naw_bnka,\t@westga_gshty,\t@dangdar,\t@westga,\t@waraqa_rast,\t@waraqapochal,@naw_karmand,@taime,@jor_dangdan,@Device_name,@srial_namber,@107, \t@108, \t@114, \t@118, \t@126, \t@127, \t@129, \t@132, \t@133, \t@134, \t@140, \t@141, \t@142, \t@143, \t@147, \t@148, \t@152, \t@155, \t@157, \t@159, \t@161, \t@162, \t@163, \t@164, \t@169, \t@175, \t@177, \t@186, \t@188, \t@190, \t@195, \t@196, \t@197, \t@200, \t@211, \t@213, \t@222, \t@224, \t@225, \t@227, \t@232)";
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
		cmd.Parameters.AddWithValue("@naw_mahafaza", txtparezga.Text);
		cmd.Parameters.AddWithValue("@malband", txtmalband.Text);
	...
	{
		if (d107d.Text == string.Empty)
		{
			d107d.Text = "0";
		}
		if (d107d.Text == "0")
		{
			d107d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d107d.ForeColor = Color.Black;
		}
	}

	private void h103_Leave(object sender, EventArgs e)
	{
		if (d108d.Text == string.Empty)
		{
			d108d.Text = "0";
		}
		if (d108d.Text == "0")
		{
			d108d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d108d.ForeColor = Color.Black;
		}
	}

	private void h105_Leave(object sender, EventArgs e)
	{
		if (d114d.Text == string.Empty)
		{
			d114d.Text = "0";
		}
		if (d114d.Text == "0")
		{
			d114d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d114d.ForeColor = Color.Black;
		}
	}

	private void h106_Leave(object sender, EventArgs e)
	{
		if (d118d.Text == string.Empty)
		{
			d118d.Text = "0";
		}
		if (d118d.Text == "0")
		{
			d118d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d118d.ForeColor = Color.Black;
		}
	}

	private void h109_Leave(object sender, EventArgs e)
	{
		if (d126d.Text == string.Empty)
		{
			d126d.Text = "0";
		}
		if (d126d.Text == "0")
		{
			d126d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d126d.ForeColor = Color.Black;
		}
	}

	private void h111_Leave(object sender, EventArgs e)
	{
		if (d127d.Text == string.Empty)
		{
			d127d.Text = "0";
		}
		if (d127d.Text == "0")
		{
			d127d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d127d.ForeColor = Color.Black;
		}
	}

	private void h112_Leave(object sender, EventArgs e)
	{
		if (d129d.Text == string.Empty)
		{
			d129d.Text = "0";
		}
		if (d129d.Text == "0")
		{
			d129d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d129d.ForeColor = Color.Black;
		}
	}
	...
	{
		if (d132d.Text == string.Empty)
		{
			d132d.Text = "0";
		}
		if (d132d.Text == "0")
		{
			d132d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d132d.ForeColor = Color.Black;
		}
	}

	private void h123_Leave(object sender, EventArgs e)
	{
		if (d133d.Text == string.Empty)
		{
			d133d.Text = "0";
		}
		if (d133d.Text == "0")
		{
			d133d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d133d.ForeColor = Color.Black;
		}
	}

	private void h179_Leave(object sender, EventArgs e)
	{
		if (d169d.Text == string.Empty)
		{
			d169d.Text = "0";
		}
		if (d169d.Text == "0")
		{
			d169d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d169d.ForeColor = Color.Black;
		}
	}

	private void h181_Leave(object sender, EventArgs e)
	{
		if (d175d.Text == string.Empty)
		{
			d175d.Text = "0";
		}
		if (d175d.Text == "0")
		{
			d175d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d175d.ForeColor = Color.Black;
		}
	}

	private void h184_Leave(object sender, EventArgs e)
	{
		if (d177d.Text == string.Empty)
		{
			d177d.Text = "0";
		}
		if (d177d.Text == "0")
		{
			d177d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d177d.ForeColor = Color.Black;
		}
	}

	private void h187_Leave(object sender, EventArgs e)
	{
		if (d186d.Text == string.Empty)
		{
			d186d.Text = "0";
		}
		if (d186d.Text == "0")
		{
			d186d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d186d.ForeColor = Color.Black;
		}
	}

	private void h189_Leave(object sender, EventArgs e)
	{
		if (d188d.Text == string.Empty)
		{
			d188d.Text = "0";
		}
		if (d188d.Text == "0")
		{
			d188d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d188d.ForeColor = Color.Black;
		}
	}

	private void h190_Leave(object sender, EventArgs e)
	{
		if (d190d.Text == string.Empty)
		{
			d190d.Text = "0";
		}
		if (d190d.Text == "0")
		{
			d190d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d190d.ForeColor = Color.Black;
		}
	}

	private void h191_Leave(object sender, EventArgs e)
	{
		if (d195d.Text == string.Empty)
		{
			d195d.Text = "0";
		}
		if (d195d.Text == "0")
		{
			d195d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d195d.ForeColor = Color.Black;
		}
	}

	private void h198_Leave(object sender, EventArgs e)
	{
		if (d196d.Text == string.Empty)
		{
			d196d.Text = "0";
		}
		if (d196d.Text == "0")
		{
			d196d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d196d.ForeColor = Color.Black;
		}
	}

	private void h199_Leave(object sender, EventArgs e)
	{
		if (d197d.Text == string.Empty)
		{
			d197d.Text = "0";
		}
		if (d197d.Text == "0")
		{
			d197d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d197d.ForeColor = Color.Black;
		}
	}

	private void h202_Leave(object sender, EventArgs e)
	{
		if (d200d.Text == string.Empty)
		{
			d200d.Text = "0";
		}
		if (d200d.Text == "0")
		{
			d200d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d200d.ForeColor = Color.Black;
		}
	}
	...
	{
		if (d134d.Text == string.Empty)
		{
			d134d.Text = "0";
		}
		if (d134d.Text == "0")
		{
			d134d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d134d.ForeColor = Color.Black;
		}
	}

	private void h131_Leave(object sender, EventArgs e)
	{
		if (d140d.Text == string.Empty)
		{
			d140d.Text = "0";
		}
		if (d140d.Text == "0")
		{
			d140d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d140d.ForeColor = Color.Black;
		}
	}

	private void h133_Leave(object sender, EventArgs e)
	{
		if (d141d.Text == string.Empty)
		{
			d141d.Text = "0";
		}
		if (d141d.Text == "0")
		{
			d141d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d141d.ForeColor = Color.Black;
		}
	}

	private void h139_Leave(object sender, EventArgs e)
	{
		if (d142d.Text == string.Empty)
		{
			d142d.Text = "0";
		}
		if (d142d.Text == "0")
		{
			d142d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d142d.ForeColor = Color.Black;
		}
	}

	private void h144_Leave(object sender, EventArgs e)
	{
		if (d143d.Text == string.Empty)
		{
			d143d.Text = "0";
		}
		if (d143d.Text == "0")
		{
			d143d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d143d.ForeColor = Color.Black;
		}
	}

	private void h146_Leave(object sender, EventArgs e)
	{
		if (d147d.Text == string.Empty)
		{
			d147d.Text = "0";
		}
		if (d147d.Text == "0")
		{
			d147d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d147d.ForeColor = Color.Black;
		}
	}

	private void h147_Leave(object sender, EventArgs e)
	{
		if (d148d.Text == string.Empty)
		{
			d148d.Text = "0";
		}
		if (d148d.Text == "0")
		{
			d148d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d148d.ForeColor = Color.Black;
		}
	}

	private void h148_Leave(object sender, EventArgs e)
	{
		if (d152d.Text == string.Empty)
		{
			d152d.Text = "0";
		}
		if (d152d.Text == "0")
		{
			d152d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d152d.ForeColor = Color.Black;
		}
	}

	private void h149_Leave(object sender, EventArgs e)
	{
		if (d155d.Text == string.Empty)
		{
			d155d.Text = "0";
		}
		if (d155d.Text == "0")
		{
			d155d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d155d.ForeColor = Color.Black;
		}
	}

	private void h203_Leave(object sender, EventArgs e)
	{
		if (d211d.Text == string.Empty)
		{
			d211d.Text = "0";
		}
		if (d211d.Text == "0")
		{
			d211d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d211d.ForeColor = Color.Black;
		}
	}

	private void h204_Leave(object sender, EventArgs e)
	{
		if (d213d.Text == string.Empty)
		{
			d213d.Text = "0";
		}
		if (d213d.Text == "0")
		{
			d213d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d213d.ForeColor = Color.Black;
		}
	}

	private void h205_Leave(object sender, EventArgs e)
	{
		if (d222d.Text == string.Empty)
		{
			d222d.Text = "0";
		}
		if (d222d.Text == "0")
		{
			d222d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d222d.ForeColor = Color.Black;
		}
	}

	private void h206_Leave(object sender, EventArgs e)
	{
		if (d224d.Text == string.Empty)
		{
			d224d.Text = "0";
		}
		if (d224d.Text == "0")
		{
			d224d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d224d.ForeColor = Color.Black;
		}
	}

	private void h208_Leave(object sender, EventArgs e)
	{
		if (d225d.Text == string.Empty)
		{
			d225d.Text = "0";
		}
		if (d225d.Text == "0")
		{
			d225d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d225d.ForeColor = Color.Black;
		}
	}

	private void h209_Leave(object sender, EventArgs e)
	{
		if (d227d.Text == string.Empty)
		{
			d227d.Text = "0";
		}
		if (d227d.Text == "0")
		{
			d227d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d227d.ForeColor = Color.Black;
		}
	}

	private void h210_Leave(object sender, EventArgs e)
	{
		if (d232d.Text == string.Empty)
		{
			d232d.Text = "0";
		}
		if (d232d.Text == "0")
		{
			d232d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d232d.ForeColor = Color.Black;
		}
	}
	...
	{
		if (d157d.Text == string.Empty)
		{
			d157d.Text = "0";
		}
		if (d157d.Text == "0")
		{
			d157d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d157d.ForeColor = Color.Black;
		}
	}

	private void h151_Leave(object sender, EventArgs e)
	{
		if (d159d.Text == string.Empty)
		{
			d159d.Text = "0";
		}
		if (d159d.Text == "0")
		{
			d159d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d159d.ForeColor = Color.Black;
		}
	}

	private void h154_Leave(object sender, EventArgs e)
	{
		if (d161d.Text == string.Empty)
		{
			d161d.Text = "0";
		}
		if (d161d.Text == "0")
		{
			d161d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d161d.ForeColor = Color.Black;
		}
	}
	...
	{
		if (d162d.Text == string.Empty)
		{
			d162d.Text = "0";
		}
		if (d162d.Text == "0")
		{
			d162d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d162d.ForeColor = Color.Black;
		}
	}

	private void h176_Leave(object sender, EventArgs e)
	{
		if (d163d.Text == string.Empty)
		{
			d163d.Text = "0";
		}
		if (d163d.Text == "0")
		{
			d163d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d163d.ForeColor = Color.Black;
		}
	}

	private void h178_Leave(object sender, EventArgs e)
	{
		if (d164d.Text == string.Empty)
		{
			d164d.Text = "0";
		}
		if (d164d.Text == "0")
		{
			d164d.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			d164d.ForeColor = Color.Black;
		}
	}
	...
	private void button5_Click(object sender, EventArgs e)
	{
		...
		{
			string qurey1 = "delete from  candid_d  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			string qurey = "delete from  dhok_hazb  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			SqlCommand cmd = new SqlCommand(qurey, connectionString);
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PUK_Anjamakan.Frm.D_Gshty));
		...
		this.d162d = new System.Windows.Forms.TextBox();
		this.d163d = new System.Windows.Forms.TextBox();
		this.d164d = new System.Windows.Forms.TextBox();
		this.d169d = new System.Windows.Forms.TextBox();
		this.d175d = new System.Windows.Forms.TextBox();
		this.d177d = new System.Windows.Forms.TextBox();
		this.d186d = new System.Windows.Forms.TextBox();
		this.d188d = new System.Windows.Forms.TextBox();
		this.d190d = new System.Windows.Forms.TextBox();
		this.d195d = new System.Windows.Forms.TextBox();
		this.d196d = new System.Windows.Forms.TextBox();
		this.d197d = new System.Windows.Forms.TextBox();
		this.d200d = new System.Windows.Forms.TextBox();
		this.d211d = new System.Windows.Forms.TextBox();
		this.d213d = new System.Windows.Forms.TextBox();
		this.d222d = new System.Windows.Forms.TextBox();
		this.d224d = new System.Windows.Forms.TextBox();
		this.d225d = new System.Windows.Forms.TextBox();
		this.d227d = new System.Windows.Forms.TextBox();
		this.d232d = new System.Windows.Forms.TextBox();
		...
		this.d107d = new System.Windows.Forms.TextBox();
		this.d108d = new System.Windows.Forms.TextBox();
		this.d114d = new System.Windows.Forms.TextBox();
		this.d118d = new System.Windows.Forms.TextBox();
		this.d126d = new System.Windows.Forms.TextBox();
		this.d127d = new System.Windows.Forms.TextBox();
		this.d129d = new System.Windows.Forms.TextBox();
		...
		this.d132d = new System.Windows.Forms.TextBox();
		this.label88 = new System.Windows.Forms.Label();
		this.label84 = new System.Windows.Forms.Label();
		this.label82 = new System.Windows.Forms.Label();
		this.d133d = new System.Windows.Forms.TextBox();
		this.label86 = new System.Windows.Forms.Label();
		this.d134d = new System.Windows.Forms.TextBox();
		this.label80 = new System.Windows.Forms.Label();
		this.label136 = new System.Windows.Forms.Label();
		this.d140d = new System.Windows.Forms.TextBox();
		this.label76 = new System.Windows.Forms.Label();
		this.label138 = new System.Windows.Forms.Label();
		this.d141d = new System.Windows.Forms.TextBox();
		this.label72 = new System.Windows.Forms.Label();
		this.label139 = new System.Windows.Forms.Label();
		this.d142d = new System.Windows.Forms.TextBox();
		this.label69 = new System.Windows.Forms.Label();
		this.label140 = new System.Windows.Forms.Label();
		this.d143d = new System.Windows.Forms.TextBox();
		this.label247 = new System.Windows.Forms.Label();
		this.label142 = new System.Windows.Forms.Label();
		this.d147d = new System.Windows.Forms.TextBox();
		this.label251 = new System.Windows.Forms.Label();
		this.label143 = new System.Windows.Forms.Label();
		this.d148d = new System.Windows.Forms.TextBox();
		this.d152d = new System.Windows.Forms.TextBox();
		this.label144 = new System.Windows.Forms.Label();
		this.label255 = new System.Windows.Forms.Label();
		this.label259 = new System.Windows.Forms.Label();
		this.label146 = new System.Windows.Forms.Label();
		this.d155d = new System.Windows.Forms.TextBox();
		this.label263 = new System.Windows.Forms.Label();
		this.label147 = new System.Windows.Forms.Label();
		this.d157d = new System.Windows.Forms.TextBox();
		this.label267 = new System.Windows.Forms.Label();
		this.label148 = new System.Windows.Forms.Label();
		this.d159d = new System.Windows.Forms.TextBox();
		this.label271 = new System.Windows.Forms.Label();
		this.label150 = new System.Windows.Forms.Label();
		this.d161d = new System.Windows.Forms.TextBox();
		...
		this.txtmalband.Location = new System.Drawing.Point(911, 60);
		this.txtmalband.Multiline = true;
		this.txtmalband.Name = "txtmalband";
		this.txtmalband.ReadOnly = true;
		this.txtmalband.Size = new System.Drawing.Size(60, 50);
		...
		this.txtparezga.Location = new System.Drawing.Point(794, 60);
		this.txtparezga.Multiline = true;
		this.txtparezga.Name = "txtparezga";
		this.txtparezga.ReadOnly = true;
		this.txtparezga.Size = new System.Drawing.Size(111, 50);
		...
		this.txtcoodtasj.Location = new System.Drawing.Point(653, 60);
		this.txtcoodtasj.Multiline = true;
		this.txtcoodtasj.Name = "txtcoodtasj";
		this.txtcoodtasj.ReadOnly = true;
		this.txtcoodtasj.Size = new System.Drawing.Size(135, 50);
		...
		this.txtnawtasj.Location = new System.Drawing.Point(462, 60);
		this.txtnawtasj.Multiline = true;
		this.txtnawtasj.Name = "txtnawtasj";
		this.txtnawtasj.ReadOnly = true;
		this.txtnawtasj.Size = new System.Drawing.Size(185, 50);
		...
		this.txtnawbnka.Location = new System.Drawing.Point(214, 60);
		this.txtnawbnka.Multiline = true;
		this.txtnawbnka.Name = "txtnawbnka";
		this.txtnawbnka.ReadOnly = true;
		this.txtnawbnka.Size = new System.Drawing.Size(242, 50);
		...
		this.txtbnkacood.Location = new System.Drawing.Point(1127, 60);
		this.txtbnkacood.Multiline = true;
		this.txtbnkacood.Name = "txtbnkacood";
		this.txtbnkacood.Size = new System.Drawing.Size(227, 50);
		...
		this.txtwestga.Location = new System.Drawing.Point(138, 60);
		this.txtwestga.Multiline = true;
		this.txtwestga.Name = "txtwestga";
		this.txtwestga.ReadOnly = true;
		this.txtwestga.Size = new System.Drawing.Size(70, 50);
		...
		this.txtzhdangdar.Size = new System.Drawing.Size(129, 50);
		...
		this.label11.Size = new System.Drawing.Size(70, 57);
		...
		this.label7.Location = new System.Drawing.Point(462, 0);
		...
		this.label9.Size = new System.Drawing.Size(135, 57);
		...
		this.label10.Location = new System.Drawing.Point(794, 0);
		this.label10.Name = "label10";
		this.label10.Size = new System.Drawing.Size(111, 57);
		...
		this.label6.Location = new System.Drawing.Point(977, 0);
		this.label6.Name = "label6";
		this.label6.Size = new System.Drawing.Size(144, 57);
		...
		this.btnsearch.Location = new System.Drawing.Point(977, 60);
		...
		this.bnltablsearch.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 190f));
		...
		this.label49.Location = new System.Drawing.Point(1166, 0);
		this.label49.Name = "label49";
		this.label49.Size = new System.Drawing.Size(188, 60);
		...
		this.comwestga.Location = new System.Drawing.Point(1015, 3);
		...
		this.label4.Size = new System.Drawing.Size(238, 60);
		...
		this.txtwaraqadrost.Location = new System.Drawing.Point(498, 3);
		this.txtwaraqadrost.Multiline = true;
		this.txtwaraqadrost.Name = "txtwaraqadrost";
		this.txtwaraqadrost.Size = new System.Drawing.Size(68, 54);
		...
		this.txtwaraqaybatl.Location = new System.Drawing.Point(162, 3);
		this.txtwaraqaybatl.Multiline = true;
		this.txtwaraqaybatl.Name = "txtwaraqaybatl";
		this.txtwaraqaybatl.Size = new System.Drawing.Size(82, 54);
		...
		this.btn_candid_d.Text = " لیستی قەوارەکانی پارێزگای دهۆک ";
		...
		this.tableLayoutPanel7.Controls.Add(this.d162d, 5, 0);
		this.tableLayoutPanel7.Controls.Add(this.d163d, 5, 1);
		this.tableLayoutPanel7.Controls.Add(this.d164d, 5, 2);
		this.tableLayoutPanel7.Controls.Add(this.d169d, 5, 3);
		this.tableLayoutPanel7.Controls.Add(this.d175d, 5, 4);
		this.tableLayoutPanel7.Controls.Add(this.d177d, 5, 5);
		this.tableLayoutPanel7.Controls.Add(this.d186d, 5, 6);
		this.tableLayoutPanel7.Controls.Add(this.d188d, 5, 7);
		this.tableLayoutPanel7.Controls.Add(this.d190d, 5, 8);
		this.tableLayoutPanel7.Controls.Add(this.d195d, 5, 9);
		this.tableLayoutPanel7.Controls.Add(this.d196d, 5, 10);
		this.tableLayoutPanel7.Controls.Add(this.d197d, 5, 11);
		this.tableLayoutPanel7.Controls.Add(this.d200d, 5, 12);
		this.tableLayoutPanel7.Controls.Add(this.d211d, 5, 13);
		this.tableLayoutPanel7.Controls.Add(this.d213d, 5, 14);
		this.tableLayoutPanel7.Controls.Add(this.d222d, 5, 15);
		this.tableLayoutPanel7.Controls.Add(this.d224d, 5, 16);
		this.tableLayoutPanel7.Controls.Add(this.d225d, 5, 17);
		this.tableLayoutPanel7.Controls.Add(this.d227d, 5, 18);
		this.tableLayoutPanel7.Controls.Add(this.d232d, 5, 19);
		...
		this.tableLayoutPanel7.Controls.Add(this.d107d, 8, 0);
		this.tableLayoutPanel7.Controls.Add(this.d108d, 8, 1);
		this.tableLayoutPanel7.Controls.Add(this.d114d, 8, 2);
		this.tableLayoutPanel7.Controls.Add(this.d118d, 8, 3);
		this.tableLayoutPanel7.Controls.Add(this.d126d, 8, 4);
		this.tableLayoutPanel7.Controls.Add(this.d127d, 8, 5);
		this.tableLayoutPanel7.Controls.Add(this.d129d, 8, 6);
		...
		this.tableLayoutPanel7.Controls.Add(this.d132d, 8, 7);
		...
		this.d162d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d162d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d162d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d162d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d162d.Location = new System.Drawing.Point(402, 3);
		this.d162d.Multiline = true;
		this.d162d.Name = "d162d";
		this.d162d.Size = new System.Drawing.Size(106, 48);
		this.d162d.TabIndex = 36;
		this.d162d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d162d.Click += new System.EventHandler(h173_Click);
		this.d162d.TextChanged += new System.EventHandler(h173_TextChanged);
		this.d162d.KeyDown += new System.Windows.Forms.KeyEventHandler(h173_KeyDown);
		this.d162d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h173_KeyPress);
		this.d162d.Leave += new System.EventHandler(h173_Leave);
		this.d163d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d163d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d163d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d163d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d163d.Location = new System.Drawing.Point(402, 57);
		this.d163d.Multiline = true;
		this.d163d.Name = "d163d";
		this.d163d.Size = new System.Drawing.Size(106, 48);
		this.d163d.TabIndex = 37;
		this.d163d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d163d.Click += new System.EventHandler(h176_Click);
		this.d163d.TextChanged += new System.EventHandler(h176_TextChanged);
		this.d163d.KeyDown += new System.Windows.Forms.KeyEventHandler(h176_KeyDown);
		this.d163d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h176_KeyPress);
		this.d163d.Leave += new System.EventHandler(h176_Leave);
		this.d164d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d164d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d164d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d164d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d164d.Location = new System.Drawing.Point(402, 111);
		this.d164d.Multiline = true;
		this.d164d.Name = "d164d";
		this.d164d.Size = new System.Drawing.Size(106, 48);
		this.d164d.TabIndex = 38;
		this.d164d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d164d.Click += new System.EventHandler(h178_Click);
		this.d164d.TextChanged += new System.EventHandler(h178_TextChanged);
		this.d164d.KeyDown += new System.Windows.Forms.KeyEventHandler(h178_KeyDown);
		this.d164d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h178_KeyPress);
		this.d164d.Leave += new System.EventHandler(h178_Leave);
		this.d169d.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		this.d169d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d169d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d169d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d169d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d169d.Location = new System.Drawing.Point(402, 165);
		this.d169d.Multiline = true;
		this.d169d.Name = "d169d";
		this.d169d.Size = new System.Drawing.Size(106, 48);
		this.d169d.TabIndex = 39;
		this.d169d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d169d.TextChanged += new System.EventHandler(h179_TextChanged);
		this.d169d.KeyDown += new System.Windows.Forms.KeyEventHandler(h179_KeyDown);
		this.d169d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h179_KeyPress);
		this.d169d.Leave += new System.EventHandler(h179_Leave);
		this.d175d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d175d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d175d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d175d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d175d.Location = new System.Drawing.Point(402, 219);
		this.d175d.Multiline = true;
		this.d175d.Name = "d175d";
		this.d175d.Size = new System.Drawing.Size(106, 48);
		this.d175d.TabIndex = 40;
		this.d175d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d175d.TextChanged += new System.EventHandler(h181_TextChanged);
		this.d175d.KeyDown += new System.Windows.Forms.KeyEventHandler(h181_KeyDown);
		this.d175d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h181_KeyPress);
		this.d175d.Leave += new System.EventHandler(h181_Leave);
		this.d177d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d177d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d177d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d177d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d177d.Location = new System.Drawing.Point(402, 273);
		this.d177d.Multiline = true;
		this.d177d.Name = "d177d";
		this.d177d.Size = new System.Drawing.Size(106, 48);
		this.d177d.TabIndex = 41;
		this.d177d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d177d.Click += new System.EventHandler(h184_Click);
		this.d177d.TextChanged += new System.EventHandler(h184_TextChanged);
		this.d177d.KeyDown += new System.Windows.Forms.KeyEventHandler(h184_KeyDown);
		this.d177d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h184_KeyPress);
		this.d177d.Leave += new System.EventHandler(h184_Leave);
		this.d186d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d186d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d186d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d186d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d186d.Location = new System.Drawing.Point(402, 327);
		this.d186d.Multiline = true;
		this.d186d.Name = "d186d";
		this.d186d.Size = new System.Drawing.Size(106, 48);
		this.d186d.TabIndex = 42;
		this.d186d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d186d.Click += new System.EventHandler(h187_Click);
		this.d186d.TextChanged += new System.EventHandler(h187_TextChanged);
		this.d186d.KeyDown += new System.Windows.Forms.KeyEventHandler(h187_KeyDown);
		this.d186d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h187_KeyPress);
		this.d186d.Leave += new System.EventHandler(h187_Leave);
		this.d188d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d188d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d188d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d188d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d188d.Location = new System.Drawing.Point(402, 381);
		this.d188d.Multiline = true;
		this.d188d.Name = "d188d";
		this.d188d.Size = new System.Drawing.Size(106, 48);
		this.d188d.TabIndex = 43;
		this.d188d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d188d.Click += new System.EventHandler(h189_Click);
		this.d188d.TextChanged += new System.EventHandler(h189_TextChanged);
		this.d188d.KeyDown += new System.Windows.Forms.KeyEventHandler(h189_KeyDown);
		this.d188d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h189_KeyPress);
		this.d188d.Leave += new System.EventHandler(h189_Leave);
		this.d190d.BackColor = System.Drawing.Color.Yellow;
		this.d190d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d190d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d190d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d190d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d190d.Location = new System.Drawing.Point(402, 435);
		this.d190d.Multiline = true;
		this.d190d.Name = "d190d";
		this.d190d.Size = new System.Drawing.Size(106, 48);
		this.d190d.TabIndex = 44;
		this.d190d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d190d.Click += new System.EventHandler(h190_Click);
		this.d190d.TextChanged += new System.EventHandler(h190_TextChanged);
		this.d190d.KeyDown += new System.Windows.Forms.KeyEventHandler(h190_KeyDown);
		this.d190d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h190_KeyPress);
		this.d190d.Leave += new System.EventHandler(h190_Leave);
		this.d195d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d195d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d195d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d195d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d195d.Location = new System.Drawing.Point(402, 489);
		this.d195d.Multiline = true;
		this.d195d.Name = "d195d";
		this.d195d.Size = new System.Drawing.Size(106, 48);
		this.d195d.TabIndex = 45;
		this.d195d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d195d.Click += new System.EventHandler(h191_Click);
		this.d195d.TextChanged += new System.EventHandler(h191_TextChanged);
		this.d195d.KeyDown += new System.Windows.Forms.KeyEventHandler(h191_KeyDown);
		this.d195d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h191_KeyPress);
		this.d195d.Leave += new System.EventHandler(h191_Leave);
		this.d196d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d196d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d196d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d196d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d196d.Location = new System.Drawing.Point(402, 543);
		this.d196d.Multiline = true;
		this.d196d.Name = "d196d";
		this.d196d.Size = new System.Drawing.Size(106, 48);
		this.d196d.TabIndex = 46;
		this.d196d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d196d.Click += new System.EventHandler(h198_Click);
		this.d196d.TextChanged += new System.EventHandler(h198_TextChanged);
		this.d196d.KeyDown += new System.Windows.Forms.KeyEventHandler(h198_KeyDown);
		this.d196d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h198_KeyPress);
		this.d196d.Leave += new System.EventHandler(h198_Leave);
		this.d197d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d197d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d197d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d197d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d197d.Location = new System.Drawing.Point(402, 597);
		this.d197d.Multiline = true;
		this.d197d.Name = "d197d";
		this.d197d.Size = new System.Drawing.Size(106, 48);
		this.d197d.TabIndex = 47;
		this.d197d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d197d.Click += new System.EventHandler(h199_Click);
		this.d197d.TextChanged += new System.EventHandler(h199_TextChanged);
		this.d197d.KeyDown += new System.Windows.Forms.KeyEventHandler(h199_KeyDown);
		this.d197d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h199_KeyPress);
		this.d197d.Leave += new System.EventHandler(h199_Leave);
		this.d200d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d200d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d200d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d200d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d200d.Location = new System.Drawing.Point(402, 651);
		this.d200d.Multiline = true;
		this.d200d.Name = "d200d";
		this.d200d.Size = new System.Drawing.Size(106, 48);
		this.d200d.TabIndex = 48;
		this.d200d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d200d.Click += new System.EventHandler(h202_Click);
		this.d200d.TextChanged += new System.EventHandler(h202_TextChanged);
		this.d200d.KeyDown += new System.Windows.Forms.KeyEventHandler(h202_KeyDown);
		this.d200d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h202_KeyPress);
		this.d200d.Leave += new System.EventHandler(h202_Leave);
		this.d211d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d211d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d211d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d211d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d211d.Location = new System.Drawing.Point(402, 705);
		this.d211d.Multiline = true;
		this.d211d.Name = "d211d";
		this.d211d.Size = new System.Drawing.Size(106, 48);
		this.d211d.TabIndex = 49;
		this.d211d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d211d.Click += new System.EventHandler(h203_Click);
		this.d211d.TextChanged += new System.EventHandler(h203_TextChanged);
		this.d211d.KeyDown += new System.Windows.Forms.KeyEventHandler(h203_KeyDown);
		this.d211d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h203_KeyPress);
		this.d211d.Leave += new System.EventHandler(h203_Leave);
		this.d213d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d213d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d213d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d213d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d213d.Location = new System.Drawing.Point(402, 759);
		this.d213d.Multiline = true;
		this.d213d.Name = "d213d";
		this.d213d.Size = new System.Drawing.Size(106, 48);
		this.d213d.TabIndex = 50;
		this.d213d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d213d.Click += new System.EventHandler(h204_Click);
		this.d213d.TextChanged += new System.EventHandler(h204_TextChanged);
		this.d213d.KeyDown += new System.Windows.Forms.KeyEventHandler(h204_KeyDown);
		this.d213d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h204_KeyPress);
		this.d213d.Leave += new System.EventHandler(h204_Leave);
		this.d222d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d222d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d222d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d222d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d222d.Location = new System.Drawing.Point(402, 813);
		this.d222d.Multiline = true;
		this.d222d.Name = "d222d";
		this.d222d.Size = new System.Drawing.Size(106, 48);
		this.d222d.TabIndex = 51;
		this.d222d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d222d.Click += new System.EventHandler(h205_Click);
		this.d222d.TextChanged += new System.EventHandler(h205_TextChanged);
		this.d222d.KeyDown += new System.Windows.Forms.KeyEventHandler(h205_KeyDown);
		this.d222d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h205_KeyPress);
		this.d222d.Leave += new System.EventHandler(h205_Leave);
		this.d224d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d224d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d224d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d224d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d224d.Location = new System.Drawing.Point(402, 867);
		this.d224d.Multiline = true;
		this.d224d.Name = "d224d";
		this.d224d.Size = new System.Drawing.Size(106, 48);
		this.d224d.TabIndex = 52;
		this.d224d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d224d.Click += new System.EventHandler(h206_Click);
		this.d224d.TextChanged += new System.EventHandler(h206_TextChanged);
		this.d224d.KeyDown += new System.Windows.Forms.KeyEventHandler(h206_KeyDown);
		this.d224d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h206_KeyPress);
		this.d224d.Leave += new System.EventHandler(h206_Leave);
		this.d225d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d225d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d225d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d225d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d225d.Location = new System.Drawing.Point(402, 921);
		this.d225d.Multiline = true;
		this.d225d.Name = "d225d";
		this.d225d.Size = new System.Drawing.Size(106, 48);
		this.d225d.TabIndex = 53;
		this.d225d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d225d.Click += new System.EventHandler(h208_Click);
		this.d225d.TextChanged += new System.EventHandler(h208_TextChanged);
		this.d225d.KeyDown += new System.Windows.Forms.KeyEventHandler(h208_KeyDown);
		this.d225d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h208_KeyPress);
		this.d225d.Leave += new System.EventHandler(h208_Leave);
		this.d227d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d227d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d227d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d227d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d227d.Location = new System.Drawing.Point(402, 975);
		this.d227d.Multiline = true;
		this.d227d.Name = "d227d";
		this.d227d.Size = new System.Drawing.Size(106, 48);
		this.d227d.TabIndex = 54;
		this.d227d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d227d.Click += new System.EventHandler(h209_Click);
		this.d227d.TextChanged += new System.EventHandler(h209_TextChanged);
		this.d227d.KeyDown += new System.Windows.Forms.KeyEventHandler(h209_KeyDown);
		this.d227d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h209_KeyPress);
		this.d227d.Leave += new System.EventHandler(h209_Leave);
		this.d232d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d232d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d232d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d232d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d232d.Location = new System.Drawing.Point(402, 1029);
		this.d232d.Multiline = true;
		this.d232d.Name = "d232d";
		this.d232d.Size = new System.Drawing.Size(106, 48);
		this.d232d.TabIndex = 55;
		this.d232d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d232d.Click += new System.EventHandler(h210_Click);
		this.d232d.TextChanged += new System.EventHandler(h210_TextChanged);
		this.d232d.KeyDown += new System.Windows.Forms.KeyEventHandler(h210_KeyDown);
		this.d232d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h210_KeyPress);
		this.d232d.Leave += new System.EventHandler(h210_Leave);
		...
		this.label18.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		...
		this.label34.Text = "المحامیة /سفیرة صدقي خورشيد";
		...
		this.label59.Font = new System.Drawing.Font("Unikurd Jino", 13.8f);
		...
		this.label96.Text = "هاوپەیمانی نیشتیمانی ";
		...
		this.label97.Text = "سربست طاهر کەمەکی";
		...
		this.label98.Text = "سەردەم";
		this.label98.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label99.AutoSize = true;
		this.label99.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		...
		this.label100.Text = "نهاد طیب محمود اغا جمانکي برواري";
		...
		this.label101.Text = "پلڤان برهان علاءالدین بەرگارەى ";
		...
		this.label102.Text = "ماهر محمد اسماعیل";
		...
		this.label103.Text = "خێرخواز/شیروان احمد بارانی ";
		this.label103.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label103.Click += new System.EventHandler(label26_Click);
		this.label104.AutoSize = true;
		this.label104.BackColor = System.Drawing.Color.Yellow;
		...
		this.label104.Text = "پارتی دیموکراتی کوردستان";
		...
		this.label105.Text = "دکتور عیسى نسري";
		...
		this.label106.Text = "اسلام يوسف سندي";
		...
		this.label107.Text = "داود هوهان داود";
		...
		this.label108.Text = "وليم بنيامين ادم شليمون ";
		...
		this.label109.Text = "د.جيمس حسدو هيدو";
		...
		this.label110.Text = "ايشخان ارشاك كيفوركيان";
		...
		this.label111.Text = "الدكتورة سرى البوتاني ";
		...
		this.label112.Text = "رافي ميران يوسف ";
		...
		this.label115.Text = "روبينة اويملك عزيز";
		...
		this.d107d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d107d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d107d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d107d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d107d.Location = new System.Drawing.Point(856, 3);
		this.d107d.Multiline = true;
		this.d107d.Name = "d107d";
		this.d107d.Size = new System.Drawing.Size(103, 48);
		this.d107d.TabIndex = 0;
		this.d107d.Text = " ";
		this.d107d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d107d.Click += new System.EventHandler(h102_Click);
		this.d107d.TextChanged += new System.EventHandler(h102_TextChanged);
		this.d107d.KeyDown += new System.Windows.Forms.KeyEventHandler(h102_KeyDown);
		this.d107d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h102_KeyPress);
		this.d107d.Leave += new System.EventHandler(h102_Leave);
		this.d108d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d108d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d108d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d108d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d108d.Location = new System.Drawing.Point(856, 57);
		this.d108d.Multiline = true;
		this.d108d.Name = "d108d";
		this.d108d.Size = new System.Drawing.Size(103, 48);
		this.d108d.TabIndex = 1;
		this.d108d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d108d.Click += new System.EventHandler(h103_Click);
		this.d108d.TextChanged += new System.EventHandler(h103_TextChanged);
		this.d108d.KeyDown += new System.Windows.Forms.KeyEventHandler(h103_KeyDown);
		this.d108d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h103_KeyPress);
		this.d108d.Leave += new System.EventHandler(h103_Leave);
		this.d114d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d114d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d114d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d114d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d114d.Location = new System.Drawing.Point(856, 111);
		this.d114d.Multiline = true;
		this.d114d.Name = "d114d";
		this.d114d.Size = new System.Drawing.Size(103, 48);
		this.d114d.TabIndex = 2;
		this.d114d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d114d.Click += new System.EventHandler(h105_Click);
		this.d114d.TextChanged += new System.EventHandler(h105_TextChanged);
		this.d114d.KeyDown += new System.Windows.Forms.KeyEventHandler(h105_KeyDown);
		this.d114d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h105_KeyPress);
		this.d114d.Leave += new System.EventHandler(h105_Leave);
		this.d118d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d118d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d118d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d118d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d118d.Location = new System.Drawing.Point(856, 165);
		this.d118d.Multiline = true;
		this.d118d.Name = "d118d";
		this.d118d.Size = new System.Drawing.Size(103, 48);
		this.d118d.TabIndex = 3;
		this.d118d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d118d.Click += new System.EventHandler(h106_Click);
		this.d118d.TextChanged += new System.EventHandler(h106_TextChanged);
		this.d118d.KeyDown += new System.Windows.Forms.KeyEventHandler(h106_KeyDown);
		this.d118d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h106_KeyPress);
		this.d118d.Leave += new System.EventHandler(h106_Leave);
		this.d126d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d126d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d126d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d126d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d126d.Location = new System.Drawing.Point(856, 219);
		this.d126d.Multiline = true;
		this.d126d.Name = "d126d";
		this.d126d.Size = new System.Drawing.Size(103, 48);
		this.d126d.TabIndex = 4;
		this.d126d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d126d.Click += new System.EventHandler(h109_Click);
		this.d126d.TextChanged += new System.EventHandler(h109_TextChanged);
		this.d126d.KeyDown += new System.Windows.Forms.KeyEventHandler(h109_KeyDown);
		this.d126d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h109_KeyPress);
		this.d126d.Leave += new System.EventHandler(h109_Leave);
		this.d127d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d127d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d127d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d127d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d127d.Location = new System.Drawing.Point(856, 273);
		this.d127d.Multiline = true;
		this.d127d.Name = "d127d";
		this.d127d.Size = new System.Drawing.Size(103, 48);
		this.d127d.TabIndex = 5;
		this.d127d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d127d.Click += new System.EventHandler(h111_Click);
		this.d127d.TextChanged += new System.EventHandler(h111_TextChanged);
		this.d127d.KeyDown += new System.Windows.Forms.KeyEventHandler(h111_KeyDown);
		this.d127d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h111_KeyPress);
		this.d127d.Leave += new System.EventHandler(h111_Leave);
		this.d129d.BackColor = System.Drawing.Color.Aquamarine;
		this.d129d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d129d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d129d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d129d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d129d.Location = new System.Drawing.Point(856, 327);
		this.d129d.Multiline = true;
		this.d129d.Name = "d129d";
		this.d129d.Size = new System.Drawing.Size(103, 48);
		this.d129d.TabIndex = 6;
		this.d129d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d129d.Click += new System.EventHandler(h112_Click);
		this.d129d.TextChanged += new System.EventHandler(h112_TextChanged);
		this.d129d.KeyDown += new System.Windows.Forms.KeyEventHandler(h112_KeyDown);
		this.d129d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h112_KeyPress);
		this.d129d.Leave += new System.EventHandler(h112_Leave);
		...
		this.label29.Text = "مامۆستا وحید ابراهیم زیباري";
		...
		this.label33.Text = "دکتور عثمان کریم عمر فندي";
		...
		this.label37.Text = "گوران (التغیر)";
		...
		this.label41.Text = "محمد میرکەتی بەرکارەی";
		...
		this.label67.Text = "لقمان مجید-ابو حکیم";
		...
		this.label70.Text = "یەکێتی نیشتیمانی کوردستان";
		...
		this.label78.Text = "دلیر مهدی مصطفى الزیباري";
		this.label78.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d132d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d132d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d132d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d132d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d132d.Location = new System.Drawing.Point(856, 381);
		this.d132d.Multiline = true;
		this.d132d.Name = "d132d";
		this.d132d.Size = new System.Drawing.Size(103, 48);
		this.d132d.TabIndex = 8;
		this.d132d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d132d.Click += new System.EventHandler(h120_Click);
		this.d132d.TextChanged += new System.EventHandler(h120_TextChanged);
		this.d132d.KeyDown += new System.Windows.Forms.KeyEventHandler(h120_KeyDown);
		this.d132d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h120_KeyPress);
		this.d132d.Leave += new System.EventHandler(h120_Leave);
		...
		this.label82.Text = "هاوپەیمانی هەرێمی کوردستان";
		this.label82.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d133d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d133d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d133d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d133d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d133d.Location = new System.Drawing.Point(856, 435);
		this.d133d.Multiline = true;
		this.d133d.Name = "d133d";
		this.d133d.Size = new System.Drawing.Size(103, 48);
		this.d133d.TabIndex = 9;
		this.d133d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d133d.Click += new System.EventHandler(h123_Click);
		this.d133d.TextChanged += new System.EventHandler(h123_TextChanged);
		this.d133d.KeyDown += new System.Windows.Forms.KeyEventHandler(h123_KeyDown);
		this.d133d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h123_KeyPress);
		this.d133d.Leave += new System.EventHandler(h123_Leave);
		...
		this.label86.Text = "صباح اتروشی";
		this.label86.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d134d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d134d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d134d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d134d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d134d.Location = new System.Drawing.Point(856, 489);
		this.d134d.Multiline = true;
		this.d134d.Name = "d134d";
		this.d134d.Size = new System.Drawing.Size(103, 48);
		this.d134d.TabIndex = 10;
		this.d134d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d134d.Click += new System.EventHandler(h129_Click);
		this.d134d.TextChanged += new System.EventHandler(h129_TextChanged);
		this.d134d.KeyDown += new System.Windows.Forms.KeyEventHandler(h129_KeyDown);
		this.d134d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h129_KeyPress);
		this.d134d.Leave += new System.EventHandler(h129_Leave);
		...
		this.label136.Text = "مسعود ورمیلی ";
		this.label136.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d140d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d140d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d140d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d140d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d140d.Location = new System.Drawing.Point(856, 543);
		this.d140d.Multiline = true;
		this.d140d.Name = "d140d";
		this.d140d.Size = new System.Drawing.Size(103, 48);
		this.d140d.TabIndex = 11;
		this.d140d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d140d.Click += new System.EventHandler(h131_Click);
		this.d140d.TextChanged += new System.EventHandler(h131_TextChanged);
		this.d140d.KeyDown += new System.Windows.Forms.KeyEventHandler(h131_KeyDown);
		this.d140d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h131_KeyPress);
		this.d140d.Leave += new System.EventHandler(h131_Leave);
		...
		this.label138.Text = "سعدي صدیق صالح";
		this.label138.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d141d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d141d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d141d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d141d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d141d.Location = new System.Drawing.Point(856, 597);
		this.d141d.Multiline = true;
		this.d141d.Name = "d141d";
		this.d141d.Size = new System.Drawing.Size(103, 48);
		this.d141d.TabIndex = 12;
		this.d141d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d141d.Click += new System.EventHandler(h133_Click);
		this.d141d.TextChanged += new System.EventHandler(h133_TextChanged);
		this.d141d.KeyDown += new System.Windows.Forms.KeyEventHandler(h133_KeyDown);
		this.d141d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h133_KeyPress);
		this.d141d.Leave += new System.EventHandler(h133_Leave);
		...
		this.label139.Text = "اراز جعفر رمضان";
		this.label139.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d142d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d142d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d142d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d142d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d142d.Location = new System.Drawing.Point(856, 651);
		this.d142d.Multiline = true;
		this.d142d.Name = "d142d";
		this.d142d.Size = new System.Drawing.Size(103, 48);
		this.d142d.TabIndex = 13;
		this.d142d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d142d.Click += new System.EventHandler(h139_Click);
		this.d142d.TextChanged += new System.EventHandler(h139_TextChanged);
		this.d142d.KeyDown += new System.Windows.Forms.KeyEventHandler(h139_KeyDown);
		this.d142d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h139_KeyPress);
		this.d142d.Leave += new System.EventHandler(h139_Leave);
		...
		this.label140.Text = "عبدالعزیز سلیمان برواري";
		this.label140.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d143d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d143d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d143d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d143d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d143d.Location = new System.Drawing.Point(856, 705);
		this.d143d.Multiline = true;
		this.d143d.Name = "d143d";
		this.d143d.Size = new System.Drawing.Size(103, 48);
		this.d143d.TabIndex = 14;
		this.d143d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d143d.Click += new System.EventHandler(h144_Click);
		this.d143d.TextChanged += new System.EventHandler(h144_TextChanged);
		this.d143d.KeyDown += new System.Windows.Forms.KeyEventHandler(h144_KeyDown);
		this.d143d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h144_KeyPress);
		this.d143d.Leave += new System.EventHandler(h144_Leave);
		...
		this.label142.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		...
		this.label142.Text = "کۆمەڵی دادگەری کوردستان/عێڕاق";
		this.label142.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d147d.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		this.d147d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d147d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d147d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d147d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d147d.Location = new System.Drawing.Point(856, 759);
		this.d147d.Multiline = true;
		this.d147d.Name = "d147d";
		this.d147d.Size = new System.Drawing.Size(103, 48);
		this.d147d.TabIndex = 15;
		this.d147d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d147d.Click += new System.EventHandler(h146_Click);
		this.d147d.TextChanged += new System.EventHandler(h146_TextChanged);
		this.d147d.KeyDown += new System.Windows.Forms.KeyEventHandler(h146_KeyDown);
		this.d147d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h146_KeyPress);
		this.d147d.Leave += new System.EventHandler(h146_Leave);
		...
		this.label143.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		...
		this.label143.Text = "یەکگرتووی ئیسلامی کوردستان ";
		this.label143.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d148d.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		this.d148d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d148d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d148d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d148d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d148d.Location = new System.Drawing.Point(856, 813);
		this.d148d.Multiline = true;
		this.d148d.Name = "d148d";
		this.d148d.Size = new System.Drawing.Size(103, 48);
		this.d148d.TabIndex = 16;
		this.d148d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d148d.Click += new System.EventHandler(h147_Click);
		this.d148d.TextChanged += new System.EventHandler(h147_TextChanged);
		this.d148d.KeyDown += new System.Windows.Forms.KeyEventHandler(h147_KeyDown);
		this.d148d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h147_KeyPress);
		this.d148d.Leave += new System.EventHandler(h147_Leave);
		this.d152d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d152d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d152d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d152d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d152d.Location = new System.Drawing.Point(856, 867);
		this.d152d.Multiline = true;
		this.d152d.Name = "d152d";
		this.d152d.Size = new System.Drawing.Size(103, 48);
		this.d152d.TabIndex = 17;
		this.d152d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d152d.Click += new System.EventHandler(h148_Click);
		this.d152d.TextChanged += new System.EventHandler(h148_TextChanged);
		this.d152d.KeyDown += new System.Windows.Forms.KeyEventHandler(h148_KeyDown);
		this.d152d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h148_KeyPress);
		this.d152d.Leave += new System.EventHandler(h148_Leave);
		...
		this.label144.Text = "عاید ئاکرەیی";
		...
		this.label146.Text = "سیروان محمد شیخ زادە سورچی";
		this.label146.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d155d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d155d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d155d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d155d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d155d.Location = new System.Drawing.Point(856, 921);
		this.d155d.Multiline = true;
		this.d155d.Name = "d155d";
		this.d155d.Size = new System.Drawing.Size(103, 48);
		this.d155d.TabIndex = 18;
		this.d155d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d155d.Click += new System.EventHandler(h149_Click);
		this.d155d.TextChanged += new System.EventHandler(h149_TextChanged);
		this.d155d.KeyDown += new System.Windows.Forms.KeyEventHandler(h149_KeyDown);
		this.d155d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h149_KeyPress);
		this.d155d.Leave += new System.EventHandler(h149_Leave);
		this.label263.AutoSize = true;
		this.label263.BackColor = System.Drawing.Color.FromArgb(255, 224, 192);
		...
		this.label263.Text = "157";
		this.label263.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label147.AutoSize = true;
		this.label147.BackColor = System.Drawing.Color.FromArgb(255, 224, 192);
		...
		this.label147.Text = "نەوەى نوێ";
		this.label147.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d157d.BackColor = System.Drawing.Color.FromArgb(255, 224, 192);
		this.d157d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d157d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d157d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d157d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d157d.Location = new System.Drawing.Point(856, 975);
		this.d157d.Multiline = true;
		this.d157d.Name = "d157d";
		this.d157d.Size = new System.Drawing.Size(103, 48);
		this.d157d.TabIndex = 19;
		this.d157d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d157d.Click += new System.EventHandler(h150_Click);
		this.d157d.TextChanged += new System.EventHandler(h150_TextChanged);
		this.d157d.KeyDown += new System.Windows.Forms.KeyEventHandler(h150_KeyDown);
		this.d157d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h150_KeyPress);
		this.d157d.Leave += new System.EventHandler(h150_Leave);
		...
		this.label148.Text = "دکتور صابر محمد قادر";
		this.label148.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d159d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d159d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d159d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d159d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d159d.Location = new System.Drawing.Point(856, 1029);
		this.d159d.Multiline = true;
		this.d159d.Name = "d159d";
		this.d159d.Size = new System.Drawing.Size(103, 48);
		this.d159d.TabIndex = 20;
		this.d159d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d159d.Click += new System.EventHandler(h151_Click);
		this.d159d.TextChanged += new System.EventHandler(h151_TextChanged);
		this.d159d.KeyDown += new System.Windows.Forms.KeyEventHandler(h151_KeyDown);
		this.d159d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h151_KeyPress);
		this.d159d.Leave += new System.EventHandler(h151_Leave);
		this.label271.AutoSize = true;
		this.label271.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label271.Text = "161";
		this.label271.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label150.AutoSize = true;
		this.label150.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label150.Text = "هەڵوێست";
		this.label150.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.d161d.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		this.d161d.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.d161d.Dock = System.Windows.Forms.DockStyle.Fill;
		this.d161d.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.d161d.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.d161d.Location = new System.Drawing.Point(856, 1083);
		this.d161d.Multiline = true;
		this.d161d.Name = "d161d";
		this.d161d.Size = new System.Drawing.Size(103, 48);
		this.d161d.TabIndex = 21;
		this.d161d.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.d161d.Click += new System.EventHandler(h154_Click);
		this.d161d.TextChanged += new System.EventHandler(h154_TextChanged);
		this.d161d.KeyDown += new System.Windows.Forms.KeyEventHandler(h154_KeyDown);
		this.d161d.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h154_KeyPress);
		this.d161d.Leave += new System.EventHandler(h154_Leave);
		this.s138s.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.s138s.Dock = System.Windows.Forms.DockStyle.Fill;
		this.s138s.Enabled = false;
		...
		this.label114.Text = "فادي بولص حنا";
