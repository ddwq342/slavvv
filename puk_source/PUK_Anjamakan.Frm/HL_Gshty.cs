...
public class HL_Gshty : Form
{
	...
	private TextBox hl162hl;

	private TextBox s165s;

	private TextBox hl161hl;
	...
	private TextBox hl157hl;

	private TextBox hl148hl;

	private TextBox hl147hl;

	private TextBox hl133hl;

	private TextBox hl190hl;

	private TextBox hl198hl;

	private TextBox hl129hl;

	private TextBox hl172hl;

	private TextBox hl123hl;

	private TextBox hl114hl;

	private TextBox hl169hl;

	private TableLayoutPanel tableLayoutPanel7;

	private TextBox hl164hl;
	...
	private void totals()
	{
		try
		{
			double To2 = (double)int.Parse(hl114hl.Text) + Convert.ToDouble(hl123hl.Text) + Convert.ToDouble(hl129hl.Text) + Convert.ToDouble(hl133hl.Text) + Convert.ToDouble(hl147hl.Text) + Convert.ToDouble(hl148hl.Text) + Convert.ToDouble(hl157hl.Text) + Convert.ToDouble(s117s.Text) + Convert.ToDouble(s119s.Text) + Convert.ToDouble(s121s.Text) + Convert.ToDouble(s122s.Text) + Convert.ToDouble(s123s.Text) + Convert.ToDouble(s124s.Text) + Convert.ToDouble(s125s.Text) + Convert.ToDouble(s128s.Text) + Convert.ToDouble(s129s.Text) + Convert.ToDouble(s130s.Text) + Convert.ToDouble(s133s.Text) + Convert.ToDouble(s135s.Text) + Convert.ToDouble(s136s.Text) + Convert.ToDouble(s137s.Text) + Convert.ToDouble(s138s.Text) + Convert.ToDouble(s145s.Text) + Convert.ToDouble(s147s.Text) + Convert.ToDouble(s148s.Text) + Convert.ToDouble(s153s.Text) + Convert.ToDouble(s157s.Text) + Convert.ToDouble(s161s.Text) + Convert.ToDouble(s162s.Text) + Convert.ToDouble(s164s.Text) + Convert.ToDouble(s165s.Text) + Convert.ToDouble(s166s.Text) + Convert.ToDouble(s168s.Text) + Convert.ToDouble(s169s.Text) + Convert.ToDouble(s171s.Text) + Convert.ToDouble(hl161hl.Text) + Convert.ToDouble(hl162hl.Text) + Convert.ToDouble(hl164hl.Text) + Convert.ToDouble(hl169hl.Text) + Convert.ToDouble(hl172hl.Text) + Convert.ToDouble(hl190hl.Text) + Convert.ToDouble(hl198hl.Text) + Convert.ToDouble(s193s.Text) + Convert.ToDouble(s194s.Text) + Convert.ToDouble(s198s.Text) + Convert.ToDouble(s201s.Text) + Convert.ToDouble(s207s.Text) + Convert.ToDouble(s218s.Text) + Convert.ToDouble(s221s.Text) + Convert.ToDouble(s226s.Text) + Convert.ToDouble(s228s.Text) + Convert.ToDouble(s230s.Text) + Convert.ToDouble(s231s.Text) + Convert.ToDouble(s236s.Text);
	...
	{
		Home ho = new Home();
		string qurey = "Update  halabja_hazb set [waraqa_rast]=@waraqa_rast,[waraqapochal]=@waraqapochal , [114]= @114, \t[123]= @123, \t[129]= @129, \t[133]= @133, \t[147]= @147, \t[148]= @148, \t[157]= @157, \t[161]= @161, \t[162]= @162, \t[164]= @164, \t[169]= @169, \t[172]= @172, \t[190]= @190, \t[198]=  @198  WHERE cood_bnka = " + txtbnkacood.Text + " and westga = " + comwestga.Text;
		...
		cmd.Parameters.AddWithValue("@114", hl114hl.Text);
		cmd.Parameters.AddWithValue("@123", hl123hl.Text);
		cmd.Parameters.AddWithValue("@129", hl129hl.Text);
		cmd.Parameters.AddWithValue("@133", hl133hl.Text);
		cmd.Parameters.AddWithValue("@147", hl147hl.Text);
		cmd.Parameters.AddWithValue("@148", hl148hl.Text);
		cmd.Parameters.AddWithValue("@157", hl157hl.Text);
		cmd.Parameters.AddWithValue("@161", hl161hl.Text);
		cmd.Parameters.AddWithValue("@162", hl162hl.Text);
		cmd.Parameters.AddWithValue("@164", hl164hl.Text);
		cmd.Parameters.AddWithValue("@169", hl169hl.Text);
		cmd.Parameters.AddWithValue("@172", hl172hl.Text);
		cmd.Parameters.AddWithValue("@190", hl190hl.Text);
		cmd.Parameters.AddWithValue("@198", hl198hl.Text);
		cmd.ExecuteNonQuery();
		connectionString.Close();
	...
	private void add_update_delete()
	{
		...
		cmd.Parameters.AddWithValue("@h102", hl114hl.Text);
		cmd.Parameters.AddWithValue("@h103", hl123hl.Text);
		cmd.Parameters.AddWithValue("@h105", hl129hl.Text);
		cmd.Parameters.AddWithValue("@h106", hl133hl.Text);
		cmd.Parameters.AddWithValue("@h109", hl147hl.Text);
		cmd.Parameters.AddWithValue("@h111", hl148hl.Text);
		cmd.Parameters.AddWithValue("@h112", hl157hl.Text);
		...
		cmd.Parameters.AddWithValue("@h173", hl161hl.Text);
		cmd.Parameters.AddWithValue("@h176", hl162hl.Text);
		cmd.Parameters.AddWithValue("@h178", hl164hl.Text);
		cmd.Parameters.AddWithValue("@h179", hl169hl.Text);
		cmd.Parameters.AddWithValue("@h181", hl172hl.Text);
		cmd.Parameters.AddWithValue("@h184", hl190hl.Text);
		cmd.Parameters.AddWithValue("@h187", hl198hl.Text);
	...
	private void btnadd_Click(object sender, EventArgs e)
	{
		...
		else if (btnadd.Text == "تۆمارکردن")
		{
			...
			bm = log.get_hazb_HL(int.Parse(txtbnkacood.Text), int.Parse(comwestga.Text));
			if (bm.Rows.Count > 0)
			{
	...
	private void comwestga_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		using (SqlDataReader reader = command.ExecuteReader())
		{
			if (reader.Read())
			{
				...
				hl114hl.Text = reader["114"].ToString();
				hl123hl.Text = reader["123"].ToString();
				hl129hl.Text = reader["129"].ToString();
				hl133hl.Text = reader["133"].ToString();
				hl147hl.Text = reader["147"].ToString();
				hl148hl.Text = reader["148"].ToString();
				hl157hl.Text = reader["157"].ToString();
				hl161hl.Text = reader["161"].ToString();
				hl162hl.Text = reader["162"].ToString();
				hl164hl.Text = reader["164"].ToString();
				hl169hl.Text = reader["169"].ToString();
				hl172hl.Text = reader["172"].ToString();
				hl190hl.Text = reader["190"].ToString();
				hl198hl.Text = reader["198"].ToString();
				btnadd.Text = "Update";
				txtcoler();
			}
			else
	...
	private void txtcoler()
	{
		...
		{
			hl114hl, hl123hl, hl129hl, hl133hl, hl147hl, hl148hl, hl157hl, s117s, s119s, s121s,
			s122s, s123s, s124s, s125s, s128s, s129s, s130s, s133s, s135s, s136s,
			s137s, s138s, s145s, s147s, s148s, s153s, s157s, s161s, s162s, s164s,
			s165s, s166s, s168s, s169s, s171s, hl161hl, hl162hl, hl164hl, hl169hl, hl172hl,
			hl190hl, hl198hl, s193s, s194s, s198s, s201s, s207s, s218s, s221s, s226s,
	...
	{
		Home ho = new Home();
		string qurey = "insert into halabja_hazb(naw_mahafaza,\tmalband,\tcood_tasjil,\tnaw_tasjil,\tcood_bnka,\tnaw_bnka,\twestga_gshty,\tdangdar,\twestga,\twaraqa_rast,\twaraqapochal, [naw_karmand],[taime],[jor_dangdan],Device_name,srial_namber, [114], \t[123], \t[129], \t[133], \t[147], \t[148], \t[157], \t[161], \t[162], \t[164], \t[169], \t[172], \t[190], \t[198])VALUES (@naw_mahafaza,\t@malband,\t@cood_tasjil,\t@naw_tasjil,\t@cood_bnka,\t@naw_bnka,\t@westga_gshty,\t@dangdar,\t@westga,\t@waraqa_rast,\t@waraqapochal,@naw_karmand,@taime,@jor_dangdan,@Device_name,@srial_namber,@114, \t@123, \t@129, \t@133, \t@147, \t@148, \t@157, \t@161, \t@162, \t@164, \t@169, \t@172, \t@190, \t@198 )";
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
		cmd.Parameters.AddWithValue("@naw_mahafaza", txtparezga.Text);
		cmd.Parameters.AddWithValue("@malband", txtmalband.Text);
	...
	{
		if (hl114hl.Text == string.Empty)
		{
			hl114hl.Text = "0";
		}
		if (hl114hl.Text == "0")
		{
			hl114hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl114hl.ForeColor = Color.Black;
		}
	}

	private void h103_Leave(object sender, EventArgs e)
	{
		if (hl123hl.Text == string.Empty)
		{
			hl123hl.Text = "0";
		}
		if (hl123hl.Text == "0")
		{
			hl123hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl123hl.ForeColor = Color.Black;
		}
	}

	private void h105_Leave(object sender, EventArgs e)
	{
		if (hl129hl.Text == string.Empty)
		{
			hl129hl.Text = "0";
		}
		if (hl129hl.Text == "0")
		{
			hl129hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl129hl.ForeColor = Color.Black;
		}
	}

	private void h106_Leave(object sender, EventArgs e)
	{
		if (hl133hl.Text == string.Empty)
		{
			hl133hl.Text = "0";
		}
		if (hl133hl.Text == "0")
		{
			hl133hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl133hl.ForeColor = Color.Black;
		}
	}

	private void h109_Leave(object sender, EventArgs e)
	{
		if (hl147hl.Text == string.Empty)
		{
			hl147hl.Text = "0";
		}
		if (hl147hl.Text == "0")
		{
			hl147hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl147hl.ForeColor = Color.Black;
		}
	}

	private void h111_Leave(object sender, EventArgs e)
	{
		if (hl148hl.Text == string.Empty)
		{
			hl148hl.Text = "0";
		}
		if (hl148hl.Text == "0")
		{
			hl148hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl148hl.ForeColor = Color.Black;
		}
	}

	private void h112_Leave(object sender, EventArgs e)
	{
		if (hl157hl.Text == string.Empty)
		{
			hl157hl.Text = "0";
		}
		if (hl157hl.Text == "0")
		{
			hl157hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl157hl.ForeColor = Color.Black;
		}
	}
	...
	{
		if (hl169hl.Text == string.Empty)
		{
			hl169hl.Text = "0";
		}
		if (hl169hl.Text == "0")
		{
			hl169hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl169hl.ForeColor = Color.Black;
		}
	}

	private void h181_Leave(object sender, EventArgs e)
	{
		if (hl172hl.Text == string.Empty)
		{
			hl172hl.Text = "0";
		}
		if (hl172hl.Text == "0")
		{
			hl172hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl172hl.ForeColor = Color.Black;
		}
	}

	private void h184_Leave(object sender, EventArgs e)
	{
		if (hl190hl.Text == string.Empty)
		{
			hl190hl.Text = "0";
		}
		if (hl190hl.Text == "0")
		{
			hl190hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl190hl.ForeColor = Color.Black;
		}
	}

	private void h187_Leave(object sender, EventArgs e)
	{
		if (hl198hl.Text == string.Empty)
		{
			hl198hl.Text = "0";
		}
		if (hl198hl.Text == "0")
		{
			hl198hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl198hl.ForeColor = Color.Black;
		}
	}
	...
	{
		if (hl161hl.Text == string.Empty)
		{
			hl161hl.Text = "0";
		}
		if (hl161hl.Text == "0")
		{
			hl161hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl161hl.ForeColor = Color.Black;
		}
	}

	private void h176_Leave(object sender, EventArgs e)
	{
		if (hl162hl.Text == string.Empty)
		{
			hl162hl.Text = "0";
		}
		if (hl162hl.Text == "0")
		{
			hl162hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl162hl.ForeColor = Color.Black;
		}
	}

	private void h178_Leave(object sender, EventArgs e)
	{
		if (hl164hl.Text == string.Empty)
		{
			hl164hl.Text = "0";
		}
		if (hl164hl.Text == "0")
		{
			hl164hl.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			hl164hl.ForeColor = Color.Black;
		}
	}
	...
	private void button5_Click(object sender, EventArgs e)
	{
		...
		{
			string qurey1 = "delete from  candid_hl  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			string qurey = "delete from  halabja_hazb  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			SqlCommand cmd = new SqlCommand(qurey, connectionString);
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PUK_Anjamakan.Frm.HL_Gshty));
		...
		this.hl161hl = new System.Windows.Forms.TextBox();
		this.hl162hl = new System.Windows.Forms.TextBox();
		this.hl164hl = new System.Windows.Forms.TextBox();
		this.hl169hl = new System.Windows.Forms.TextBox();
		this.hl172hl = new System.Windows.Forms.TextBox();
		this.hl190hl = new System.Windows.Forms.TextBox();
		this.hl198hl = new System.Windows.Forms.TextBox();
		...
		this.hl114hl = new System.Windows.Forms.TextBox();
		this.hl123hl = new System.Windows.Forms.TextBox();
		this.hl129hl = new System.Windows.Forms.TextBox();
		this.hl133hl = new System.Windows.Forms.TextBox();
		this.hl147hl = new System.Windows.Forms.TextBox();
		this.hl148hl = new System.Windows.Forms.TextBox();
		this.hl157hl = new System.Windows.Forms.TextBox();
		...
		this.btnsearch.Font = new System.Drawing.Font("Unikurd Jino", 12f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		...
		this.btn_candid_d.Text = " لیستی قەوارەکانی پارێزگای هەڵەبجە ";
		...
		this.tableLayoutPanel7.Controls.Add(this.hl161hl, 5, 0);
		this.tableLayoutPanel7.Controls.Add(this.hl162hl, 5, 1);
		this.tableLayoutPanel7.Controls.Add(this.hl164hl, 5, 2);
		this.tableLayoutPanel7.Controls.Add(this.hl169hl, 5, 3);
		this.tableLayoutPanel7.Controls.Add(this.hl172hl, 5, 4);
		this.tableLayoutPanel7.Controls.Add(this.hl190hl, 5, 5);
		this.tableLayoutPanel7.Controls.Add(this.hl198hl, 5, 6);
		...
		this.tableLayoutPanel7.Controls.Add(this.hl114hl, 8, 0);
		this.tableLayoutPanel7.Controls.Add(this.hl123hl, 8, 1);
		this.tableLayoutPanel7.Controls.Add(this.hl129hl, 8, 2);
		this.tableLayoutPanel7.Controls.Add(this.hl133hl, 8, 3);
		this.tableLayoutPanel7.Controls.Add(this.hl147hl, 8, 4);
		this.tableLayoutPanel7.Controls.Add(this.hl148hl, 8, 5);
		this.tableLayoutPanel7.Controls.Add(this.hl157hl, 8, 6);
		...
		this.tableLayoutPanel7.MouseMove += new System.Windows.Forms.MouseEventHandler(tableLayoutPanel7_MouseMove);
		...
		this.label31.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		...
		this.label31.Text = "147";
		this.label31.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label31.Click += new System.EventHandler(label31_Click);
		this.label35.AutoSize = true;
		this.label35.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		...
		this.label35.Text = "148";
		this.label35.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label35.Click += new System.EventHandler(label35_Click);
		this.label39.AutoSize = true;
		this.label39.BackColor = System.Drawing.Color.FromArgb(255, 192, 128);
		...
		this.hl161hl.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		this.hl161hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl161hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl161hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl161hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl161hl.Location = new System.Drawing.Point(402, 3);
		this.hl161hl.Multiline = true;
		this.hl161hl.Name = "hl161hl";
		this.hl161hl.Size = new System.Drawing.Size(106, 48);
		this.hl161hl.TabIndex = 36;
		this.hl161hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl161hl.Click += new System.EventHandler(h173_Click);
		this.hl161hl.TextChanged += new System.EventHandler(h173_TextChanged);
		this.hl161hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h173_KeyDown);
		this.hl161hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h173_KeyPress);
		this.hl161hl.Leave += new System.EventHandler(h173_Leave);
		this.hl162hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl162hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl162hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl162hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl162hl.Location = new System.Drawing.Point(402, 57);
		this.hl162hl.Multiline = true;
		this.hl162hl.Name = "hl162hl";
		this.hl162hl.Size = new System.Drawing.Size(106, 48);
		this.hl162hl.TabIndex = 37;
		this.hl162hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl162hl.Click += new System.EventHandler(h176_Click);
		this.hl162hl.TextChanged += new System.EventHandler(h176_TextChanged);
		this.hl162hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h176_KeyDown);
		this.hl162hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h176_KeyPress);
		this.hl162hl.Leave += new System.EventHandler(h176_Leave);
		this.hl164hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl164hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl164hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl164hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl164hl.Location = new System.Drawing.Point(402, 111);
		this.hl164hl.Multiline = true;
		this.hl164hl.Name = "hl164hl";
		this.hl164hl.Size = new System.Drawing.Size(106, 48);
		this.hl164hl.TabIndex = 38;
		this.hl164hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl164hl.Click += new System.EventHandler(h178_Click);
		this.hl164hl.TextChanged += new System.EventHandler(h178_TextChanged);
		this.hl164hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h178_KeyDown);
		this.hl164hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h178_KeyPress);
		this.hl164hl.Leave += new System.EventHandler(h178_Leave);
		this.hl169hl.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		this.hl169hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl169hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl169hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl169hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl169hl.Location = new System.Drawing.Point(402, 165);
		this.hl169hl.Multiline = true;
		this.hl169hl.Name = "hl169hl";
		this.hl169hl.Size = new System.Drawing.Size(106, 48);
		this.hl169hl.TabIndex = 39;
		this.hl169hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl169hl.TextChanged += new System.EventHandler(h179_TextChanged);
		this.hl169hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h179_KeyDown);
		this.hl169hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h179_KeyPress);
		this.hl169hl.Leave += new System.EventHandler(h179_Leave);
		this.hl172hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl172hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl172hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl172hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl172hl.Location = new System.Drawing.Point(402, 219);
		this.hl172hl.Multiline = true;
		this.hl172hl.Name = "hl172hl";
		this.hl172hl.Size = new System.Drawing.Size(106, 48);
		this.hl172hl.TabIndex = 40;
		this.hl172hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl172hl.TextChanged += new System.EventHandler(h181_TextChanged);
		this.hl172hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h181_KeyDown);
		this.hl172hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h181_KeyPress);
		this.hl172hl.Leave += new System.EventHandler(h181_Leave);
		this.hl190hl.BackColor = System.Drawing.Color.Yellow;
		this.hl190hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl190hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl190hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl190hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl190hl.Location = new System.Drawing.Point(402, 273);
		this.hl190hl.Multiline = true;
		this.hl190hl.Name = "hl190hl";
		this.hl190hl.Size = new System.Drawing.Size(106, 48);
		this.hl190hl.TabIndex = 41;
		this.hl190hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl190hl.Click += new System.EventHandler(h184_Click);
		this.hl190hl.TextChanged += new System.EventHandler(h184_TextChanged);
		this.hl190hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h184_KeyDown);
		this.hl190hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h184_KeyPress);
		this.hl190hl.Leave += new System.EventHandler(h184_Leave);
		this.hl198hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl198hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl198hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl198hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl198hl.Location = new System.Drawing.Point(402, 327);
		this.hl198hl.Multiline = true;
		this.hl198hl.Name = "hl198hl";
		this.hl198hl.Size = new System.Drawing.Size(106, 48);
		this.hl198hl.TabIndex = 42;
		this.hl198hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl198hl.Click += new System.EventHandler(h187_Click);
		this.hl198hl.TextChanged += new System.EventHandler(h187_TextChanged);
		this.hl198hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h187_KeyDown);
		this.hl198hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h187_KeyPress);
		this.hl198hl.Leave += new System.EventHandler(h187_Leave);
		this.s193s.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.s193s.Dock = System.Windows.Forms.DockStyle.Fill;
		this.s193s.Enabled = false;
		...
		this.label16.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label96.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label97.Text = "هاوپەیمانی نیشتیمانی ";
		...
		this.label100.Text = "سامان نامق اسكندر";
		this.label100.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label101.AutoSize = true;
		this.label101.BackColor = System.Drawing.Color.Yellow;
		...
		this.hl114hl.BackColor = System.Drawing.Color.White;
		this.hl114hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl114hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl114hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl114hl.ForeColor = System.Drawing.Color.White;
		this.hl114hl.Location = new System.Drawing.Point(856, 3);
		this.hl114hl.Multiline = true;
		this.hl114hl.Name = "hl114hl";
		this.hl114hl.Size = new System.Drawing.Size(103, 48);
		this.hl114hl.TabIndex = 0;
		this.hl114hl.Text = " ";
		this.hl114hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl114hl.Click += new System.EventHandler(h102_Click);
		this.hl114hl.TextChanged += new System.EventHandler(h102_TextChanged);
		this.hl114hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h102_KeyDown);
		this.hl114hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h102_KeyPress);
		this.hl114hl.Leave += new System.EventHandler(h102_Leave);
		this.hl123hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl123hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl123hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl123hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl123hl.Location = new System.Drawing.Point(856, 57);
		this.hl123hl.Multiline = true;
		this.hl123hl.Name = "hl123hl";
		this.hl123hl.Size = new System.Drawing.Size(103, 48);
		this.hl123hl.TabIndex = 1;
		this.hl123hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl123hl.Click += new System.EventHandler(h103_Click);
		this.hl123hl.TextChanged += new System.EventHandler(h103_TextChanged);
		this.hl123hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h103_KeyDown);
		this.hl123hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h103_KeyPress);
		this.hl123hl.Leave += new System.EventHandler(h103_Leave);
		this.hl129hl.BackColor = System.Drawing.Color.Aquamarine;
		this.hl129hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl129hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl129hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl129hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl129hl.Location = new System.Drawing.Point(856, 111);
		this.hl129hl.Multiline = true;
		this.hl129hl.Name = "hl129hl";
		this.hl129hl.Size = new System.Drawing.Size(103, 48);
		this.hl129hl.TabIndex = 2;
		this.hl129hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl129hl.Click += new System.EventHandler(h105_Click);
		this.hl129hl.TextChanged += new System.EventHandler(h105_TextChanged);
		this.hl129hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h105_KeyDown);
		this.hl129hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h105_KeyPress);
		this.hl129hl.Leave += new System.EventHandler(h105_Leave);
		this.hl133hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl133hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl133hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl133hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl133hl.Location = new System.Drawing.Point(856, 165);
		this.hl133hl.Multiline = true;
		this.hl133hl.Name = "hl133hl";
		this.hl133hl.Size = new System.Drawing.Size(103, 48);
		this.hl133hl.TabIndex = 3;
		this.hl133hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl133hl.Click += new System.EventHandler(h106_Click);
		this.hl133hl.TextChanged += new System.EventHandler(h106_TextChanged);
		this.hl133hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h106_KeyDown);
		this.hl133hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h106_KeyPress);
		this.hl133hl.Leave += new System.EventHandler(h106_Leave);
		this.hl147hl.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		this.hl147hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl147hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl147hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl147hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl147hl.Location = new System.Drawing.Point(856, 219);
		this.hl147hl.Multiline = true;
		this.hl147hl.Name = "hl147hl";
		this.hl147hl.Size = new System.Drawing.Size(103, 48);
		this.hl147hl.TabIndex = 4;
		this.hl147hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl147hl.Click += new System.EventHandler(h109_Click);
		this.hl147hl.TextChanged += new System.EventHandler(h109_TextChanged);
		this.hl147hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h109_KeyDown);
		this.hl147hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h109_KeyPress);
		this.hl147hl.Leave += new System.EventHandler(h109_Leave);
		this.hl148hl.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		this.hl148hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl148hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl148hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl148hl.ForeColor = System.Drawing.Color.White;
		this.hl148hl.Location = new System.Drawing.Point(856, 273);
		this.hl148hl.Multiline = true;
		this.hl148hl.Name = "hl148hl";
		this.hl148hl.Size = new System.Drawing.Size(103, 48);
		this.hl148hl.TabIndex = 5;
		this.hl148hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl148hl.Click += new System.EventHandler(h111_Click);
		this.hl148hl.TextChanged += new System.EventHandler(h111_TextChanged);
		this.hl148hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h111_KeyDown);
		this.hl148hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h111_KeyPress);
		this.hl148hl.Leave += new System.EventHandler(h111_Leave);
		this.hl157hl.BackColor = System.Drawing.Color.FromArgb(255, 192, 128);
		this.hl157hl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.hl157hl.Dock = System.Windows.Forms.DockStyle.Fill;
		this.hl157hl.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.hl157hl.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.hl157hl.Location = new System.Drawing.Point(856, 327);
		this.hl157hl.Multiline = true;
		this.hl157hl.Name = "hl157hl";
		this.hl157hl.Size = new System.Drawing.Size(103, 48);
		this.hl157hl.TabIndex = 6;
		this.hl157hl.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.hl157hl.Click += new System.EventHandler(h112_Click);
		this.hl157hl.TextChanged += new System.EventHandler(h112_TextChanged);
		this.hl157hl.KeyDown += new System.Windows.Forms.KeyEventHandler(h112_KeyDown);
		this.hl157hl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h112_KeyPress);
		this.hl157hl.Leave += new System.EventHandler(h112_Leave);
		...
		this.label29.Text = "گوران(التغیر)";
		...
		this.label33.Text = "بزوتنەوەى پەیوەندی ئیسلامى کوردستان";
		...
		this.label37.Text = "یەکێتی نیشتیمانی کوردستان";
		...
		this.label41.Text = "هاوپەیمانى هەرێمی کوردستان";
		this.label41.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label45.AutoSize = true;
		this.label45.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		...
		this.label45.Text = "کۆمەڵی دادگەری کوردستان/عێڕاق";
		this.label45.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label67.AutoSize = true;
		this.label67.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		...
		this.label67.Text = "یەکگرتووی ئیسلامی کوردستان ";
		this.label67.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label70.AutoSize = true;
		this.label70.BackColor = System.Drawing.Color.FromArgb(255, 192, 128);
