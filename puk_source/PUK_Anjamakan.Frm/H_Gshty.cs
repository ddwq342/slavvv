...
public class H_Gshty : Form
{
	...
	private TextBox h170h;

	private TextBox s31;

	private TextBox h173h;

	private TextBox s23;

	private TextBox h176h;
	...
	private TextBox h184h;

	private TextBox h169h;

	private TextBox h181h;

	private TextBox h167h;

	private TextBox h164h;

	private TextBox h162h;

	private TextBox h161h;

	private TextBox h235;

	private TextBox h234;

	private TextBox h160h;

	private TextBox h158h;

	private TextBox h233;

	private TextBox h229;

	private TextBox h234h;

	private TextBox h235h;

	private TextBox h157h;

	private TextBox h233h;

	private TextBox h156h;

	private TextBox h154h;

	private TextBox h151h;

	private TextBox h229h;

	private TextBox h223h;

	private TextBox h150h;

	private TextBox h220h;

	private TextBox h149h;

	private TextBox h219h;

	private TextBox h148h;

	private TextBox h217h;

	private TextBox h147h;

	private TextBox h216h;

	private TextBox h214h;

	private TextBox h146h;

	private TextBox h215h;

	private TextBox h144h;

	private TextBox h139h;

	private TextBox h212h;

	private TextBox h210h;

	private TextBox h133h;

	private TextBox h209h;

	private TextBox h131h;

	private TextBox h129h;

	private TextBox h208h;

	private TextBox h123h;

	private TextBox h120h;

	private TextBox h114h;

	private TextBox h206h;

	private TextBox h205h;

	private TextBox h204h;

	private TextBox h203h;

	private TextBox h202h;

	private TextBox h199h;

	private TextBox h112h;

	private TextBox h111h;

	private TextBox h109h;

	private TextBox h106h;

	private TextBox h191h;

	private TextBox h198h;

	private TextBox h105h;

	private TextBox h190h;

	private TextBox h103h;

	private TextBox h102h;

	private TextBox h189h;

	private TableLayoutPanel tableLayoutPanel7;

	private TextBox h187h;
	...
	private void totals()
	{
		try
		{
			double To2 = (double)int.Parse(h102h.Text) + Convert.ToDouble(h103h.Text) + Convert.ToDouble(h105h.Text) + Convert.ToDouble(h106h.Text) + Convert.ToDouble(h109h.Text) + Convert.ToDouble(h111h.Text) + Convert.ToDouble(h112h.Text) + Convert.ToDouble(h114h.Text) + Convert.ToDouble(h120h.Text) + Convert.ToDouble(h123h.Text) + Convert.ToDouble(h129h.Text) + Convert.ToDouble(h131h.Text) + Convert.ToDouble(h133h.Text) + Convert.ToDouble(h139h.Text) + Convert.ToDouble(h144h.Text) + Convert.ToDouble(h146h.Text) + Convert.ToDouble(h147h.Text) + Convert.ToDouble(h148h.Text) + Convert.ToDouble(h149h.Text) + Convert.ToDouble(h150h.Text) + Convert.ToDouble(h151h.Text) + Convert.ToDouble(h154h.Text) + Convert.ToDouble(h156h.Text) + Convert.ToDouble(h157h.Text) + Convert.ToDouble(h158h.Text) + Convert.ToDouble(h160h.Text) + Convert.ToDouble(h161h.Text) + Convert.ToDouble(h162h.Text) + Convert.ToDouble(h164h.Text) + Convert.ToDouble(h167h.Text) + Convert.ToDouble(h169h.Text) + Convert.ToDouble(h170h.Text) + Convert.ToDouble(h173h.Text) + Convert.ToDouble(h176h.Text) + Convert.ToDouble(h178h.Text) + Convert.ToDouble(h181h.Text) + Convert.ToDouble(h184h.Text) + Convert.ToDouble(h187h.Text) + Convert.ToDouble(h189h.Text) + Convert.ToDouble(h190h.Text) + Convert.ToDouble(h191h.Text) + Convert.ToDouble(h198h.Text) + Convert.ToDouble(h199h.Text) + Convert.ToDouble(h202h.Text) + Convert.ToDouble(h203h.Text) + Convert.ToDouble(h204h.Text) + Convert.ToDouble(h205h.Text) + Convert.ToDouble(h206h.Text) + Convert.ToDouble(h208h.Text) + Convert.ToDouble(h209h.Text) + Convert.ToDouble(h210h.Text) + Convert.ToDouble(h212h.Text) + Convert.ToDouble(h214h.Text) + Convert.ToDouble(h215h.Text);
	...
	{
		Home ho = new Home();
		string qurey = "Update  hawler_hazb set [waraqa_rast]=@waraqa_rast,[waraqapochal]=@waraqapochal ,  [102]=@102,\t[103] =@103, \t[105] =@105, \t[106] =@106, \t[109] =@109, \t[111] =@111, \t[112] =@112, \t[114] =@114, \t[120] =@120, \t[123] =@123, \t[129] =@129, \t[131] =@131, \t[133] =@133, \t[139] =@139, \t[144] =@144, \t[146] =@146, \t[147] =@147, \t[148] =@148, \t[149] =@149, \t[150] =@150, \t[151] =@151, \t[154] =@154, \t[156] =@156, \t[157] =@157, \t[158] =@158, \t[160] =@160, \t[161] =@161, \t[162] =@162, \t[164] =@164, \t[167] =@167, \t[169] =@169, \t[170] =@170, \t[173] =@173, \t[176] =@176, \t[178] =@178, \t[179] =@179, \t[181] =@181, \t[184] =@184, \t[187] =@187, \t[189] =@189, \t[190] =@190, \t[191] =@191, \t[198] =@198, \t[199] =@199, \t[202] =@202, \t[203] =@203, \t[204] =@204, \t[205] =@205, \t[206] =@206, \t[208] =@208, \t[209] =@209, \t[210] =@210, \t[212] =@212, \t[214] =@214, \t[215] =@215, \t[216] =@216, \t[217] =@217, \t[219] =@219, \t[220] =@220, \t[223] =@223, \t[229] =@229, \t[233] =@233, \t[234] =@234, \t[235]  =@235   WHERE cood_bnka = " + txtbnkacood.Text + " and westga = " + comwestga.Text;
		...
		cmd.Parameters.AddWithValue("@102", h102h.Text);
		cmd.Parameters.AddWithValue("@103 ", h103h.Text);
		cmd.Parameters.AddWithValue("@105 ", h105h.Text);
		cmd.Parameters.AddWithValue("@106 ", h106h.Text);
		cmd.Parameters.AddWithValue("@109 ", h109h.Text);
		cmd.Parameters.AddWithValue("@111 ", h111h.Text);
		cmd.Parameters.AddWithValue("@112 ", h112h.Text);
		cmd.Parameters.AddWithValue("@114 ", h114h.Text);
		cmd.Parameters.AddWithValue("@120 ", h120h.Text);
		cmd.Parameters.AddWithValue("@123 ", h123h.Text);
		cmd.Parameters.AddWithValue("@129 ", h129h.Text);
		cmd.Parameters.AddWithValue("@131 ", h131h.Text);
		cmd.Parameters.AddWithValue("@133 ", h133h.Text);
		cmd.Parameters.AddWithValue("@139 ", h139h.Text);
		cmd.Parameters.AddWithValue("@144 ", h144h.Text);
		cmd.Parameters.AddWithValue("@146 ", h146h.Text);
		cmd.Parameters.AddWithValue("@147 ", h147h.Text);
		cmd.Parameters.AddWithValue("@148 ", h148h.Text);
		cmd.Parameters.AddWithValue("@149 ", h149h.Text);
		cmd.Parameters.AddWithValue("@150 ", h150h.Text);
		cmd.Parameters.AddWithValue("@151 ", h151h.Text);
		cmd.Parameters.AddWithValue("@154 ", h154h.Text);
		cmd.Parameters.AddWithValue("@156 ", h156h.Text);
		cmd.Parameters.AddWithValue("@157 ", h157h.Text);
		cmd.Parameters.AddWithValue("@158 ", h158h.Text);
		cmd.Parameters.AddWithValue("@160 ", h160h.Text);
		cmd.Parameters.AddWithValue("@161 ", h161h.Text);
		cmd.Parameters.AddWithValue("@162 ", h162h.Text);
		cmd.Parameters.AddWithValue("@164 ", h164h.Text);
		cmd.Parameters.AddWithValue("@167 ", h167h.Text);
		cmd.Parameters.AddWithValue("@169 ", h169h.Text);
		cmd.Parameters.AddWithValue("@170 ", h170h.Text);
		cmd.Parameters.AddWithValue("@173 ", h173h.Text);
		cmd.Parameters.AddWithValue("@176 ", h176h.Text);
		cmd.Parameters.AddWithValue("@178 ", h178h.Text);
		cmd.Parameters.AddWithValue("@179 ", h179h.Text);
		cmd.Parameters.AddWithValue("@181 ", h181h.Text);
		cmd.Parameters.AddWithValue("@184 ", h184h.Text);
		cmd.Parameters.AddWithValue("@187 ", h187h.Text);
		cmd.Parameters.AddWithValue("@189 ", h189h.Text);
		cmd.Parameters.AddWithValue("@190 ", h190h.Text);
		cmd.Parameters.AddWithValue("@191 ", h191h.Text);
		cmd.Parameters.AddWithValue("@198 ", h198h.Text);
		cmd.Parameters.AddWithValue("@199 ", h199h.Text);
		cmd.Parameters.AddWithValue("@202 ", h202h.Text);
		cmd.Parameters.AddWithValue("@203 ", h203h.Text);
		cmd.Parameters.AddWithValue("@204 ", h204h.Text);
		cmd.Parameters.AddWithValue("@205 ", h205h.Text);
		cmd.Parameters.AddWithValue("@206 ", h206h.Text);
		cmd.Parameters.AddWithValue("@208 ", h208h.Text);
		cmd.Parameters.AddWithValue("@209 ", h209h.Text);
		cmd.Parameters.AddWithValue("@210 ", h210h.Text);
		cmd.Parameters.AddWithValue("@212 ", h212h.Text);
		cmd.Parameters.AddWithValue("@214 ", h214h.Text);
		cmd.Parameters.AddWithValue("@215 ", h215h.Text);
		cmd.Parameters.AddWithValue("@216 ", h216h.Text);
		cmd.Parameters.AddWithValue("@217 ", h217h.Text);
		cmd.Parameters.AddWithValue("@219 ", h219h.Text);
		cmd.Parameters.AddWithValue("@220 ", h220h.Text);
		cmd.Parameters.AddWithValue("@223 ", h223h.Text);
		cmd.Parameters.AddWithValue("@229 ", h229h.Text);
		cmd.Parameters.AddWithValue("@233 ", h233h.Text);
		cmd.Parameters.AddWithValue("@234 ", h234h.Text);
		cmd.Parameters.AddWithValue("@235  ", h235h.Text);
		cmd.ExecuteNonQuery();
		connectionString.Close();
	...
	{
		string qurey = "Update candid_h set [1]=@1,\t[2]=@2,\t[3]=@3,\t[4]=@4,\t[5]=@5,\t[6]=@6,\t[7]=@7,\t[8]=@8,\t[9]=@9,\t[10]=@10,\t[11]=@11,\t[12]=@12,\t[13]=@13,\t[14]=@14,\t[15]=@15,\t[16]=@16,\t[17]=@17,\t[18]=@18,\t[19]=@19,\t[20]=@20,\t[21]=@21,\t[22]=@22,\t[23]=@23,\t[24]=@24,\t[25]=@25,\t[26]=@26,\t[27]=@27,\t[28]=@28,\t[29]=@29,\t[30]=@30,\t[31]=@31,\t[32]=@32,\t[33]=@33,\t[34]=@34,\t[35]=@35,\t[36]=@36,\t[37]=@37,\t[38]=@38,\t[39]=@39,\t[40]=@40,\t[41]=@41,\t[42]=@42,\t[43]=@43,\t[44]=@44,\t[45]=@45,\t[46]=@46,\t[47]=@47,\t[48]=@48,\t[49]=@49,\t[50]=@50,\t[51]=@51,\t[52]=@52,\t[53]=@53,\t[54]=@54,\t[55]=@55,\t[56]=@56,\t[57]=@57,\t[58]=@58,\t[59]=@59,\t[60]=@60,\t[61]=@61,\t[62]=@62,\t[63]=@63,\t[64]=@64  WHERE cood_bnka = " + txtbnkacood.Text + " and westga = " + comwestga.Text;
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
	...
	private void btnadd_Click(object sender, EventArgs e)
	{
		...
		else if (btnadd.Text == "تۆمارکردن")
		{
			...
			bm = log.get_hazb_h(int.Parse(txtbnkacood.Text), int.Parse(comwestga.Text));
			if (bm.Rows.Count > 0)
			{
	...
	private void comwestga_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		using (SqlDataReader reader = command.ExecuteReader())
		{
			if (reader.Read())
			{
				...
				h102h.Text = reader["102"].ToString();
				h103h.Text = reader["103"].ToString();
				h105h.Text = reader["105"].ToString();
				h106h.Text = reader["106"].ToString();
				h109h.Text = reader["109"].ToString();
				h111h.Text = reader["111"].ToString();
				h112h.Text = reader["112"].ToString();
				h114h.Text = reader["114"].ToString();
				h120h.Text = reader["120"].ToString();
				h123h.Text = reader["123"].ToString();
				h129h.Text = reader["129"].ToString();
				h131h.Text = reader["131"].ToString();
				h133h.Text = reader["133"].ToString();
				h139h.Text = reader["139"].ToString();
				h144h.Text = reader["144"].ToString();
				h146h.Text = reader["146"].ToString();
				h147h.Text = reader["147"].ToString();
				h148h.Text = reader["148"].ToString();
				h149h.Text = reader["149"].ToString();
				h150h.Text = reader["150"].ToString();
				h151h.Text = reader["151"].ToString();
				h154h.Text = reader["154"].ToString();
				h156h.Text = reader["156"].ToString();
				h157h.Text = reader["157"].ToString();
				h158h.Text = reader["158"].ToString();
				h160h.Text = reader["160"].ToString();
				h161h.Text = reader["161"].ToString();
				h162h.Text = reader["162"].ToString();
				h164h.Text = reader["164"].ToString();
				h167h.Text = reader["167"].ToString();
				h169h.Text = reader["169"].ToString();
				h170h.Text = reader["170"].ToString();
				h173h.Text = reader["173"].ToString();
				h176h.Text = reader["176"].ToString();
				h178h.Text = reader["178"].ToString();
				h179h.Text = reader["179"].ToString();
				h181h.Text = reader["181"].ToString();
				h184h.Text = reader["184"].ToString();
				h187h.Text = reader["187"].ToString();
				h189h.Text = reader["189"].ToString();
				h190h.Text = reader["190"].ToString();
				h191h.Text = reader["191"].ToString();
				h198h.Text = reader["198"].ToString();
				h199h.Text = reader["199"].ToString();
				h202h.Text = reader["202"].ToString();
				h203h.Text = reader["203"].ToString();
				h204h.Text = reader["204"].ToString();
				h205h.Text = reader["205"].ToString();
				h206h.Text = reader["206"].ToString();
				h208h.Text = reader["208"].ToString();
				h209h.Text = reader["209"].ToString();
				h210h.Text = reader["210"].ToString();
				h212h.Text = reader["212"].ToString();
				h214h.Text = reader["214"].ToString();
				h215h.Text = reader["215"].ToString();
				h216h.Text = reader["216"].ToString();
				h217h.Text = reader["217"].ToString();
				h219h.Text = reader["219"].ToString();
				h220h.Text = reader["220"].ToString();
				h223h.Text = reader["223"].ToString();
				h229h.Text = reader["229"].ToString();
				h233h.Text = reader["233"].ToString();
				h234h.Text = reader["234"].ToString();
				h235h.Text = reader["235"].ToString();
				btnadd.Text = "Update";
				txtcoler();
			}
			else
	...
	{
		string qurey = "insert into candid_h(naw_mahafaza,cood_tasjil,cood_bnka,jor_dangdan,\twestga,[1]\t,[2]\t,[3]\t,[4]\t,[5]\t,[6]\t,[7]\t,[8]\t,[9]\t,[10]\t,[11]\t,[12]\t,[13]\t,[14]\t,[15]\t,[16]\t,[17]\t,[18]\t,[19]\t,[20]\t,[21]\t,[22]\t,[23]\t,[24]\t,[25]\t,[26]\t,[27]\t,[28]\t,[29]\t,[30]\t,[31]\t,[32]\t,[33]\t,[34]\t,[35]\t,[36]\t,[37]\t,[38]\t,[39]\t,[40]\t,[41]\t,[42]\t,[43]\t,[44]\t,[45]\t,[46]\t,[47]\t,[48]\t,[49]\t,[50]\t,[51]\t,[52]\t,[53]\t,[54]\t,[55]\t,[56]\t,[57]\t,[58]\t,[59]\t,[60]\t,[61]\t,[62]\t,[63]\t,[64]\t )VALUES (@naw_mahafaza,\t@cood_tasjil,\t@cood_bnka,@jor_dangdan,\t@westga,@1,@2,\t@3,\t@4,\t@5,\t@6,\t@7,\t@8,\t@9,\t@10,\t@11,\t@12,\t@13,\t@14,\t@15,\t@16,\t@17,\t@18,\t@19,\t@20,\t@21,\t@22,\t@23,\t@24,\t@25,\t@26,\t@27,\t@28,\t@29,\t@30,\t@31,\t@32,\t@33,\t@34,\t@35,\t@36,\t@37,\t@38,\t@39,\t@40,\t@41,\t@42,\t@43,\t@44,\t@45,\t@46,\t@47,\t@48,\t@49,\t@50,\t@51,\t@52,\t@53,\t@54,\t@55,\t@56,\t@57,\t@58,\t@59,\t@60,\t@61,\t@62,\t@63,\t@64)";
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
	...
	private void txtcoler()
	{
		...
		{
			h102h, h103h, h105h, h106h, h109h, h111h, h112h, h114h, h120h, h123h,
			h129h, h131h, h133h, h139h, h144h, h146h, h147h, h148h, h149h, h150h,
			h151h, h154h, h156h, h157h, h158h, h160h, h161h, h162h, h164h, h167h,
			h169h, h170h, h173h, h176h, h178h, h181h, h184h, h187h, h189h, h190h,
			h191h, h198h, h199h, h202h, h203h, h204h, h205h, h206h, h208h, h209h,
			h210h, h212h, h214h, h215h, h216h, h217h, h219h, h220h, h223h, h229h,
			h233h, h234h, h235h, s1, s2, s3, s4, s5, s6, s7,
	...
	{
		Home ho = new Home();
		string qurey = "insert into hawler_hazb(naw_mahafaza,\tmalband,\tcood_tasjil,\tnaw_tasjil,\tcood_bnka,\tnaw_bnka,\twestga_gshty,\tdangdar,\twestga,\twaraqa_rast,\twaraqapochal, [naw_karmand],[taime],[jor_dangdan],Device_name,srial_namber, [102],\t[103] ,\t[105] ,\t[106] ,\t[109] ,\t[111] ,\t[112] ,\t[114] ,\t[120] ,\t[123] ,\t[129] ,\t[131] ,\t[133] ,\t[139] ,\t[144] ,\t[146] ,\t[147] ,\t[148] ,\t[149] ,\t[150] ,\t[151] ,\t[154] ,\t[156] ,\t[157] ,\t[158] ,\t[160] ,\t[161] ,\t[162] ,\t[164] ,\t[167] ,\t[169] ,\t[170] ,\t[173] ,\t[176] ,\t[178] ,\t[179] ,\t[181] ,\t[184] ,\t[187] ,\t[189] ,\t[190] ,\t[191] ,\t[198] ,\t[199] ,\t[202] ,\t[203] ,\t[204] ,\t[205] ,\t[206] ,\t[208] ,\t[209] ,\t[210] ,\t[212] ,\t[214] ,\t[215] ,\t[216] ,\t[217] ,\t[219] ,\t[220] ,\t[223] ,\t[229] ,\t[233] ,\t[234] ,\t[235])VALUES (@naw_mahafaza,\t@malband,\t@cood_tasjil,\t@naw_tasjil,\t@cood_bnka,\t@naw_bnka,\t@westga_gshty,\t@dangdar,\t@westga,\t@waraqa_rast,\t@waraqapochal,@naw_karmand,@taime,@jor_dangdan,@Device_name,@srial_namber,@102,\t@103 ,\t@105 ,\t@106 ,\t@109 ,\t@111 ,\t@112 ,\t@114 ,\t@120 ,\t@123 ,\t@129 ,\t@131 ,\t@133 ,\t@139 ,\t@144 ,\t@146 ,\t@147 ,\t@148 ,\t@149 ,\t@150 ,\t@151 ,\t@154 ,\t@156 ,\t@157 ,\t@158 ,\t@160 ,\t@161 ,\t@162 ,\t@164 ,\t@167 ,\t@169 ,\t@170 ,\t@173 ,\t@176 ,\t@178 ,\t@179 ,\t@181 ,\t@184 ,\t@187 ,\t@189 ,\t@190 ,\t@191 ,\t@198 ,\t@199 ,\t@202 ,\t@203 ,\t@204 ,\t@205 ,\t@206 ,\t@208 ,\t@209 ,\t@210 ,\t@212 ,\t@214 ,\t@215 ,\t@216 ,\t@217 ,\t@219 ,\t@220 ,\t@223 ,\t@229 ,\t@233 ,\t@234 ,\t@235)";
		SqlCommand cmd = new SqlCommand(qurey, connectionString);
		connectionString.Open();
		cmd.Parameters.AddWithValue("@naw_mahafaza", txtparezga.Text);
	...
	{
		if (h102h.Text == string.Empty)
		{
			h102h.Text = "0";
		}
		if (h102h.Text == "0")
		{
			h102h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h102h.ForeColor = Color.Black;
		}
	}

	private void h103_Leave(object sender, EventArgs e)
	{
		if (h103h.Text == string.Empty)
		{
			h103h.Text = "0";
		}
		if (h103h.Text == "0")
		{
			h103h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h103h.ForeColor = Color.Black;
		}
	}

	private void h105_Leave(object sender, EventArgs e)
	{
		if (h105h.Text == string.Empty)
		{
			h105h.Text = "0";
		}
		if (h105h.Text == "0")
		{
			h105h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h105h.ForeColor = Color.Black;
		}
	}

	private void h106_Leave(object sender, EventArgs e)
	{
		if (h106h.Text == string.Empty)
		{
			h106h.Text = "0";
		}
		if (h106h.Text == "0")
		{
			h106h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h106h.ForeColor = Color.Black;
		}
	}

	private void h109_Leave(object sender, EventArgs e)
	{
		if (h109h.Text == string.Empty)
		{
			h109h.Text = "0";
		}
		if (h109h.Text == "0")
		{
			h109h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h109h.ForeColor = Color.Black;
		}
	}

	private void h111_Leave(object sender, EventArgs e)
	{
		if (h111h.Text == string.Empty)
		{
			h111h.Text = "0";
		}
		if (h111h.Text == "0")
		{
			h111h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h111h.ForeColor = Color.Black;
		}
	}

	private void h112_Leave(object sender, EventArgs e)
	{
		if (h112h.Text == string.Empty)
		{
			h112h.Text = "0";
		}
		if (h112h.Text == "0")
		{
			h112h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h112h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h114h.Text == string.Empty)
		{
			h114h.Text = "0";
		}
		if (h114h.Text == "0")
		{
			h114h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h114h.ForeColor = Color.Black;
		}
	}

	private void h123_Leave(object sender, EventArgs e)
	{
		if (h120h.Text == string.Empty)
		{
			h120h.Text = "0";
		}
		if (h120h.Text == "0")
		{
			h120h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h120h.ForeColor = Color.Black;
		}
	}

	private void h179_Leave(object sender, EventArgs e)
	{
		if (h189h.Text == string.Empty)
		{
			h189h.Text = "0";
		}
		if (h189h.Text == "0")
		{
			h189h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h189h.ForeColor = Color.Black;
		}
	}

	private void h181_Leave(object sender, EventArgs e)
	{
		if (h190h.Text == string.Empty)
		{
			h190h.Text = "0";
		}
		if (h190h.Text == "0")
		{
			h190h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h190h.ForeColor = Color.Black;
		}
	}

	private void h184_Leave(object sender, EventArgs e)
	{
		if (h191h.Text == string.Empty)
		{
			h191h.Text = "0";
		}
		if (h191h.Text == "0")
		{
			h191h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h191h.ForeColor = Color.Black;
		}
	}

	private void h187_Leave(object sender, EventArgs e)
	{
		if (h198h.Text == string.Empty)
		{
			h198h.Text = "0";
		}
		if (h198h.Text == "0")
		{
			h198h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h198h.ForeColor = Color.Black;
		}
	}

	private void h189_Leave(object sender, EventArgs e)
	{
		if (h199h.Text == string.Empty)
		{
			h199h.Text = "0";
		}
		if (h199h.Text == "0")
		{
			h199h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h199h.ForeColor = Color.Black;
		}
	}

	private void h190_Leave(object sender, EventArgs e)
	{
		if (h202h.Text == string.Empty)
		{
			h202h.Text = "0";
		}
		if (h202h.Text == "0")
		{
			h202h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h202h.ForeColor = Color.Black;
		}
	}

	private void h191_Leave(object sender, EventArgs e)
	{
		if (h203h.Text == string.Empty)
		{
			h203h.Text = "0";
		}
		if (h203h.Text == "0")
		{
			h203h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h203h.ForeColor = Color.Black;
		}
	}

	private void h198_Leave(object sender, EventArgs e)
	{
		if (h204h.Text == string.Empty)
		{
			h204h.Text = "0";
		}
		if (h204h.Text == "0")
		{
			h204h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h204h.ForeColor = Color.Black;
		}
	}

	private void h199_Leave(object sender, EventArgs e)
	{
		if (h205h.Text == string.Empty)
		{
			h205h.Text = "0";
		}
		if (h205h.Text == "0")
		{
			h205h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h205h.ForeColor = Color.Black;
		}
	}

	private void h202_Leave(object sender, EventArgs e)
	{
		if (h206h.Text == string.Empty)
		{
			h206h.Text = "0";
		}
		if (h206h.Text == "0")
		{
			h206h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h206h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h178h.Text == string.Empty)
		{
			h178h.Text = "0";
		}
		if (h178h.Text == "0")
		{
			h178h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h178h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h123h.Text == string.Empty)
		{
			h123h.Text = "0";
		}
		if (h123h.Text == "0")
		{
			h123h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h123h.ForeColor = Color.Black;
		}
	}

	private void h131_Leave(object sender, EventArgs e)
	{
		if (h129h.Text == string.Empty)
		{
			h129h.Text = "0";
		}
		if (h129h.Text == "0")
		{
			h129h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h129h.ForeColor = Color.Black;
		}
	}

	private void h133_Leave(object sender, EventArgs e)
	{
		if (h131h.Text == string.Empty)
		{
			h131h.Text = "0";
		}
		if (h131h.Text == "0")
		{
			h131h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h131h.ForeColor = Color.Black;
		}
	}

	private void h139_Leave(object sender, EventArgs e)
	{
		if (h133h.Text == string.Empty)
		{
			h133h.Text = "0";
		}
		if (h133h.Text == "0")
		{
			h133h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h133h.ForeColor = Color.Black;
		}
	}

	private void h144_Leave(object sender, EventArgs e)
	{
		if (h139h.Text == string.Empty)
		{
			h139h.Text = "0";
		}
		if (h139h.Text == "0")
		{
			h139h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h139h.ForeColor = Color.Black;
		}
	}

	private void h146_Leave(object sender, EventArgs e)
	{
		if (h144h.Text == string.Empty)
		{
			h144h.Text = "0";
		}
		if (h144h.Text == "0")
		{
			h144h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h144h.ForeColor = Color.Black;
		}
	}

	private void h147_Leave(object sender, EventArgs e)
	{
		if (h146h.Text == string.Empty)
		{
			h146h.Text = "0";
		}
		if (h146h.Text == "0")
		{
			h146h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h146h.ForeColor = Color.Black;
		}
	}

	private void h148_Leave(object sender, EventArgs e)
	{
		if (h147h.Text == string.Empty)
		{
			h147h.Text = "0";
		}
		if (h147h.Text == "0")
		{
			h147h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h147h.ForeColor = Color.Black;
		}
	}

	private void h149_Leave(object sender, EventArgs e)
	{
		if (h148h.Text == string.Empty)
		{
			h148h.Text = "0";
		}
		if (h148h.Text == "0")
		{
			h148h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h148h.ForeColor = Color.Black;
		}
	}

	private void h203_Leave(object sender, EventArgs e)
	{
		if (h208h.Text == string.Empty)
		{
			h208h.Text = "0";
		}
		if (h208h.Text == "0")
		{
			h208h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h208h.ForeColor = Color.Black;
		}
	}

	private void h204_Leave(object sender, EventArgs e)
	{
		if (h209h.Text == string.Empty)
		{
			h209h.Text = "0";
		}
		if (h209h.Text == "0")
		{
			h209h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h209h.ForeColor = Color.Black;
		}
	}

	private void h205_Leave(object sender, EventArgs e)
	{
		if (h210h.Text == string.Empty)
		{
			h210h.Text = "0";
		}
		if (h210h.Text == "0")
		{
			h210h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h210h.ForeColor = Color.Black;
		}
	}

	private void h206_Leave(object sender, EventArgs e)
	{
		if (h212h.Text == string.Empty)
		{
			h212h.Text = "0";
		}
		if (h212h.Text == "0")
		{
			h212h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h212h.ForeColor = Color.Black;
		}
	}

	private void h208_Leave(object sender, EventArgs e)
	{
		if (h214h.Text == string.Empty)
		{
			h214h.Text = "0";
		}
		if (h214h.Text == "0")
		{
			h214h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h214h.ForeColor = Color.Black;
		}
	}

	private void h209_Leave(object sender, EventArgs e)
	{
		if (h215h.Text == string.Empty)
		{
			h215h.Text = "0";
		}
		if (h215h.Text == "0")
		{
			h215h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h215h.ForeColor = Color.Black;
		}
	}

	private void h210_Leave(object sender, EventArgs e)
	{
		if (h216h.Text == string.Empty)
		{
			h216h.Text = "0";
		}
		if (h216h.Text == "0")
		{
			h216h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h216h.ForeColor = Color.Black;
		}
	}

	private void h212_Leave(object sender, EventArgs e)
	{
		if (h217h.Text == string.Empty)
		{
			h217h.Text = "0";
		}
		if (h217h.Text == "0")
		{
			h217h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h217h.ForeColor = Color.Black;
		}
	}

	private void h214_Leave(object sender, EventArgs e)
	{
		if (h219h.Text == string.Empty)
		{
			h219h.Text = "0";
		}
		if (h219h.Text == "0")
		{
			h219h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h219h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h176h.Text == string.Empty)
		{
			h176h.Text = "0";
		}
		if (h176h.Text == "0")
		{
			h176h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h176h.ForeColor = Color.Black;
		}
	}

	private void s135_Leave(object sender, EventArgs e)
	{
		if (h173h.Text == string.Empty)
		{
			h173h.Text = "0";
		}
		if (h173h.Text == "0")
		{
			h173h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h173h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h179h.Text == string.Empty)
		{
			h179h.Text = "0";
		}
		if (h179h.Text == "0")
		{
			h179h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h179h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h149h.Text == string.Empty)
		{
			h149h.Text = "0";
		}
		if (h149h.Text == "0")
		{
			h149h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h149h.ForeColor = Color.Black;
		}
	}

	private void h151_Leave(object sender, EventArgs e)
	{
		if (h150h.Text == string.Empty)
		{
			h150h.Text = "0";
		}
		if (h150h.Text == "0")
		{
			h150h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h150h.ForeColor = Color.Black;
		}
	}

	private void h154_Leave(object sender, EventArgs e)
	{
		if (h151h.Text == string.Empty)
		{
			h151h.Text = "0";
		}
		if (h151h.Text == "0")
		{
			h151h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h151h.ForeColor = Color.Black;
		}
	}

	private void h156_Leave(object sender, EventArgs e)
	{
		if (h154h.Text == string.Empty)
		{
			h154h.Text = "0";
		}
		if (h154h.Text == "0")
		{
			h154h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h154h.ForeColor = Color.Black;
		}
	}

	private void h157_Leave(object sender, EventArgs e)
	{
		if (h156h.Text == string.Empty)
		{
			h156h.Text = "0";
		}
		if (h156h.Text == "0")
		{
			h156h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h156h.ForeColor = Color.Black;
		}
	}

	private void h158_Leave(object sender, EventArgs e)
	{
		if (h157h.Text == string.Empty)
		{
			h157h.Text = "0";
		}
		if (h157h.Text == "0")
		{
			h157h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h157h.ForeColor = Color.Black;
		}
	}

	private void h160_Leave(object sender, EventArgs e)
	{
		if (h158h.Text == string.Empty)
		{
			h158h.Text = "0";
		}
		if (h158h.Text == "0")
		{
			h158h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h158h.ForeColor = Color.Black;
		}
	}

	private void h161_Leave(object sender, EventArgs e)
	{
		if (h160h.Text == string.Empty)
		{
			h160h.Text = "0";
		}
		if (h160h.Text == "0")
		{
			h160h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h160h.ForeColor = Color.Black;
		}
	}

	private void h162_Leave(object sender, EventArgs e)
	{
		if (h161h.Text == string.Empty)
		{
			h161h.Text = "0";
		}
		if (h161h.Text == "0")
		{
			h161h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h161h.ForeColor = Color.Black;
		}
	}

	private void h164_Leave(object sender, EventArgs e)
	{
		if (h162h.Text == string.Empty)
		{
			h162h.Text = "0";
		}
		if (h162h.Text == "0")
		{
			h162h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h162h.ForeColor = Color.Black;
		}
	}

	private void h215_Leave(object sender, EventArgs e)
	{
		if (h220h.Text == string.Empty)
		{
			h220h.Text = "0";
		}
		if (h220h.Text == "0")
		{
			h220h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h220h.ForeColor = Color.Black;
		}
	}

	private void h216_Leave(object sender, EventArgs e)
	{
		if (h223h.Text == string.Empty)
		{
			h223h.Text = "0";
		}
		if (h223h.Text == "0")
		{
			h223h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h223h.ForeColor = Color.Black;
		}
	}

	private void h217_Leave(object sender, EventArgs e)
	{
		if (h229h.Text == string.Empty)
		{
			h229h.Text = "0";
		}
		if (h229h.Text == "0")
		{
			h229h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h229h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h234h.Text == string.Empty)
		{
			h234h.Text = "0";
		}
		if (h234h.Text == "0")
		{
			h234h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h234h.ForeColor = Color.Black;
		}
	}

	private void h223_Leave(object sender, EventArgs e)
	{
		if (h235h.Text == string.Empty)
		{
			h235h.Text = "0";
		}
		if (h235h.Text == "0")
		{
			h235h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h235h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h170h.Text == string.Empty)
		{
			h170h.Text = "0";
		}
		if (h170h.Text == "0")
		{
			h170h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h170h.ForeColor = Color.Black;
		}
	}
	...
	{
		if (h164h.Text == string.Empty)
		{
			h164h.Text = "0";
		}
		if (h164h.Text == "0")
		{
			h164h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h164h.ForeColor = Color.Black;
		}
	}

	private void h169_Leave(object sender, EventArgs e)
	{
		if (h167h.Text == string.Empty)
		{
			h167h.Text = "0";
		}
		if (h167h.Text == "0")
		{
			h167h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h167h.ForeColor = Color.Black;
		}
	}

	private void h170_Leave(object sender, EventArgs e)
	{
		if (h169h.Text == string.Empty)
		{
			h169h.Text = "0";
		}
		if (h169h.Text == "0")
		{
			h169h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h169h.ForeColor = Color.Black;
		}
	}

	private void h173_Leave(object sender, EventArgs e)
	{
		if (h181h.Text == string.Empty)
		{
			h181h.Text = "0";
		}
		if (h181h.Text == "0")
		{
			h181h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h181h.ForeColor = Color.Black;
		}
	}

	private void h176_Leave(object sender, EventArgs e)
	{
		if (h184h.Text == string.Empty)
		{
			h184h.Text = "0";
		}
		if (h184h.Text == "0")
		{
			h184h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h184h.ForeColor = Color.Black;
		}
	}

	private void h178_Leave(object sender, EventArgs e)
	{
		if (h187h.Text == string.Empty)
		{
			h187h.Text = "0";
		}
		if (h187h.Text == "0")
		{
			h187h.ForeColor = Color.FromArgb(255, 192, 192);
		}
		else
		{
			h187h.ForeColor = Color.Black;
		}
	}
	...
	private void button5_Click(object sender, EventArgs e)
	{
		...
		{
			string qurey1 = "delete from  candid_h  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			string qurey = "delete from  hawler_hazb  WHERE cood_bnka = " + txtbnkacood.Text + " and westga=" + comwestga.Text;
			SqlCommand cmd = new SqlCommand(qurey, connectionString);
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PUK_Anjamakan.Frm.H_Gshty));
		...
		this.h181h = new System.Windows.Forms.TextBox();
		this.h184h = new System.Windows.Forms.TextBox();
		this.h187h = new System.Windows.Forms.TextBox();
		this.h189h = new System.Windows.Forms.TextBox();
		this.h190h = new System.Windows.Forms.TextBox();
		this.h191h = new System.Windows.Forms.TextBox();
		this.h198h = new System.Windows.Forms.TextBox();
		this.h199h = new System.Windows.Forms.TextBox();
		this.h202h = new System.Windows.Forms.TextBox();
		this.h203h = new System.Windows.Forms.TextBox();
		this.h204h = new System.Windows.Forms.TextBox();
		this.h205h = new System.Windows.Forms.TextBox();
		this.h206h = new System.Windows.Forms.TextBox();
		this.h208h = new System.Windows.Forms.TextBox();
		this.h209h = new System.Windows.Forms.TextBox();
		this.h210h = new System.Windows.Forms.TextBox();
		this.h212h = new System.Windows.Forms.TextBox();
		this.h214h = new System.Windows.Forms.TextBox();
		this.h215h = new System.Windows.Forms.TextBox();
		this.h216h = new System.Windows.Forms.TextBox();
		this.h217h = new System.Windows.Forms.TextBox();
		this.h219h = new System.Windows.Forms.TextBox();
		this.h220h = new System.Windows.Forms.TextBox();
		this.h223h = new System.Windows.Forms.TextBox();
		this.h229h = new System.Windows.Forms.TextBox();
		this.h233h = new System.Windows.Forms.TextBox();
		this.h234h = new System.Windows.Forms.TextBox();
		this.h235h = new System.Windows.Forms.TextBox();
		...
		this.h102h = new System.Windows.Forms.TextBox();
		this.h103h = new System.Windows.Forms.TextBox();
		this.h105h = new System.Windows.Forms.TextBox();
		this.h106h = new System.Windows.Forms.TextBox();
		this.h109h = new System.Windows.Forms.TextBox();
		this.h111h = new System.Windows.Forms.TextBox();
		this.h112h = new System.Windows.Forms.TextBox();
		...
		this.h114h = new System.Windows.Forms.TextBox();
		this.label88 = new System.Windows.Forms.Label();
		this.label84 = new System.Windows.Forms.Label();
		this.label82 = new System.Windows.Forms.Label();
		this.h120h = new System.Windows.Forms.TextBox();
		this.label86 = new System.Windows.Forms.Label();
		this.h123h = new System.Windows.Forms.TextBox();
		this.label136 = new System.Windows.Forms.Label();
		this.h129h = new System.Windows.Forms.TextBox();
		this.label138 = new System.Windows.Forms.Label();
		this.h131h = new System.Windows.Forms.TextBox();
		this.label139 = new System.Windows.Forms.Label();
		this.h133h = new System.Windows.Forms.TextBox();
		this.label140 = new System.Windows.Forms.Label();
		this.h139h = new System.Windows.Forms.TextBox();
		this.label142 = new System.Windows.Forms.Label();
		this.h144h = new System.Windows.Forms.TextBox();
		this.label143 = new System.Windows.Forms.Label();
		this.h146h = new System.Windows.Forms.TextBox();
		this.h147h = new System.Windows.Forms.TextBox();
		this.label144 = new System.Windows.Forms.Label();
		this.label146 = new System.Windows.Forms.Label();
		this.h148h = new System.Windows.Forms.TextBox();
		this.label147 = new System.Windows.Forms.Label();
		this.h149h = new System.Windows.Forms.TextBox();
		this.label148 = new System.Windows.Forms.Label();
		this.h150h = new System.Windows.Forms.TextBox();
		this.label150 = new System.Windows.Forms.Label();
		this.h151h = new System.Windows.Forms.TextBox();
		this.h154h = new System.Windows.Forms.TextBox();
		this.label151 = new System.Windows.Forms.Label();
		this.label152 = new System.Windows.Forms.Label();
		this.h156h = new System.Windows.Forms.TextBox();
		this.h157h = new System.Windows.Forms.TextBox();
		this.label154 = new System.Windows.Forms.Label();
		this.label155 = new System.Windows.Forms.Label();
		this.h158h = new System.Windows.Forms.TextBox();
		this.h160h = new System.Windows.Forms.TextBox();
		this.label156 = new System.Windows.Forms.Label();
		this.label158 = new System.Windows.Forms.Label();
		this.h161h = new System.Windows.Forms.TextBox();
		this.label159 = new System.Windows.Forms.Label();
		this.h162h = new System.Windows.Forms.TextBox();
		this.label160 = new System.Windows.Forms.Label();
		this.h164h = new System.Windows.Forms.TextBox();
		this.label162 = new System.Windows.Forms.Label();
		this.h167h = new System.Windows.Forms.TextBox();
		this.h169h = new System.Windows.Forms.TextBox();
		this.label163 = new System.Windows.Forms.Label();
		this.label164 = new System.Windows.Forms.Label();
		this.h170h = new System.Windows.Forms.TextBox();
		this.label166 = new System.Windows.Forms.Label();
		this.h173h = new System.Windows.Forms.TextBox();
		this.label167 = new System.Windows.Forms.Label();
		this.h176h = new System.Windows.Forms.TextBox();
		this.label168 = new System.Windows.Forms.Label();
		this.h178h = new System.Windows.Forms.TextBox();
		...
		this.h179h = new System.Windows.Forms.TextBox();
		...
		this.txtmalband.Location = new System.Drawing.Point(926, 60);
		...
		this.txtparezga.Location = new System.Drawing.Point(807, 60);
		this.txtparezga.Multiline = true;
		this.txtparezga.Name = "txtparezga";
		this.txtparezga.ReadOnly = true;
		this.txtparezga.Size = new System.Drawing.Size(113, 50);
		...
		this.txtcoodtasj.Location = new System.Drawing.Point(664, 60);
		this.txtcoodtasj.Multiline = true;
		this.txtcoodtasj.Name = "txtcoodtasj";
		this.txtcoodtasj.ReadOnly = true;
		this.txtcoodtasj.Size = new System.Drawing.Size(137, 50);
		...
		this.txtnawtasj.Location = new System.Drawing.Point(470, 60);
		...
		this.txtnawbnka.Size = new System.Drawing.Size(246, 50);
		...
		this.txtbnkacood.Location = new System.Drawing.Point(1146, 60);
		this.txtbnkacood.Multiline = true;
		this.txtbnkacood.Name = "txtbnkacood";
		this.txtbnkacood.Size = new System.Drawing.Size(208, 50);
		...
		this.label10.Size = new System.Drawing.Size(113, 57);
		...
		this.btnsearch.Location = new System.Drawing.Point(993, 60);
		...
		this.label3.Location = new System.Drawing.Point(1146, 0);
		...
		this.label1.Location = new System.Drawing.Point(926, 0);
		...
		this.bnltablsearch.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 178f));
		...
		this.label49.Location = new System.Drawing.Point(1178, 0);
		this.label49.Name = "label49";
		this.label49.Size = new System.Drawing.Size(176, 60);
		...
		this.comwestga.Location = new System.Drawing.Point(1027, 3);
		...
		this.btnadd.Location = new System.Drawing.Point(826, 3);
		...
		this.label4.Size = new System.Drawing.Size(241, 60);
		...
		this.txtwaraqadrost.Location = new System.Drawing.Point(504, 3);
		...
		this.txtwaraqaybatl.Location = new System.Drawing.Point(164, 3);
		...
		this.btn_candid_d.Text = " لیستی قەوارەکانی پارێزگای هەولێر ";
		...
		this.tableLayoutPanel7.Controls.Add(this.h181h, 5, 0);
		this.tableLayoutPanel7.Controls.Add(this.h184h, 5, 1);
		this.tableLayoutPanel7.Controls.Add(this.h187h, 5, 2);
		this.tableLayoutPanel7.Controls.Add(this.h189h, 5, 3);
		this.tableLayoutPanel7.Controls.Add(this.h190h, 5, 4);
		this.tableLayoutPanel7.Controls.Add(this.h191h, 5, 5);
		this.tableLayoutPanel7.Controls.Add(this.h198h, 5, 6);
		this.tableLayoutPanel7.Controls.Add(this.h199h, 5, 7);
		this.tableLayoutPanel7.Controls.Add(this.h202h, 5, 8);
		this.tableLayoutPanel7.Controls.Add(this.h203h, 5, 9);
		this.tableLayoutPanel7.Controls.Add(this.h204h, 5, 10);
		this.tableLayoutPanel7.Controls.Add(this.h205h, 5, 11);
		this.tableLayoutPanel7.Controls.Add(this.h206h, 5, 12);
		this.tableLayoutPanel7.Controls.Add(this.h208h, 5, 13);
		this.tableLayoutPanel7.Controls.Add(this.h209h, 5, 14);
		this.tableLayoutPanel7.Controls.Add(this.h210h, 5, 15);
		this.tableLayoutPanel7.Controls.Add(this.h212h, 5, 16);
		this.tableLayoutPanel7.Controls.Add(this.h214h, 5, 17);
		this.tableLayoutPanel7.Controls.Add(this.h215h, 5, 18);
		this.tableLayoutPanel7.Controls.Add(this.h216h, 5, 19);
		this.tableLayoutPanel7.Controls.Add(this.h217h, 5, 20);
		this.tableLayoutPanel7.Controls.Add(this.h219h, 5, 21);
		this.tableLayoutPanel7.Controls.Add(this.h220h, 5, 22);
		this.tableLayoutPanel7.Controls.Add(this.h223h, 5, 23);
		this.tableLayoutPanel7.Controls.Add(this.h229h, 5, 24);
		this.tableLayoutPanel7.Controls.Add(this.h233h, 5, 25);
		this.tableLayoutPanel7.Controls.Add(this.h234h, 5, 26);
		this.tableLayoutPanel7.Controls.Add(this.h235h, 5, 27);
		...
		this.tableLayoutPanel7.Controls.Add(this.h102h, 8, 0);
		this.tableLayoutPanel7.Controls.Add(this.h103h, 8, 1);
		this.tableLayoutPanel7.Controls.Add(this.h105h, 8, 2);
		this.tableLayoutPanel7.Controls.Add(this.h106h, 8, 3);
		this.tableLayoutPanel7.Controls.Add(this.h109h, 8, 4);
		this.tableLayoutPanel7.Controls.Add(this.h111h, 8, 5);
		this.tableLayoutPanel7.Controls.Add(this.h112h, 8, 6);
		...
		this.tableLayoutPanel7.Controls.Add(this.h114h, 8, 7);
		...
		this.tableLayoutPanel7.Controls.Add(this.label43, 10, 10);
		this.tableLayoutPanel7.Controls.Add(this.label87, 7, 32);
		this.tableLayoutPanel7.Controls.Add(this.label85, 7, 31);
		this.tableLayoutPanel7.Controls.Add(this.label83, 7, 30);
		this.tableLayoutPanel7.Controls.Add(this.label81, 7, 29);
		this.tableLayoutPanel7.Controls.Add(this.label79, 7, 28);
		this.tableLayoutPanel7.Controls.Add(this.label15, 7, 3);
		this.tableLayoutPanel7.Controls.Add(this.label13, 7, 2);
		this.tableLayoutPanel7.Controls.Add(this.label16, 7, 1);
		this.tableLayoutPanel7.Controls.Add(this.label21, 10, 35);
		this.tableLayoutPanel7.Controls.Add(this.label17, 10, 34);
		this.tableLayoutPanel7.Controls.Add(this.label14, 10, 33);
		this.tableLayoutPanel7.Controls.Add(this.label311, 10, 32);
		this.tableLayoutPanel7.Controls.Add(this.label307, 10, 31);
		this.tableLayoutPanel7.Controls.Add(this.label303, 10, 30);
		this.tableLayoutPanel7.Controls.Add(this.label299, 10, 29);
		this.tableLayoutPanel7.Controls.Add(this.label295, 10, 28);
		this.tableLayoutPanel7.Controls.Add(this.label283, 10, 25);
		this.tableLayoutPanel7.Controls.Add(this.label279, 10, 24);
		this.tableLayoutPanel7.Controls.Add(this.label275, 10, 23);
		this.tableLayoutPanel7.Controls.Add(this.label271, 10, 22);
		this.tableLayoutPanel7.Controls.Add(this.label267, 10, 21);
		this.tableLayoutPanel7.Controls.Add(this.label263, 10, 20);
		this.tableLayoutPanel7.Controls.Add(this.label25, 7, 0);
		this.tableLayoutPanel7.Controls.Add(this.label251, 10, 17);
		this.tableLayoutPanel7.Controls.Add(this.label247, 10, 16);
		this.tableLayoutPanel7.Controls.Add(this.label69, 10, 15);
		this.tableLayoutPanel7.Controls.Add(this.label72, 10, 14);
		this.tableLayoutPanel7.Controls.Add(this.label76, 10, 13);
		this.tableLayoutPanel7.Controls.Add(this.label80, 10, 12);
		this.tableLayoutPanel7.Controls.Add(this.label74, 10, 11);
		this.tableLayoutPanel7.Controls.Add(this.label255, 10, 18);
		this.tableLayoutPanel7.Controls.Add(this.label259, 10, 19);
		this.tableLayoutPanel7.Controls.Add(this.label287, 10, 26);
		this.tableLayoutPanel7.Controls.Add(this.label291, 10, 27);
		this.tableLayoutPanel7.Controls.Add(this.label22, 7, 7);
		this.tableLayoutPanel7.Controls.Add(this.label20, 7, 6);
		this.tableLayoutPanel7.Controls.Add(this.label18, 7, 5);
		this.tableLayoutPanel7.Controls.Add(this.label77, 7, 4);
		this.tableLayoutPanel7.Controls.Add(this.label24, 7, 8);
		this.tableLayoutPanel7.Controls.Add(this.label26, 7, 9);
		this.tableLayoutPanel7.Controls.Add(this.label28, 7, 10);
		this.tableLayoutPanel7.Controls.Add(this.label32, 7, 12);
		this.tableLayoutPanel7.Controls.Add(this.label30, 7, 11);
		this.tableLayoutPanel7.Controls.Add(this.label42, 7, 16);
		this.tableLayoutPanel7.Controls.Add(this.label40, 7, 15);
		this.tableLayoutPanel7.Controls.Add(this.label36, 7, 13);
		this.tableLayoutPanel7.Controls.Add(this.label38, 7, 14);
		this.tableLayoutPanel7.Controls.Add(this.label44, 7, 17);
		this.tableLayoutPanel7.Controls.Add(this.label92, 7, 18);
		this.tableLayoutPanel7.Controls.Add(this.label51, 7, 19);
		this.tableLayoutPanel7.Controls.Add(this.label46, 7, 27);
		this.tableLayoutPanel7.Controls.Add(this.label73, 7, 26);
		this.tableLayoutPanel7.Controls.Add(this.label71, 7, 25);
		this.tableLayoutPanel7.Controls.Add(this.label68, 7, 24);
		this.tableLayoutPanel7.Controls.Add(this.label63, 7, 23);
		this.tableLayoutPanel7.Controls.Add(this.label61, 7, 22);
		this.tableLayoutPanel7.Controls.Add(this.label59, 7, 21);
		this.tableLayoutPanel7.Controls.Add(this.label48, 7, 20);
		this.tableLayoutPanel7.Controls.Add(this.label75, 9, 35);
		this.tableLayoutPanel7.Controls.Add(this.h179h, 8, 35);
		...
		this.h181h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h181h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h181h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h181h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h181h.Location = new System.Drawing.Point(402, 3);
		this.h181h.Multiline = true;
		this.h181h.Name = "h181h";
		this.h181h.Size = new System.Drawing.Size(106, 48);
		this.h181h.TabIndex = 36;
		this.h181h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h181h.Click += new System.EventHandler(h173_Click);
		this.h181h.TextChanged += new System.EventHandler(h173_TextChanged);
		this.h181h.KeyDown += new System.Windows.Forms.KeyEventHandler(h173_KeyDown);
		this.h181h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h173_KeyPress);
		this.h181h.Leave += new System.EventHandler(h173_Leave);
		this.h184h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h184h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h184h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h184h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h184h.Location = new System.Drawing.Point(402, 57);
		this.h184h.Multiline = true;
		this.h184h.Name = "h184h";
		this.h184h.Size = new System.Drawing.Size(106, 48);
		this.h184h.TabIndex = 37;
		this.h184h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h184h.Click += new System.EventHandler(h176_Click);
		this.h184h.TextChanged += new System.EventHandler(h176_TextChanged);
		this.h184h.KeyDown += new System.Windows.Forms.KeyEventHandler(h176_KeyDown);
		this.h184h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h176_KeyPress);
		this.h184h.Leave += new System.EventHandler(h176_Leave);
		this.h187h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h187h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h187h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h187h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h187h.Location = new System.Drawing.Point(402, 111);
		this.h187h.Multiline = true;
		this.h187h.Name = "h187h";
		this.h187h.Size = new System.Drawing.Size(106, 48);
		this.h187h.TabIndex = 38;
		this.h187h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h187h.Click += new System.EventHandler(h178_Click);
		this.h187h.TextChanged += new System.EventHandler(h178_TextChanged);
		this.h187h.KeyDown += new System.Windows.Forms.KeyEventHandler(h178_KeyDown);
		this.h187h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h178_KeyPress);
		this.h187h.Leave += new System.EventHandler(h178_Leave);
		this.h189h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h189h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h189h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h189h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h189h.Location = new System.Drawing.Point(402, 165);
		this.h189h.Multiline = true;
		this.h189h.Name = "h189h";
		this.h189h.Size = new System.Drawing.Size(106, 48);
		this.h189h.TabIndex = 39;
		this.h189h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h189h.TextChanged += new System.EventHandler(h179_TextChanged);
		this.h189h.KeyDown += new System.Windows.Forms.KeyEventHandler(h179_KeyDown);
		this.h189h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h179_KeyPress);
		this.h189h.Leave += new System.EventHandler(h179_Leave);
		this.h190h.BackColor = System.Drawing.Color.Yellow;
		this.h190h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h190h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h190h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h190h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h190h.Location = new System.Drawing.Point(402, 219);
		this.h190h.Multiline = true;
		this.h190h.Name = "h190h";
		this.h190h.Size = new System.Drawing.Size(106, 48);
		this.h190h.TabIndex = 40;
		this.h190h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h190h.TextChanged += new System.EventHandler(h181_TextChanged);
		this.h190h.KeyDown += new System.Windows.Forms.KeyEventHandler(h181_KeyDown);
		this.h190h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h181_KeyPress);
		this.h190h.Leave += new System.EventHandler(h181_Leave);
		this.h191h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h191h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h191h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h191h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h191h.Location = new System.Drawing.Point(402, 273);
		this.h191h.Multiline = true;
		this.h191h.Name = "h191h";
		this.h191h.Size = new System.Drawing.Size(106, 48);
		this.h191h.TabIndex = 41;
		this.h191h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h191h.Click += new System.EventHandler(h184_Click);
		this.h191h.TextChanged += new System.EventHandler(h184_TextChanged);
		this.h191h.KeyDown += new System.Windows.Forms.KeyEventHandler(h184_KeyDown);
		this.h191h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h184_KeyPress);
		this.h191h.Leave += new System.EventHandler(h184_Leave);
		this.h198h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h198h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h198h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h198h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h198h.Location = new System.Drawing.Point(402, 327);
		this.h198h.Multiline = true;
		this.h198h.Name = "h198h";
		this.h198h.Size = new System.Drawing.Size(106, 48);
		this.h198h.TabIndex = 42;
		this.h198h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h198h.Click += new System.EventHandler(h187_Click);
		this.h198h.TextChanged += new System.EventHandler(h187_TextChanged);
		this.h198h.KeyDown += new System.Windows.Forms.KeyEventHandler(h187_KeyDown);
		this.h198h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h187_KeyPress);
		this.h198h.Leave += new System.EventHandler(h187_Leave);
		this.h199h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h199h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h199h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h199h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h199h.Location = new System.Drawing.Point(402, 381);
		this.h199h.Multiline = true;
		this.h199h.Name = "h199h";
		this.h199h.Size = new System.Drawing.Size(106, 48);
		this.h199h.TabIndex = 43;
		this.h199h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h199h.Click += new System.EventHandler(h189_Click);
		this.h199h.TextChanged += new System.EventHandler(h189_TextChanged);
		this.h199h.KeyDown += new System.Windows.Forms.KeyEventHandler(h189_KeyDown);
		this.h199h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h189_KeyPress);
		this.h199h.Leave += new System.EventHandler(h189_Leave);
		this.h202h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h202h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h202h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h202h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h202h.Location = new System.Drawing.Point(402, 435);
		this.h202h.Multiline = true;
		this.h202h.Name = "h202h";
		this.h202h.Size = new System.Drawing.Size(106, 48);
		this.h202h.TabIndex = 44;
		this.h202h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h202h.Click += new System.EventHandler(h190_Click);
		this.h202h.TextChanged += new System.EventHandler(h190_TextChanged);
		this.h202h.KeyDown += new System.Windows.Forms.KeyEventHandler(h190_KeyDown);
		this.h202h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h190_KeyPress);
		this.h202h.Leave += new System.EventHandler(h190_Leave);
		this.h203h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h203h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h203h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h203h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h203h.Location = new System.Drawing.Point(402, 489);
		this.h203h.Multiline = true;
		this.h203h.Name = "h203h";
		this.h203h.Size = new System.Drawing.Size(106, 48);
		this.h203h.TabIndex = 45;
		this.h203h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h203h.Click += new System.EventHandler(h191_Click);
		this.h203h.TextChanged += new System.EventHandler(h191_TextChanged);
		this.h203h.KeyDown += new System.Windows.Forms.KeyEventHandler(h191_KeyDown);
		this.h203h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h191_KeyPress);
		this.h203h.Leave += new System.EventHandler(h191_Leave);
		this.h204h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h204h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h204h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h204h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h204h.Location = new System.Drawing.Point(402, 543);
		this.h204h.Multiline = true;
		this.h204h.Name = "h204h";
		this.h204h.Size = new System.Drawing.Size(106, 48);
		this.h204h.TabIndex = 46;
		this.h204h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h204h.Click += new System.EventHandler(h198_Click);
		this.h204h.TextChanged += new System.EventHandler(h198_TextChanged);
		this.h204h.KeyDown += new System.Windows.Forms.KeyEventHandler(h198_KeyDown);
		this.h204h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h198_KeyPress);
		this.h204h.Leave += new System.EventHandler(h198_Leave);
		this.h205h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h205h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h205h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h205h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h205h.Location = new System.Drawing.Point(402, 597);
		this.h205h.Multiline = true;
		this.h205h.Name = "h205h";
		this.h205h.Size = new System.Drawing.Size(106, 48);
		this.h205h.TabIndex = 47;
		this.h205h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h205h.Click += new System.EventHandler(h199_Click);
		this.h205h.TextChanged += new System.EventHandler(h199_TextChanged);
		this.h205h.KeyDown += new System.Windows.Forms.KeyEventHandler(h199_KeyDown);
		this.h205h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h199_KeyPress);
		this.h205h.Leave += new System.EventHandler(h199_Leave);
		this.h206h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h206h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h206h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h206h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h206h.Location = new System.Drawing.Point(402, 651);
		this.h206h.Multiline = true;
		this.h206h.Name = "h206h";
		this.h206h.Size = new System.Drawing.Size(106, 48);
		this.h206h.TabIndex = 48;
		this.h206h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h206h.Click += new System.EventHandler(h202_Click);
		this.h206h.TextChanged += new System.EventHandler(h202_TextChanged);
		this.h206h.KeyDown += new System.Windows.Forms.KeyEventHandler(h202_KeyDown);
		this.h206h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h202_KeyPress);
		this.h206h.Leave += new System.EventHandler(h202_Leave);
		this.h208h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h208h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h208h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h208h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h208h.Location = new System.Drawing.Point(402, 705);
		this.h208h.Multiline = true;
		this.h208h.Name = "h208h";
		this.h208h.Size = new System.Drawing.Size(106, 48);
		this.h208h.TabIndex = 49;
		this.h208h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h208h.Click += new System.EventHandler(h203_Click);
		this.h208h.TextChanged += new System.EventHandler(h203_TextChanged);
		this.h208h.KeyDown += new System.Windows.Forms.KeyEventHandler(h203_KeyDown);
		this.h208h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h203_KeyPress);
		this.h208h.Leave += new System.EventHandler(h203_Leave);
		this.h209h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h209h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h209h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h209h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h209h.Location = new System.Drawing.Point(402, 759);
		this.h209h.Multiline = true;
		this.h209h.Name = "h209h";
		this.h209h.Size = new System.Drawing.Size(106, 48);
		this.h209h.TabIndex = 50;
		this.h209h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h209h.Click += new System.EventHandler(h204_Click);
		this.h209h.TextChanged += new System.EventHandler(h204_TextChanged);
		this.h209h.KeyDown += new System.Windows.Forms.KeyEventHandler(h204_KeyDown);
		this.h209h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h204_KeyPress);
		this.h209h.Leave += new System.EventHandler(h204_Leave);
		this.h210h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h210h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h210h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h210h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h210h.Location = new System.Drawing.Point(402, 813);
		this.h210h.Multiline = true;
		this.h210h.Name = "h210h";
		this.h210h.Size = new System.Drawing.Size(106, 48);
		this.h210h.TabIndex = 51;
		this.h210h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h210h.Click += new System.EventHandler(h205_Click);
		this.h210h.TextChanged += new System.EventHandler(h205_TextChanged);
		this.h210h.KeyDown += new System.Windows.Forms.KeyEventHandler(h205_KeyDown);
		this.h210h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h205_KeyPress);
		this.h210h.Leave += new System.EventHandler(h205_Leave);
		this.h212h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h212h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h212h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h212h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h212h.Location = new System.Drawing.Point(402, 867);
		this.h212h.Multiline = true;
		this.h212h.Name = "h212h";
		this.h212h.Size = new System.Drawing.Size(106, 48);
		this.h212h.TabIndex = 52;
		this.h212h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h212h.Click += new System.EventHandler(h206_Click);
		this.h212h.TextChanged += new System.EventHandler(h206_TextChanged);
		this.h212h.KeyDown += new System.Windows.Forms.KeyEventHandler(h206_KeyDown);
		this.h212h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h206_KeyPress);
		this.h212h.Leave += new System.EventHandler(h206_Leave);
		this.h214h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h214h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h214h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h214h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h214h.Location = new System.Drawing.Point(402, 921);
		this.h214h.Multiline = true;
		this.h214h.Name = "h214h";
		this.h214h.Size = new System.Drawing.Size(106, 48);
		this.h214h.TabIndex = 53;
		this.h214h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h214h.Click += new System.EventHandler(h208_Click);
		this.h214h.TextChanged += new System.EventHandler(h208_TextChanged);
		this.h214h.KeyDown += new System.Windows.Forms.KeyEventHandler(h208_KeyDown);
		this.h214h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h208_KeyPress);
		this.h214h.Leave += new System.EventHandler(h208_Leave);
		this.h215h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h215h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h215h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h215h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h215h.Location = new System.Drawing.Point(402, 975);
		this.h215h.Multiline = true;
		this.h215h.Name = "h215h";
		this.h215h.Size = new System.Drawing.Size(106, 48);
		this.h215h.TabIndex = 54;
		this.h215h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h215h.Click += new System.EventHandler(h209_Click);
		this.h215h.TextChanged += new System.EventHandler(h209_TextChanged);
		this.h215h.KeyDown += new System.Windows.Forms.KeyEventHandler(h209_KeyDown);
		this.h215h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h209_KeyPress);
		this.h215h.Leave += new System.EventHandler(h209_Leave);
		this.h216h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h216h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h216h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h216h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h216h.Location = new System.Drawing.Point(402, 1029);
		this.h216h.Multiline = true;
		this.h216h.Name = "h216h";
		this.h216h.Size = new System.Drawing.Size(106, 48);
		this.h216h.TabIndex = 55;
		this.h216h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h216h.Click += new System.EventHandler(h210_Click);
		this.h216h.TextChanged += new System.EventHandler(h210_TextChanged);
		this.h216h.KeyDown += new System.Windows.Forms.KeyEventHandler(h210_KeyDown);
		this.h216h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h210_KeyPress);
		this.h216h.Leave += new System.EventHandler(h210_Leave);
		this.h217h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h217h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h217h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h217h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h217h.Location = new System.Drawing.Point(402, 1083);
		this.h217h.Multiline = true;
		this.h217h.Name = "h217h";
		this.h217h.Size = new System.Drawing.Size(106, 48);
		this.h217h.TabIndex = 56;
		this.h217h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h217h.Click += new System.EventHandler(h212_Click);
		this.h217h.TextChanged += new System.EventHandler(h212_TextChanged);
		this.h217h.KeyDown += new System.Windows.Forms.KeyEventHandler(h212_KeyDown);
		this.h217h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h212_KeyPress);
		this.h217h.Leave += new System.EventHandler(h212_Leave);
		this.h219h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h219h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h219h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h219h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h219h.Location = new System.Drawing.Point(402, 1137);
		this.h219h.Multiline = true;
		this.h219h.Name = "h219h";
		this.h219h.Size = new System.Drawing.Size(106, 48);
		this.h219h.TabIndex = 57;
		this.h219h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h219h.Click += new System.EventHandler(h214_Click);
		this.h219h.TextChanged += new System.EventHandler(h214_TextChanged);
		this.h219h.KeyDown += new System.Windows.Forms.KeyEventHandler(h214_KeyDown);
		this.h219h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h214_KeyPress);
		this.h219h.Leave += new System.EventHandler(h214_Leave);
		this.h220h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h220h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h220h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h220h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h220h.Location = new System.Drawing.Point(402, 1191);
		this.h220h.Multiline = true;
		this.h220h.Name = "h220h";
		this.h220h.Size = new System.Drawing.Size(106, 48);
		this.h220h.TabIndex = 58;
		this.h220h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h220h.Click += new System.EventHandler(h215_Click);
		this.h220h.TextChanged += new System.EventHandler(h215_TextChanged);
		this.h220h.KeyDown += new System.Windows.Forms.KeyEventHandler(h215_KeyDown);
		this.h220h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h215_KeyPress);
		this.h220h.Leave += new System.EventHandler(h215_Leave);
		this.h223h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h223h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h223h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h223h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h223h.Location = new System.Drawing.Point(402, 1245);
		this.h223h.Multiline = true;
		this.h223h.Name = "h223h";
		this.h223h.Size = new System.Drawing.Size(106, 48);
		this.h223h.TabIndex = 59;
		this.h223h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h223h.Click += new System.EventHandler(h216_Click);
		this.h223h.TextChanged += new System.EventHandler(h216_TextChanged);
		this.h223h.KeyDown += new System.Windows.Forms.KeyEventHandler(h216_KeyDown);
		this.h223h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h216_KeyPress);
		this.h223h.Leave += new System.EventHandler(h216_Leave);
		this.h229h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h229h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h229h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h229h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h229h.Location = new System.Drawing.Point(402, 1299);
		this.h229h.Multiline = true;
		this.h229h.Name = "h229h";
		this.h229h.Size = new System.Drawing.Size(106, 48);
		this.h229h.TabIndex = 60;
		this.h229h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h229h.Click += new System.EventHandler(h217_Click);
		this.h229h.TextChanged += new System.EventHandler(h217_TextChanged);
		this.h229h.KeyDown += new System.Windows.Forms.KeyEventHandler(h217_KeyDown);
		this.h229h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h217_KeyPress);
		this.h229h.Leave += new System.EventHandler(h217_Leave);
		this.h233h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h233h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h233h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h233h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h233h.Location = new System.Drawing.Point(402, 1353);
		this.h233h.Multiline = true;
		this.h233h.Name = "h233h";
		this.h233h.Size = new System.Drawing.Size(106, 48);
		this.h233h.TabIndex = 61;
		this.h233h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h233h.Click += new System.EventHandler(h219_Click);
		this.h233h.TextChanged += new System.EventHandler(h219_TextChanged);
		this.h233h.KeyDown += new System.Windows.Forms.KeyEventHandler(h219_KeyDown);
		this.h233h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h219_KeyPress);
		this.h233h.Leave += new System.EventHandler(h219_Leave);
		this.h234h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h234h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h234h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h234h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h234h.Location = new System.Drawing.Point(402, 1407);
		this.h234h.Multiline = true;
		this.h234h.Name = "h234h";
		this.h234h.Size = new System.Drawing.Size(106, 48);
		this.h234h.TabIndex = 62;
		this.h234h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h234h.Click += new System.EventHandler(h220_Click);
		this.h234h.TextChanged += new System.EventHandler(h220_TextChanged);
		this.h234h.KeyDown += new System.Windows.Forms.KeyEventHandler(h220_KeyDown);
		this.h234h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h220_KeyPress);
		this.h234h.Leave += new System.EventHandler(h220_Leave);
		this.h235h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h235h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h235h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h235h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h235h.Location = new System.Drawing.Point(402, 1461);
		this.h235h.Multiline = true;
		this.h235h.Name = "h235h";
		this.h235h.Size = new System.Drawing.Size(106, 48);
		this.h235h.TabIndex = 63;
		this.h235h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h235h.Click += new System.EventHandler(h223_Click);
		this.h235h.TextChanged += new System.EventHandler(h223_TextChanged);
		this.h235h.KeyDown += new System.Windows.Forms.KeyEventHandler(h223_KeyDown);
		this.h235h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h223_KeyPress);
		this.h235h.Leave += new System.EventHandler(h223_Leave);
		...
		this.label34.Text = "محمد سعدالدین انور";
		...
		this.label97.Text = "ریدار عبداخالق خوشناو";
		...
		this.label98.Text = "رزکار ابراهیم ملامحمد ";
		...
		this.label99.Text = "فرهاد پیربال";
		this.label99.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label100.AutoSize = true;
		this.label100.BackColor = System.Drawing.Color.Yellow;
		...
		this.label100.Text = "پارتی دیموکراتی کوردستان";
		...
		this.label101.Text = "زیبار هەرکی";
		...
		this.label102.Text = "الحرکة الاسلامیة في کوردستان العراق";
		...
		this.label103.Text = "عماد یشار مشکو";
		...
		this.label104.Text = "د.کاضم یاور";
		...
		this.label105.Text = "دلشاد محمد اسماعیل";
		...
		this.label106.Text = "رامسي حکمت حنا یوسف ";
		...
		this.label107.Text = "نوبار سیبان غریب";
		...
		this.label108.Text = "منى نبي قهوة جي";
		...
		this.label109.Text = "المحامي محمد اژي ازاد القصاب";
		...
		this.label110.Text = "جنان جبار بویا";
		...
		this.label111.Text = "هیمان رمزي محمود";
		...
		this.label112.Text = "عبدالباسط خالد رشید عبدالله ";
		...
		this.label115.Text = "د.سوران صلاح الدین شکر";
		...
		this.label116.Text = "مشتاق عبدالله توفیق";
		...
		this.label118.Text = "ضیاء بطرس صلیوا";
		...
		this.label119.Text = "دیدار عقید فرهاد";
		...
		this.label120.Text = "سیڤان صبرى خورانی ";
		...
		this.label122.Text = "رامي نوري عوديش سياوش";
		...
		this.label123.Text = "المحامي احمد سيدمكرم";
		...
		this.label124.Text = "ازاد كورەچی ";
		...
		this.label126.Text = "الاعلامي نوزاد بولص الحکیم";
		...
		this.h102h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h102h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h102h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h102h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h102h.Location = new System.Drawing.Point(856, 3);
		this.h102h.Multiline = true;
		this.h102h.Name = "h102h";
		this.h102h.Size = new System.Drawing.Size(103, 48);
		this.h102h.TabIndex = 0;
		this.h102h.Text = " ";
		this.h102h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h102h.Click += new System.EventHandler(h102_Click);
		this.h102h.TextChanged += new System.EventHandler(h102_TextChanged);
		this.h102h.KeyDown += new System.Windows.Forms.KeyEventHandler(h102_KeyDown);
		this.h102h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h102_KeyPress);
		this.h102h.Leave += new System.EventHandler(h102_Leave);
		this.h103h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h103h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h103h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h103h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h103h.Location = new System.Drawing.Point(856, 57);
		this.h103h.Multiline = true;
		this.h103h.Name = "h103h";
		this.h103h.Size = new System.Drawing.Size(103, 48);
		this.h103h.TabIndex = 1;
		this.h103h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h103h.Click += new System.EventHandler(h103_Click);
		this.h103h.TextChanged += new System.EventHandler(h103_TextChanged);
		this.h103h.KeyDown += new System.Windows.Forms.KeyEventHandler(h103_KeyDown);
		this.h103h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h103_KeyPress);
		this.h103h.Leave += new System.EventHandler(h103_Leave);
		this.h105h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h105h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h105h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h105h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h105h.Location = new System.Drawing.Point(856, 111);
		this.h105h.Multiline = true;
		this.h105h.Name = "h105h";
		this.h105h.Size = new System.Drawing.Size(103, 48);
		this.h105h.TabIndex = 2;
		this.h105h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h105h.Click += new System.EventHandler(h105_Click);
		this.h105h.TextChanged += new System.EventHandler(h105_TextChanged);
		this.h105h.KeyDown += new System.Windows.Forms.KeyEventHandler(h105_KeyDown);
		this.h105h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h105_KeyPress);
		this.h105h.Leave += new System.EventHandler(h105_Leave);
		this.h106h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h106h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h106h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h106h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h106h.Location = new System.Drawing.Point(856, 165);
		this.h106h.Multiline = true;
		this.h106h.Name = "h106h";
		this.h106h.Size = new System.Drawing.Size(103, 48);
		this.h106h.TabIndex = 3;
		this.h106h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h106h.Click += new System.EventHandler(h106_Click);
		this.h106h.TextChanged += new System.EventHandler(h106_TextChanged);
		this.h106h.KeyDown += new System.Windows.Forms.KeyEventHandler(h106_KeyDown);
		this.h106h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h106_KeyPress);
		this.h106h.Leave += new System.EventHandler(h106_Leave);
		this.h109h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h109h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h109h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h109h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h109h.Location = new System.Drawing.Point(856, 219);
		this.h109h.Multiline = true;
		this.h109h.Name = "h109h";
		this.h109h.Size = new System.Drawing.Size(103, 48);
		this.h109h.TabIndex = 4;
		this.h109h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h109h.Click += new System.EventHandler(h109_Click);
		this.h109h.TextChanged += new System.EventHandler(h109_TextChanged);
		this.h109h.KeyDown += new System.Windows.Forms.KeyEventHandler(h109_KeyDown);
		this.h109h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h109_KeyPress);
		this.h109h.Leave += new System.EventHandler(h109_Leave);
		this.h111h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h111h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h111h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h111h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h111h.Location = new System.Drawing.Point(856, 273);
		this.h111h.Multiline = true;
		this.h111h.Name = "h111h";
		this.h111h.Size = new System.Drawing.Size(103, 48);
		this.h111h.TabIndex = 5;
		this.h111h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h111h.Click += new System.EventHandler(h111_Click);
		this.h111h.TextChanged += new System.EventHandler(h111_TextChanged);
		this.h111h.KeyDown += new System.Windows.Forms.KeyEventHandler(h111_KeyDown);
		this.h111h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h111_KeyPress);
		this.h111h.Leave += new System.EventHandler(h111_Leave);
		this.h112h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h112h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h112h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h112h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h112h.Location = new System.Drawing.Point(856, 327);
		this.h112h.Multiline = true;
		this.h112h.Name = "h112h";
		this.h112h.Size = new System.Drawing.Size(103, 48);
		this.h112h.TabIndex = 6;
		this.h112h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h112h.Click += new System.EventHandler(h112_Click);
		this.h112h.TextChanged += new System.EventHandler(h112_TextChanged);
		this.h112h.KeyDown += new System.Windows.Forms.KeyEventHandler(h112_KeyDown);
		this.h112h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h112_KeyPress);
		this.h112h.Leave += new System.EventHandler(h112_Leave);
		...
		this.label29.Text = "سید صباح محمد ";
		...
		this.label33.Text = "هیمداد سلیم سارمەمی";
		...
		this.label37.Text = "مامۆستا ارسلان مولود غفوري";
		...
		this.label41.Text = "جاسم محمد حسین";
		...
		this.label45.Text = "دکتۆر هەڵدێر";
		...
		this.label67.Text = "دڵشاد عبدالله عمراغا برادۆستی";
		...
		this.label70.Text = "مردان الهرکي";
		...
		this.label78.Text = "گوران (التغیر)";
		this.label78.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h114h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h114h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h114h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h114h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h114h.Location = new System.Drawing.Point(856, 381);
		this.h114h.Multiline = true;
		this.h114h.Name = "h114h";
		this.h114h.Size = new System.Drawing.Size(103, 48);
		this.h114h.TabIndex = 8;
		this.h114h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h114h.Click += new System.EventHandler(h120_Click);
		this.h114h.TextChanged += new System.EventHandler(h120_TextChanged);
		this.h114h.KeyDown += new System.Windows.Forms.KeyEventHandler(h120_KeyDown);
		this.h114h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h120_KeyPress);
		this.h114h.Leave += new System.EventHandler(h120_Leave);
		...
		this.label82.Text = "فریق معروف ابراهیم";
		this.label82.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h120h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h120h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h120h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h120h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h120h.Location = new System.Drawing.Point(856, 435);
		this.h120h.Multiline = true;
		this.h120h.Name = "h120h";
		this.h120h.Size = new System.Drawing.Size(103, 48);
		this.h120h.TabIndex = 9;
		this.h120h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h120h.Click += new System.EventHandler(h123_Click);
		this.h120h.TextChanged += new System.EventHandler(h123_TextChanged);
		this.h120h.KeyDown += new System.Windows.Forms.KeyEventHandler(h123_KeyDown);
		this.h120h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h123_KeyPress);
		this.h120h.Leave += new System.EventHandler(h123_Leave);
		...
		this.label86.Text = "بزوتنەوەى پەیوەندى ئیسلامى کوردستان";
		this.label86.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h123h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h123h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h123h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h123h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h123h.Location = new System.Drawing.Point(856, 489);
		this.h123h.Multiline = true;
		this.h123h.Name = "h123h";
		this.h123h.Size = new System.Drawing.Size(103, 48);
		this.h123h.TabIndex = 10;
		this.h123h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h123h.Click += new System.EventHandler(h129_Click);
		this.h123h.TextChanged += new System.EventHandler(h129_TextChanged);
		this.h123h.KeyDown += new System.Windows.Forms.KeyEventHandler(h129_KeyDown);
		this.h123h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h129_KeyPress);
		this.h123h.Leave += new System.EventHandler(h129_Leave);
		this.label136.AutoSize = true;
		this.label136.BackColor = System.Drawing.Color.Aquamarine;
		...
		this.label136.Text = "یەکێتی نیشتیمانی کوردستان";
		this.label136.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h129h.BackColor = System.Drawing.Color.Aquamarine;
		this.h129h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h129h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h129h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h129h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h129h.Location = new System.Drawing.Point(856, 543);
		this.h129h.Multiline = true;
		this.h129h.Name = "h129h";
		this.h129h.Size = new System.Drawing.Size(103, 48);
		this.h129h.TabIndex = 11;
		this.h129h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h129h.Click += new System.EventHandler(h131_Click);
		this.h129h.TextChanged += new System.EventHandler(h131_TextChanged);
		this.h129h.KeyDown += new System.Windows.Forms.KeyEventHandler(h131_KeyDown);
		this.h129h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h131_KeyPress);
		this.h129h.Leave += new System.EventHandler(h131_Leave);
		...
		this.label138.Text = "اسراء عبدالستار عبدالکریم";
		this.label138.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h131h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h131h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h131h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h131h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h131h.Location = new System.Drawing.Point(856, 597);
		this.h131h.Multiline = true;
		this.h131h.Name = "h131h";
		this.h131h.Size = new System.Drawing.Size(103, 48);
		this.h131h.TabIndex = 12;
		this.h131h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h131h.Click += new System.EventHandler(h133_Click);
		this.h131h.TextChanged += new System.EventHandler(h133_TextChanged);
		this.h131h.KeyDown += new System.Windows.Forms.KeyEventHandler(h133_KeyDown);
		this.h131h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h133_KeyPress);
		this.h131h.Leave += new System.EventHandler(h133_Leave);
		...
		this.label139.Text = "هاوپەیمانى هەرێمی کوردستان";
		this.label139.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h133h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h133h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h133h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h133h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h133h.Location = new System.Drawing.Point(856, 651);
		this.h133h.Multiline = true;
		this.h133h.Name = "h133h";
		this.h133h.Size = new System.Drawing.Size(103, 48);
		this.h133h.TabIndex = 13;
		this.h133h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h133h.Click += new System.EventHandler(h139_Click);
		this.h133h.TextChanged += new System.EventHandler(h139_TextChanged);
		this.h133h.KeyDown += new System.Windows.Forms.KeyEventHandler(h139_KeyDown);
		this.h133h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h139_KeyPress);
		this.h133h.Leave += new System.EventHandler(h139_Leave);
		...
		this.label140.Text = "عباس علي سامان ";
		this.label140.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h139h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h139h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h139h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h139h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h139h.Location = new System.Drawing.Point(856, 705);
		this.h139h.Multiline = true;
		this.h139h.Name = "h139h";
		this.h139h.Size = new System.Drawing.Size(103, 48);
		this.h139h.TabIndex = 14;
		this.h139h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h139h.Click += new System.EventHandler(h144_Click);
		this.h139h.TextChanged += new System.EventHandler(h144_TextChanged);
		this.h139h.KeyDown += new System.Windows.Forms.KeyEventHandler(h144_KeyDown);
		this.h139h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h144_KeyPress);
		this.h139h.Leave += new System.EventHandler(h144_Leave);
		...
		this.label142.Text = "محمد صالح ی بەرەنگار";
		this.label142.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h144h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h144h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h144h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h144h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h144h.Location = new System.Drawing.Point(856, 759);
		this.h144h.Multiline = true;
		this.h144h.Name = "h144h";
		this.h144h.Size = new System.Drawing.Size(103, 48);
		this.h144h.TabIndex = 15;
		this.h144h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h144h.Click += new System.EventHandler(h146_Click);
		this.h144h.TextChanged += new System.EventHandler(h146_TextChanged);
		this.h144h.KeyDown += new System.Windows.Forms.KeyEventHandler(h146_KeyDown);
		this.h144h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h146_KeyPress);
		this.h144h.Leave += new System.EventHandler(h146_Leave);
		...
		this.label143.Text = "شیروان عمر";
		this.label143.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h146h.BackColor = System.Drawing.Color.LightCyan;
		this.h146h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h146h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h146h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h146h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h146h.Location = new System.Drawing.Point(856, 813);
		this.h146h.Multiline = true;
		this.h146h.Name = "h146h";
		this.h146h.Size = new System.Drawing.Size(103, 48);
		this.h146h.TabIndex = 16;
		this.h146h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h146h.Click += new System.EventHandler(h147_Click);
		this.h146h.TextChanged += new System.EventHandler(h147_TextChanged);
		this.h146h.KeyDown += new System.Windows.Forms.KeyEventHandler(h147_KeyDown);
		this.h146h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h147_KeyPress);
		this.h146h.Leave += new System.EventHandler(h147_Leave);
		this.h147h.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		this.h147h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h147h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h147h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h147h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h147h.Location = new System.Drawing.Point(856, 867);
		this.h147h.Multiline = true;
		this.h147h.Name = "h147h";
		this.h147h.Size = new System.Drawing.Size(103, 48);
		this.h147h.TabIndex = 17;
		this.h147h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h147h.Click += new System.EventHandler(h148_Click);
		this.h147h.TextChanged += new System.EventHandler(h148_TextChanged);
		this.h147h.KeyDown += new System.Windows.Forms.KeyEventHandler(h148_KeyDown);
		this.h147h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h148_KeyPress);
		this.h147h.Leave += new System.EventHandler(h148_Leave);
		this.label144.AutoSize = true;
		this.label144.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		...
		this.label144.Text = "کۆمەڵی دادگەری کوردستان/عێراق ";
		this.label144.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label146.AutoSize = true;
		this.label146.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		...
		this.label146.Text = "یەکگرتووی ئیسلامی کوردستان";
		this.label146.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h148h.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		this.h148h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h148h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h148h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h148h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h148h.Location = new System.Drawing.Point(856, 921);
		this.h148h.Multiline = true;
		this.h148h.Name = "h148h";
		this.h148h.Size = new System.Drawing.Size(103, 48);
		this.h148h.TabIndex = 18;
		this.h148h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h148h.Click += new System.EventHandler(h149_Click);
		this.h148h.TextChanged += new System.EventHandler(h149_TextChanged);
		this.h148h.KeyDown += new System.Windows.Forms.KeyEventHandler(h149_KeyDown);
		this.h148h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h149_KeyPress);
		this.h148h.Leave += new System.EventHandler(h149_Leave);
		...
		this.label147.Text = "الجبهة الترکمانیة العراقیة";
		this.label147.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h149h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h149h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h149h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h149h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h149h.Location = new System.Drawing.Point(856, 975);
		this.h149h.Multiline = true;
		this.h149h.Name = "h149h";
		this.h149h.Size = new System.Drawing.Size(103, 48);
		this.h149h.TabIndex = 19;
		this.h149h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h149h.Click += new System.EventHandler(h150_Click);
		this.h149h.TextChanged += new System.EventHandler(h150_TextChanged);
		this.h149h.KeyDown += new System.Windows.Forms.KeyEventHandler(h150_KeyDown);
		this.h149h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h150_KeyPress);
		this.h149h.Leave += new System.EventHandler(h150_Leave);
		...
		this.label148.Text = "شهاب عبدالوهاب فتح الله شیخاني ";
		this.label148.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h150h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h150h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h150h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h150h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h150h.Location = new System.Drawing.Point(856, 1029);
		this.h150h.Multiline = true;
		this.h150h.Name = "h150h";
		this.h150h.Size = new System.Drawing.Size(103, 48);
		this.h150h.TabIndex = 20;
		this.h150h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h150h.Click += new System.EventHandler(h151_Click);
		this.h150h.TextChanged += new System.EventHandler(h151_TextChanged);
		this.h150h.KeyDown += new System.Windows.Forms.KeyEventHandler(h151_KeyDown);
		this.h150h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h151_KeyPress);
		this.h150h.Leave += new System.EventHandler(h151_Leave);
		...
		this.label150.Text = "زانا حسن بایز";
		this.label150.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h151h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h151h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h151h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h151h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h151h.Location = new System.Drawing.Point(856, 1083);
		this.h151h.Multiline = true;
		this.h151h.Name = "h151h";
		this.h151h.Size = new System.Drawing.Size(103, 48);
		this.h151h.TabIndex = 21;
		this.h151h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h151h.Click += new System.EventHandler(h154_Click);
		this.h151h.TextChanged += new System.EventHandler(h154_TextChanged);
		this.h151h.KeyDown += new System.Windows.Forms.KeyEventHandler(h154_KeyDown);
		this.h151h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h154_KeyPress);
		this.h151h.Leave += new System.EventHandler(h154_Leave);
		this.h154h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h154h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h154h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h154h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h154h.Location = new System.Drawing.Point(856, 1137);
		this.h154h.Multiline = true;
		this.h154h.Name = "h154h";
		this.h154h.Size = new System.Drawing.Size(103, 48);
		this.h154h.TabIndex = 22;
		this.h154h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h154h.Click += new System.EventHandler(h156_Click);
		this.h154h.TextChanged += new System.EventHandler(h156_TextChanged);
		this.h154h.KeyDown += new System.Windows.Forms.KeyEventHandler(h156_KeyDown);
		this.h154h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h156_KeyPress);
		this.h154h.Leave += new System.EventHandler(h156_Leave);
		...
		this.label151.Text = "وەستا هەژارى نانەوا";
		...
		this.label152.Text = "سید دڵشاد سیدجلال بەرزنجی ";
		this.label152.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h156h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h156h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h156h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h156h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h156h.Location = new System.Drawing.Point(856, 1191);
		this.h156h.Multiline = true;
		this.h156h.Name = "h156h";
		this.h156h.Size = new System.Drawing.Size(103, 48);
		this.h156h.TabIndex = 23;
		this.h156h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h156h.Click += new System.EventHandler(h157_Click);
		this.h156h.TextChanged += new System.EventHandler(h157_TextChanged);
		this.h156h.KeyDown += new System.Windows.Forms.KeyEventHandler(h157_KeyDown);
		this.h156h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h157_KeyPress);
		this.h156h.Leave += new System.EventHandler(h157_Leave);
		this.h157h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h157h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h157h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h157h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h157h.Location = new System.Drawing.Point(856, 1245);
		this.h157h.Multiline = true;
		this.h157h.Name = "h157h";
		this.h157h.Size = new System.Drawing.Size(103, 48);
		this.h157h.TabIndex = 24;
		this.h157h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h157h.Click += new System.EventHandler(h158_Click);
		this.h157h.TextChanged += new System.EventHandler(h158_TextChanged);
		this.h157h.KeyDown += new System.Windows.Forms.KeyEventHandler(h158_KeyDown);
		this.h157h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h158_KeyPress);
		this.h157h.Leave += new System.EventHandler(h158_Leave);
		...
		this.label155.Text = "شیخ انس";
		this.label155.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h158h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h158h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h158h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h158h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h158h.Location = new System.Drawing.Point(856, 1299);
		this.h158h.Multiline = true;
		this.h158h.Name = "h158h";
		this.h158h.Size = new System.Drawing.Size(103, 48);
		this.h158h.TabIndex = 25;
		this.h158h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h158h.Click += new System.EventHandler(h160_Click);
		this.h158h.TextChanged += new System.EventHandler(h160_TextChanged);
		this.h158h.KeyDown += new System.Windows.Forms.KeyEventHandler(h160_KeyDown);
		this.h158h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h160_KeyPress);
		this.h158h.Leave += new System.EventHandler(h160_Leave);
		this.h160h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h160h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h160h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h160h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h160h.Location = new System.Drawing.Point(856, 1353);
		this.h160h.Multiline = true;
		this.h160h.Name = "h160h";
		this.h160h.Size = new System.Drawing.Size(103, 48);
		this.h160h.TabIndex = 26;
		this.h160h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h160h.Click += new System.EventHandler(h161_Click);
		this.h160h.TextChanged += new System.EventHandler(h161_TextChanged);
		this.h160h.KeyDown += new System.Windows.Forms.KeyEventHandler(h161_KeyDown);
		this.h160h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h161_KeyPress);
		this.h160h.Leave += new System.EventHandler(h161_Leave);
		...
		this.label156.Text = "جواد محمد هةرکي";
		this.label156.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label158.AutoSize = true;
		this.label158.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label158.Text = "هەڵوێست";
		this.label158.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h161h.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		this.h161h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h161h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h161h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h161h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h161h.Location = new System.Drawing.Point(856, 1407);
		this.h161h.Multiline = true;
		this.h161h.Name = "h161h";
		this.h161h.Size = new System.Drawing.Size(103, 48);
		this.h161h.TabIndex = 27;
		this.h161h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h161h.Click += new System.EventHandler(h162_Click);
		this.h161h.TextChanged += new System.EventHandler(h162_TextChanged);
		this.h161h.KeyDown += new System.Windows.Forms.KeyEventHandler(h162_KeyDown);
		this.h161h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h162_KeyPress);
		this.h161h.Leave += new System.EventHandler(h162_Leave);
		...
		this.label159.Text = "هاوپەیمانی نیشتیمانی";
		this.label159.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h162h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h162h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h162h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h162h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h162h.Location = new System.Drawing.Point(856, 1461);
		this.h162h.Multiline = true;
		this.h162h.Name = "h162h";
		this.h162h.Size = new System.Drawing.Size(103, 48);
		this.h162h.TabIndex = 28;
		this.h162h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h162h.Click += new System.EventHandler(h164_Click);
		this.h162h.TextChanged += new System.EventHandler(h164_TextChanged);
		this.h162h.KeyDown += new System.Windows.Forms.KeyEventHandler(h164_KeyDown);
		this.h162h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h164_KeyPress);
		this.h162h.Leave += new System.EventHandler(h164_Leave);
		...
		this.label160.Text = "سەردەم";
		this.label160.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h164h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h164h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h164h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h164h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h164h.Location = new System.Drawing.Point(856, 1515);
		this.h164h.Multiline = true;
		this.h164h.Name = "h164h";
		this.h164h.Size = new System.Drawing.Size(103, 48);
		this.h164h.TabIndex = 29;
		this.h164h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h164h.Click += new System.EventHandler(h167_Click);
		this.h164h.TextChanged += new System.EventHandler(h167_TextChanged);
		this.h164h.KeyDown += new System.Windows.Forms.KeyEventHandler(h167_KeyDown);
		this.h164h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h167_KeyPress);
		this.h164h.Leave += new System.EventHandler(h167_Leave);
		...
		this.label162.Text = "دلزار حسن";
		this.label162.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h167h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h167h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h167h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h167h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h167h.Location = new System.Drawing.Point(856, 1569);
		this.h167h.Multiline = true;
		this.h167h.Name = "h167h";
		this.h167h.Size = new System.Drawing.Size(103, 48);
		this.h167h.TabIndex = 30;
		this.h167h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h167h.Click += new System.EventHandler(h169_Click);
		this.h167h.TextChanged += new System.EventHandler(h169_TextChanged);
		this.h167h.KeyDown += new System.Windows.Forms.KeyEventHandler(h169_KeyDown);
		this.h167h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(h169_KeyPress);
		this.h167h.Leave += new System.EventHandler(h169_Leave);
		this.h169h.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		this.h169h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h169h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h169h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h169h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h169h.Location = new System.Drawing.Point(856, 1623);
		this.h169h.Multiline = true;
		this.h169h.Name = "h169h";
		this.h169h.Size = new System.Drawing.Size(103, 48);
		this.h169h.TabIndex = 31;
		this.h169h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h169h.Click += new System.EventHandler(h170_Click);
		this.h169h.TextChanged += new System.EventHandler(h170_TextChanged);
		this.h169h.KeyDown += new System.Windows.Forms.KeyEventHandler(h170_KeyDown);
		this.h169h.Leave += new System.EventHandler(h170_Leave);
		this.label163.AutoSize = true;
		this.label163.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		...
		this.label164.Text = "جلال پەریشان";
		this.label164.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h170h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h170h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h170h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h170h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h170h.Location = new System.Drawing.Point(856, 1677);
		this.h170h.Multiline = true;
		this.h170h.Name = "h170h";
		this.h170h.Size = new System.Drawing.Size(103, 48);
		this.h170h.TabIndex = 32;
		this.h170h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h170h.Click += new System.EventHandler(s137_Click);
		this.h170h.TextChanged += new System.EventHandler(s137_TextChanged);
		this.h170h.KeyDown += new System.Windows.Forms.KeyEventHandler(s137_KeyDown);
		this.h170h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(s137_KeyPress);
		this.h170h.Leave += new System.EventHandler(s137_Leave);
		...
		this.label166.Text = "شانۆ بەگزادە ";
		this.label166.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h173h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h173h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h173h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h173h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h173h.Location = new System.Drawing.Point(856, 1731);
		this.h173h.Multiline = true;
		this.h173h.Name = "h173h";
		this.h173h.Size = new System.Drawing.Size(103, 48);
		this.h173h.TabIndex = 33;
		this.h173h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h173h.Click += new System.EventHandler(s135_Click);
		this.h173h.TextChanged += new System.EventHandler(s135_TextChanged);
		this.h173h.KeyDown += new System.Windows.Forms.KeyEventHandler(s135_KeyDown);
		this.h173h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(s135_KeyPress);
		this.h173h.Leave += new System.EventHandler(s135_Leave);
		...
		this.label167.Text = "علي خۆشناو";
		this.label167.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h176h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h176h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h176h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h176h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h176h.Location = new System.Drawing.Point(856, 1785);
		this.h176h.Multiline = true;
		this.h176h.Name = "h176h";
		this.h176h.Size = new System.Drawing.Size(103, 48);
		this.h176h.TabIndex = 34;
		this.h176h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h176h.Click += new System.EventHandler(s133_Click);
		this.h176h.TextChanged += new System.EventHandler(s133_TextChanged);
		this.h176h.KeyDown += new System.Windows.Forms.KeyEventHandler(s133_KeyDown);
		this.h176h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(s133_KeyPress);
		this.h176h.Leave += new System.EventHandler(s133_Leave);
		...
		this.label168.Text = "سروة کۆی";
		this.label168.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h178h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h178h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h178h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h178h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h178h.Location = new System.Drawing.Point(856, 1839);
		this.h178h.Multiline = true;
		this.h178h.Name = "h178h";
		this.h178h.Size = new System.Drawing.Size(103, 48);
		this.h178h.TabIndex = 35;
		this.h178h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h178h.Click += new System.EventHandler(s198_Click);
		this.h178h.TextChanged += new System.EventHandler(s198_TextChanged);
		this.h178h.KeyDown += new System.Windows.Forms.KeyEventHandler(s198_KeyDown);
		this.h178h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(s198_KeyPress);
		this.h178h.Leave += new System.EventHandler(s198_Leave);
		...
		this.label114.Text = "نجیب محسن على عثمان ";
		...
		this.label43.Font = new System.Drawing.Font("Unikurd Jino", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label43.Location = new System.Drawing.Point(1236, 540);
		this.label43.Name = "label43";
		this.label43.Size = new System.Drawing.Size(88, 54);
		this.label43.TabIndex = 68;
		this.label43.Text = "129";
		this.label43.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label43.Click += new System.EventHandler(label80_Click);
		...
		this.label87.Location = new System.Drawing.Point(767, 1728);
		...
		this.label85.Location = new System.Drawing.Point(767, 1674);
		...
		this.label83.Location = new System.Drawing.Point(767, 1620);
		...
		this.label81.Location = new System.Drawing.Point(767, 1566);
		...
		this.label79.Location = new System.Drawing.Point(767, 1512);
		...
		this.label21.Location = new System.Drawing.Point(1236, 1890);
		this.label21.Name = "label21";
		this.label21.Size = new System.Drawing.Size(88, 65);
		this.label21.TabIndex = 174;
		this.label21.Text = "179";
		...
		this.label17.Location = new System.Drawing.Point(1236, 1836);
		this.label17.Name = "label17";
		this.label17.Size = new System.Drawing.Size(88, 54);
		this.label17.TabIndex = 174;
		this.label17.Text = "178";
		...
		this.label14.Location = new System.Drawing.Point(1236, 1782);
		this.label14.Name = "label14";
		this.label14.Size = new System.Drawing.Size(88, 54);
		this.label14.TabIndex = 174;
		this.label14.Text = "176";
		...
		this.label307.Location = new System.Drawing.Point(1236, 1674);
		this.label307.Name = "label307";
		this.label307.Size = new System.Drawing.Size(88, 54);
		this.label307.TabIndex = 170;
		this.label307.Text = "170";
		this.label307.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label307.Click += new System.EventHandler(label307_Click);
		this.label303.AutoSize = true;
		this.label303.BackColor = System.Drawing.Color.FromArgb(255, 255, 192);
		...
		this.label25.Location = new System.Drawing.Point(767, 0);
		this.label25.Name = "label25";
		this.label25.Size = new System.Drawing.Size(83, 54);
		this.label25.TabIndex = 174;
		this.label25.Text = "181";
		this.label25.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label251.AutoSize = true;
		this.label251.BackColor = System.Drawing.Color.FromArgb(192, 64, 0);
		...
		this.label251.Location = new System.Drawing.Point(1236, 918);
		this.label251.Name = "label251";
		this.label251.Size = new System.Drawing.Size(88, 54);
		this.label251.TabIndex = 114;
		this.label251.Text = "148";
		this.label251.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label251.Click += new System.EventHandler(label251_Click);
		this.label247.AutoSize = true;
		this.label247.BackColor = System.Drawing.Color.FromArgb(255, 128, 0);
		...
		this.label69.Location = new System.Drawing.Point(1236, 810);
		this.label69.Name = "label69";
		this.label69.Size = new System.Drawing.Size(88, 54);
		this.label69.TabIndex = 57;
		this.label69.Text = "146";
		this.label69.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label69.Click += new System.EventHandler(label69_Click);
		...
		this.label72.Location = new System.Drawing.Point(1236, 756);
		this.label72.Name = "label72";
		this.label72.Size = new System.Drawing.Size(88, 54);
		this.label72.TabIndex = 60;
		this.label72.Text = "144";
		this.label72.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label72.Click += new System.EventHandler(label72_Click);
		...
		this.label76.Location = new System.Drawing.Point(1236, 702);
		this.label76.Name = "label76";
		this.label76.Size = new System.Drawing.Size(88, 54);
		this.label76.TabIndex = 64;
		this.label76.Text = "139";
		this.label76.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label76.Click += new System.EventHandler(label76_Click);
		...
		this.label80.Location = new System.Drawing.Point(1236, 648);
		this.label80.Name = "label80";
		this.label80.Size = new System.Drawing.Size(88, 54);
		this.label80.TabIndex = 68;
		this.label80.Text = "133";
		this.label80.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label80.Click += new System.EventHandler(label80_Click);
		this.label74.AutoSize = true;
		this.label74.BackColor = System.Drawing.Color.LightCyan;
		...
		this.label74.Font = new System.Drawing.Font("Unikurd Jino", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label74.Location = new System.Drawing.Point(1236, 594);
		this.label74.Name = "label74";
		this.label74.Size = new System.Drawing.Size(88, 54);
		this.label74.TabIndex = 68;
		this.label74.Text = "131";
		this.label74.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label74.Click += new System.EventHandler(label80_Click);
		...
		this.label259.Location = new System.Drawing.Point(1236, 1026);
		this.label259.Name = "label259";
		this.label259.Size = new System.Drawing.Size(88, 54);
		this.label259.TabIndex = 122;
		this.label259.Text = "150";
		this.label259.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label259.Click += new System.EventHandler(label259_Click);
		this.label287.AutoSize = true;
		this.label287.BackColor = System.Drawing.Color.FromArgb(255, 192, 255);
		...
		this.label20.Location = new System.Drawing.Point(767, 324);
		...
		this.label77.Font = new System.Drawing.Font("Unikurd Jino", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label77.ForeColor = System.Drawing.Color.Black;
		this.label77.Location = new System.Drawing.Point(767, 216);
		this.label77.Name = "label77";
		this.label77.Size = new System.Drawing.Size(83, 54);
		this.label77.TabIndex = 5909;
		this.label77.Text = "190";
		this.label77.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label77.Click += new System.EventHandler(label15_Click);
		...
		this.label26.Location = new System.Drawing.Point(767, 486);
		...
		this.label92.Font = new System.Drawing.Font("Unikurd Jino", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label92.ForeColor = System.Drawing.Color.Black;
		this.label92.Location = new System.Drawing.Point(767, 972);
		this.label92.Name = "label92";
		this.label92.Size = new System.Drawing.Size(83, 54);
		this.label92.TabIndex = 5909;
		this.label92.Text = "215";
		this.label92.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.label92.Click += new System.EventHandler(label26_Click);
		...
		this.label46.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label46.ForeColor = System.Drawing.Color.Black;
		this.label46.Location = new System.Drawing.Point(767, 1458);
		this.label46.Name = "label46";
		this.label46.Size = new System.Drawing.Size(83, 54);
		this.label46.TabIndex = 5909;
		this.label46.Text = "235";
		...
		this.label73.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label73.ForeColor = System.Drawing.Color.Black;
		this.label73.Location = new System.Drawing.Point(767, 1404);
		this.label73.Name = "label73";
		this.label73.Size = new System.Drawing.Size(83, 54);
		this.label73.TabIndex = 5909;
		this.label73.Text = "234";
		...
		this.label71.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label71.ForeColor = System.Drawing.Color.Black;
		this.label71.Location = new System.Drawing.Point(767, 1350);
		this.label71.Name = "label71";
		this.label71.Size = new System.Drawing.Size(83, 54);
		this.label71.TabIndex = 5909;
		this.label71.Text = "233";
		...
		this.label68.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label68.ForeColor = System.Drawing.Color.Black;
		this.label68.Location = new System.Drawing.Point(767, 1296);
		this.label68.Name = "label68";
		this.label68.Size = new System.Drawing.Size(83, 54);
		this.label68.TabIndex = 5909;
		this.label68.Text = "229";
		...
		this.label63.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label63.ForeColor = System.Drawing.Color.Black;
		this.label63.Location = new System.Drawing.Point(767, 1242);
		this.label63.Name = "label63";
		this.label63.Size = new System.Drawing.Size(83, 54);
		this.label63.TabIndex = 5909;
		this.label63.Text = "223";
		...
		this.label61.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label61.ForeColor = System.Drawing.Color.Black;
		this.label61.Location = new System.Drawing.Point(767, 1188);
		this.label61.Name = "label61";
		this.label61.Size = new System.Drawing.Size(83, 54);
		this.label61.TabIndex = 5909;
		this.label61.Text = "220";
		...
		this.label59.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label59.ForeColor = System.Drawing.Color.Black;
		this.label59.Location = new System.Drawing.Point(767, 1134);
		this.label59.Name = "label59";
		this.label59.Size = new System.Drawing.Size(83, 54);
		this.label59.TabIndex = 5909;
		this.label59.Text = "219";
		...
		this.label48.Font = new System.Drawing.Font("Tahoma", 13.8f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.label48.ForeColor = System.Drawing.Color.Black;
		this.label48.Location = new System.Drawing.Point(767, 1080);
		this.label48.Name = "label48";
		this.label48.Size = new System.Drawing.Size(83, 54);
		this.label48.TabIndex = 5909;
		this.label48.Text = "217";
		...
		this.label75.Location = new System.Drawing.Point(965, 1890);
		this.label75.Name = "label75";
		this.label75.Size = new System.Drawing.Size(265, 65);
		this.label75.TabIndex = 0;
		this.label75.Text = " الدکتور کامران نوری اودل";
		this.label75.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
		this.h179h.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		this.h179h.Dock = System.Windows.Forms.DockStyle.Fill;
		this.h179h.Font = new System.Drawing.Font("Unikurd Jino", 18f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		this.h179h.ForeColor = System.Drawing.Color.FromArgb(192, 0, 0);
		this.h179h.Location = new System.Drawing.Point(856, 1893);
		this.h179h.Multiline = true;
		this.h179h.Name = "h179h";
		this.h179h.Size = new System.Drawing.Size(103, 59);
		this.h179h.TabIndex = 69;
		this.h179h.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.h179h.Click += new System.EventHandler(s207_Click);
		this.h179h.TextChanged += new System.EventHandler(s207_TextChanged);
		this.h179h.KeyDown += new System.Windows.Forms.KeyEventHandler(s207_KeyDown);
		this.h179h.KeyPress += new System.Windows.Forms.KeyPressEventHandler(s207_KeyPress);
		this.h179h.Leave += new System.EventHandler(s207_Leave);
