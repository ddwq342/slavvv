...
public class Candid_T : Form
{
	...
	private void button1_Click(object sender, EventArgs e)
	{
		...
		bm = log.get_candid_taybats(int.Parse(txtbnkacood.Text), int.Parse(comwestga.Text));
		if (bm.Rows.Count > 0)
		{
	...
	private void comwestga_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		using (SqlDataReader reader = command.ExecuteReader())
		{
			if (reader.Read())
			{
				...
				s7.Text = reader["7"].ToString();
				s8.Text = reader["8"].ToString();
				s9.Text = reader["9"].ToString();
				s10.Text = reader["10"].ToString();
				s11.Text = reader["11"].ToString();
				s12.Text = reader["12"].ToString();
				s13.Text = reader["13"].ToString();
				s14.Text = reader["14"].ToString();
				s15.Text = reader["15"].ToString();
				s16.Text = reader["16"].ToString();
				s17.Text = reader["17"].ToString();
				s18.Text = reader["18"].ToString();
				s19.Text = reader["19"].ToString();
				s20.Text = reader["20"].ToString();
				s21.Text = reader["21"].ToString();
				s22.Text = reader["22"].ToString();
				s23.Text = reader["23"].ToString();
				s24.Text = reader["24"].ToString();
				s25.Text = reader["25"].ToString();
				s26.Text = reader["26"].ToString();
				s27.Text = reader["27"].ToString();
				s28.Text = reader["28"].ToString();
				s29.Text = reader["29"].ToString();
				s30.Text = reader["30"].ToString();
				s31.Text = reader["31"].ToString();
				s32.Text = reader["32"].ToString();
				s33.Text = reader["33"].ToString();
				s34.Text = reader["34"].ToString();
				s35.Text = reader["35"].ToString();
				s36.Text = reader["36"].ToString();
				s37.Text = reader["37"].ToString();
				s38.Text = reader["38"].ToString();
				s39.Text = reader["39"].ToString();
				s40.Text = reader["40"].ToString();
				s41.Text = reader["41"].ToString();
				s42.Text = reader["42"].ToString();
				s43.Text = reader["43"].ToString();
				s44.Text = reader["44"].ToString();
				s45.Text = reader["45"].ToString();
				s46.Text = reader["46"].ToString();
				s47.Text = reader["47"].ToString();
				s48.Text = reader["48"].ToString();
				s49.Text = reader["49"].ToString();
				s50.Text = reader["50"].ToString();
				s51.Text = reader["51"].ToString();
				s52.Text = reader["52"].ToString();
				s53.Text = reader["53"].ToString();
				s54.Text = reader["54"].ToString();
				s55.Text = reader["55"].ToString();
				s56.Text = reader["56"].ToString();
				s57.Text = reader["57"].ToString();
				s58.Text = reader["58"].ToString();
				s59.Text = reader["59"].ToString();
				s60.Text = reader["60"].ToString();
				s61.Text = reader["61"].ToString();
				s62.Text = reader["62"].ToString();
				s63.Text = reader["63"].ToString();
				s64.Text = reader["64"].ToString();
				s65.Text = reader["65"].ToString();
				s66.Text = reader["66"].ToString();
				s67.Text = reader["67"].ToString();
				s68.Text = reader["68"].ToString();
				s69.Text = reader["69"].ToString();
				s70.Text = reader["70"].ToString();
				s71.Text = reader["71"].ToString();
				s72.Text = reader["72"].ToString();
				button1.Text = "Update";
				txtcoler();
			}
			else
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PUK_Anjamakan.CND.Candid_T));
		...
		base.SuspendLayout();
		this.pnl_titil_ca.BackColor = System.Drawing.Color.Teal;
		...
		this.lbl_taswit.ForeColor = System.Drawing.Color.Teal;
		this.lbl_taswit.Location = new System.Drawing.Point(228, 25);
		this.lbl_taswit.Name = "lbl_taswit";
		this.lbl_taswit.Size = new System.Drawing.Size(42, 17);
		this.lbl_taswit.TabIndex = 5338;
		this.lbl_taswit.Text = "label2";
		this.txtwestga.AutoSize = true;
		this.txtwestga.ForeColor = System.Drawing.Color.Teal;
		...
		this.comwestga.Location = new System.Drawing.Point(850, 60);
		...
		this.txtcoodtasj.Size = new System.Drawing.Size(221, 50);
		...
		this.txtbnkacood.Location = new System.Drawing.Point(1207, 60);
		this.txtbnkacood.Multiline = true;
		this.txtbnkacood.Name = "txtbnkacood";
		this.txtbnkacood.ReadOnly = true;
		this.txtbnkacood.Size = new System.Drawing.Size(196, 50);
		...
		this.label9.Size = new System.Drawing.Size(221, 57);
		...
		this.label3.Location = new System.Drawing.Point(1207, 0);
		this.label3.Name = "label3";
		this.label3.Size = new System.Drawing.Size(196, 57);
		...
		this.label6.Size = new System.Drawing.Size(290, 57);
		...
		this.label8.Location = new System.Drawing.Point(956, 0);
		this.label8.Name = "label8";
		this.label8.Size = new System.Drawing.Size(245, 57);
		...
		this.txtnawbnka.Location = new System.Drawing.Point(956, 60);
		this.txtnawbnka.Multiline = true;
		this.txtnawbnka.Name = "txtnawbnka";
		this.txtnawbnka.ReadOnly = true;
		this.txtnawbnka.Size = new System.Drawing.Size(245, 50);
		...
		this.button1.Location = new System.Drawing.Point(554, 60);
		...
		this.label111.Location = new System.Drawing.Point(560, 9);
		this.label111.Name = "label111";
		this.label111.Size = new System.Drawing.Size(396, 44);
		this.label111.TabIndex = 0;
		this.label111.Text = "په\u200cڕه\u200cی تۆماری كاندید پاریزگای سلێمانی";
		this.label111.Click += new System.EventHandler(label111_Click);
		...
		this.button9.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
		...
		this.button8.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
		...
		this.button7.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
		...
		this.button10.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
		...
		this.button11.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
		...
		this.button12.BackColor = System.Drawing.Color.FromArgb(43, 196, 138);
