...
public class RJComboBox : UserControl
{
	...
	private void Icon_Paint(object sender, PaintEventArgs e)
	{
		int iconWidht = 14;
		int iconHeight = 6;
		Rectangle rectIcon = new Rectangle((btnIcon.Width - iconWidht) / 2, (btnIcon.Height - iconHeight) / 2, iconWidht, iconHeight);
	...
	{
		base.SuspendLayout();
		base.Name = "RJComboBox";
		base.Size = new System.Drawing.Size(843, 552);
